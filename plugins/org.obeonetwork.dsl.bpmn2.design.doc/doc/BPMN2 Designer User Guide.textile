...
Double click on representations.aird to open the designer. You will be greeted with the process definitions table.
...
Then click on the wizard shortcuts at the top-left of the Eclipse Workbench. Select __New BPMN Project.__
...
When you press the __Finish__ button, the projects gets created and automatically enabled the BPMN 2.0 - Process viewpoints.
