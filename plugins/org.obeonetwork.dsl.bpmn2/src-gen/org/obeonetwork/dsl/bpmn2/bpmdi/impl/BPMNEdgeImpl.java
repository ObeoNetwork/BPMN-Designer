...
public class BPMNEdgeImpl extends LabeledEdgeImpl implements BPMNEdge {
    ...
    public BPMNLabel getLabel() {
        return (BPMNLabel) eDynamicGet(BpmnDiPackage.BPMN_EDGE__LABEL, BpmnDiPackage.Literals.BPMN_EDGE__LABEL, true, true);
    }
    ...
    public BaseElement getBpmnElement() {
        return (BaseElement) eDynamicGet(BpmnDiPackage.BPMN_EDGE__BPMN_ELEMENT, BpmnDiPackage.Literals.BPMN_EDGE__BPMN_ELEMENT, true, true);
    }
    ...
    public BaseElement basicGetBpmnElement() {
        return (BaseElement) eDynamicGet(BpmnDiPackage.BPMN_EDGE__BPMN_ELEMENT, BpmnDiPackage.Literals.BPMN_EDGE__BPMN_ELEMENT, false, true);
    }
    ...
    public void setBpmnElement(BaseElement newBpmnElement) {
        eDynamicSet(BpmnDiPackage.BPMN_EDGE__BPMN_ELEMENT, BpmnDiPackage.Literals.BPMN_EDGE__BPMN_ELEMENT, newBpmnElement);
    }
    ...
    public DiagramElement getSourceElement() {
        return (DiagramElement) eDynamicGet(BpmnDiPackage.BPMN_EDGE__SOURCE_ELEMENT, BpmnDiPackage.Literals.BPMN_EDGE__SOURCE_ELEMENT, true, true);
    }
    ...
    public DiagramElement basicGetSourceElement() {
        return (DiagramElement) eDynamicGet(BpmnDiPackage.BPMN_EDGE__SOURCE_ELEMENT, BpmnDiPackage.Literals.BPMN_EDGE__SOURCE_ELEMENT, false, true);
    }
    ...
    public void setSourceElement(DiagramElement newSourceElement) {
        eDynamicSet(BpmnDiPackage.BPMN_EDGE__SOURCE_ELEMENT, BpmnDiPackage.Literals.BPMN_EDGE__SOURCE_ELEMENT, newSourceElement);
    }
    ...
    public DiagramElement getTargetElement() {
        return (DiagramElement) eDynamicGet(BpmnDiPackage.BPMN_EDGE__TARGET_ELEMENT, BpmnDiPackage.Literals.BPMN_EDGE__TARGET_ELEMENT, true, true);
    }
    ...
    public DiagramElement basicGetTargetElement() {
        return (DiagramElement) eDynamicGet(BpmnDiPackage.BPMN_EDGE__TARGET_ELEMENT, BpmnDiPackage.Literals.BPMN_EDGE__TARGET_ELEMENT, false, true);
    }
    ...
    public void setTargetElement(DiagramElement newTargetElement) {
        eDynamicSet(BpmnDiPackage.BPMN_EDGE__TARGET_ELEMENT, BpmnDiPackage.Literals.BPMN_EDGE__TARGET_ELEMENT, newTargetElement);
    }
    ...
    public MessageVisibleKind getMessageVisibleKind() {
        return (MessageVisibleKind) eDynamicGet(BpmnDiPackage.BPMN_EDGE__MESSAGE_VISIBLE_KIND, BpmnDiPackage.Literals.BPMN_EDGE__MESSAGE_VISIBLE_KIND, true, true);
    }
    ...
    public void setMessageVisibleKind(MessageVisibleKind newMessageVisibleKind) {
        eDynamicSet(BpmnDiPackage.BPMN_EDGE__MESSAGE_VISIBLE_KIND, BpmnDiPackage.Literals.BPMN_EDGE__MESSAGE_VISIBLE_KIND, newMessageVisibleKind);
    }
