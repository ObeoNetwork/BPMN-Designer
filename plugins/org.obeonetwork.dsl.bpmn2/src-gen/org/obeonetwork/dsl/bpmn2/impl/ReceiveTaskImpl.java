...
public class ReceiveTaskImpl extends TaskImpl implements ReceiveTask {
    ...
    public String getImplementation() {
        return (String) eDynamicGet(Bpmn2Package.RECEIVE_TASK__IMPLEMENTATION, Bpmn2Package.Literals.RECEIVE_TASK__IMPLEMENTATION, true, true);
    }
    ...
    public void setImplementation(String newImplementation) {
        eDynamicSet(Bpmn2Package.RECEIVE_TASK__IMPLEMENTATION, Bpmn2Package.Literals.RECEIVE_TASK__IMPLEMENTATION, newImplementation);
    }
    ...
    public boolean isInstantiate() {
        return (Boolean) eDynamicGet(Bpmn2Package.RECEIVE_TASK__INSTANTIATE, Bpmn2Package.Literals.RECEIVE_TASK__INSTANTIATE, true, true);
    }
    ...
    public void setInstantiate(boolean newInstantiate) {
        eDynamicSet(Bpmn2Package.RECEIVE_TASK__INSTANTIATE, Bpmn2Package.Literals.RECEIVE_TASK__INSTANTIATE, newInstantiate);
    }
    ...
    public Operation getOperationRef() {
        return (Operation) eDynamicGet(Bpmn2Package.RECEIVE_TASK__OPERATION_REF, Bpmn2Package.Literals.RECEIVE_TASK__OPERATION_REF, true, true);
    }
    ...
    public Operation basicGetOperationRef() {
        return (Operation) eDynamicGet(Bpmn2Package.RECEIVE_TASK__OPERATION_REF, Bpmn2Package.Literals.RECEIVE_TASK__OPERATION_REF, false, true);
    }
    ...
    public void setOperationRef(Operation newOperationRef) {
        eDynamicSet(Bpmn2Package.RECEIVE_TASK__OPERATION_REF, Bpmn2Package.Literals.RECEIVE_TASK__OPERATION_REF, newOperationRef);
    }
    ...
    public Message getMessageRef() {
        return (Message) eDynamicGet(Bpmn2Package.RECEIVE_TASK__MESSAGE_REF, Bpmn2Package.Literals.RECEIVE_TASK__MESSAGE_REF, true, true);
    }
    ...
    public Message basicGetMessageRef() {
        return (Message) eDynamicGet(Bpmn2Package.RECEIVE_TASK__MESSAGE_REF, Bpmn2Package.Literals.RECEIVE_TASK__MESSAGE_REF, false, true);
    }
    ...
    public void setMessageRef(Message newMessageRef) {
        eDynamicSet(Bpmn2Package.RECEIVE_TASK__MESSAGE_REF, Bpmn2Package.Literals.RECEIVE_TASK__MESSAGE_REF, newMessageRef);
    }
