...
public class ConversationLinkImpl extends BaseElementImpl implements ConversationLink {
    ...
    public InteractionNode getSourceRef() {
        return (InteractionNode) eDynamicGet(Bpmn2Package.CONVERSATION_LINK__SOURCE_REF, Bpmn2Package.Literals.CONVERSATION_LINK__SOURCE_REF, true, true);
    }
    ...
    public InteractionNode basicGetSourceRef() {
        return (InteractionNode) eDynamicGet(Bpmn2Package.CONVERSATION_LINK__SOURCE_REF, Bpmn2Package.Literals.CONVERSATION_LINK__SOURCE_REF, false, true);
    }
    ...
    public void setSourceRef(InteractionNode newSourceRef) {
        eDynamicSet(Bpmn2Package.CONVERSATION_LINK__SOURCE_REF, Bpmn2Package.Literals.CONVERSATION_LINK__SOURCE_REF, newSourceRef);
    }
    ...
    public String getName() {
        return (String) eDynamicGet(Bpmn2Package.CONVERSATION_LINK__NAME, Bpmn2Package.Literals.CONVERSATION_LINK__NAME, true, true);
    }
    ...
    public InteractionNode getTargetRef() {
        return (InteractionNode) eDynamicGet(Bpmn2Package.CONVERSATION_LINK__TARGET_REF, Bpmn2Package.Literals.CONVERSATION_LINK__TARGET_REF, true, true);
    }
    ...
    public InteractionNode basicGetTargetRef() {
        return (InteractionNode) eDynamicGet(Bpmn2Package.CONVERSATION_LINK__TARGET_REF, Bpmn2Package.Literals.CONVERSATION_LINK__TARGET_REF, false, true);
    }
    ...
    public void setTargetRef(InteractionNode newTargetRef) {
        eDynamicSet(Bpmn2Package.CONVERSATION_LINK__TARGET_REF, Bpmn2Package.Literals.CONVERSATION_LINK__TARGET_REF, newTargetRef);
    }
