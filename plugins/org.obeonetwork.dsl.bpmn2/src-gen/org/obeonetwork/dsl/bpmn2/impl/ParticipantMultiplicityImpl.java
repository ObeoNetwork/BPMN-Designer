...
public class ParticipantMultiplicityImpl extends BPMN2ObjectImpl implements ParticipantMultiplicity {
	...
	public int getMinimum() {
		return (Integer) eDynamicGet(Bpmn2Package.PARTICIPANT_MULTIPLICITY__MINIMUM,
				Bpmn2Package.Literals.PARTICIPANT_MULTIPLICITY__MINIMUM, true, true);
	}
	...
	public void setMinimum(int newMinimum) {
		eDynamicSet(Bpmn2Package.PARTICIPANT_MULTIPLICITY__MINIMUM,
				Bpmn2Package.Literals.PARTICIPANT_MULTIPLICITY__MINIMUM, newMinimum);
	}
	...
	public int getMaximum() {
		return (Integer) eDynamicGet(Bpmn2Package.PARTICIPANT_MULTIPLICITY__MAXIMUM,
				Bpmn2Package.Literals.PARTICIPANT_MULTIPLICITY__MAXIMUM, true, true);
	}
	...
	public void setMaximum(int newMaximum) {
		eDynamicSet(Bpmn2Package.PARTICIPANT_MULTIPLICITY__MAXIMUM,
				Bpmn2Package.Literals.PARTICIPANT_MULTIPLICITY__MAXIMUM, newMaximum);
	}
	...
	@Override
	public String getId() {
		return (String) eDynamicGet(Bpmn2Package.PARTICIPANT_MULTIPLICITY__ID,
				Bpmn2Package.Literals.PARTICIPANT_MULTIPLICITY__ID, true, true);
	}
	...
	public void setId(String newId) {
		eDynamicSet(Bpmn2Package.PARTICIPANT_MULTIPLICITY__ID, Bpmn2Package.Literals.PARTICIPANT_MULTIPLICITY__ID,
				newId);
	}
