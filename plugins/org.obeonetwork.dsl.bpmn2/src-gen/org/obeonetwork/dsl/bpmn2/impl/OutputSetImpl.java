...
public class OutputSetImpl extends BaseElementImpl implements OutputSet {
    ...
    public EList<DataOutput> getDataOutputRefs() {
        return (EList<DataOutput>) eDynamicGet(Bpmn2Package.OUTPUT_SET__DATA_OUTPUT_REFS, Bpmn2Package.Literals.OUTPUT_SET__DATA_OUTPUT_REFS, true, true);
    }
    ...
    public EList<DataOutput> getOptionalOutputRefs() {
        return (EList<DataOutput>) eDynamicGet(Bpmn2Package.OUTPUT_SET__OPTIONAL_OUTPUT_REFS, Bpmn2Package.Literals.OUTPUT_SET__OPTIONAL_OUTPUT_REFS, true, true);
    }
    ...
    public EList<DataOutput> getWhileExecutingOutputRefs() {
        return (EList<DataOutput>) eDynamicGet(Bpmn2Package.OUTPUT_SET__WHILE_EXECUTING_OUTPUT_REFS, Bpmn2Package.Literals.OUTPUT_SET__WHILE_EXECUTING_OUTPUT_REFS, true, true);
    }
    ...
    public EList<InputSet> getInputSetRefs() {
        return (EList<InputSet>) eDynamicGet(Bpmn2Package.OUTPUT_SET__INPUT_SET_REFS, Bpmn2Package.Literals.OUTPUT_SET__INPUT_SET_REFS, true, true);
    }
