...
public class EventBasedGatewayImpl extends GatewayImpl implements EventBasedGateway {
    ...
    public boolean isInstantiate() {
        return (Boolean) eDynamicGet(Bpmn2Package.EVENT_BASED_GATEWAY__INSTANTIATE, Bpmn2Package.Literals.EVENT_BASED_GATEWAY__INSTANTIATE, true, true);
    }
    ...
    public void setInstantiate(boolean newInstantiate) {
        eDynamicSet(Bpmn2Package.EVENT_BASED_GATEWAY__INSTANTIATE, Bpmn2Package.Literals.EVENT_BASED_GATEWAY__INSTANTIATE, newInstantiate);
    }
    ...
    public EventBasedGatewayType getEventGatewayType() {
        return (EventBasedGatewayType) eDynamicGet(Bpmn2Package.EVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE, Bpmn2Package.Literals.EVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE, true, true);
    }
    ...
    public void setEventGatewayType(EventBasedGatewayType newEventGatewayType) {
        eDynamicSet(Bpmn2Package.EVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE, Bpmn2Package.Literals.EVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE, newEventGatewayType);
    }
