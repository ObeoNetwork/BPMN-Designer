...
public class ExtensionAttributeDefinitionImpl extends BPMN2ObjectImpl implements ExtensionAttributeDefinition {
    ...
    public String getName() {
        return (String) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__NAME, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__NAME, true, true);
    }
    ...
    public void setName(String newName) {
        eDynamicSet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__NAME, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__NAME, newName);
    }
    ...
    public String getType() {
        return (String) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__TYPE, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__TYPE, true, true);
    }
    ...
    public void setType(String newType) {
        eDynamicSet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__TYPE, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__TYPE, newType);
    }
    ...
    public boolean isIsReference() {
        return (Boolean) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__IS_REFERENCE, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__IS_REFERENCE, true, true);
    }
    ...
    public void setIsReference(boolean newIsReference) {
        eDynamicSet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__IS_REFERENCE, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__IS_REFERENCE, newIsReference);
    }
    ...
    public ExtensionDefinition getExtensionDefinition() {
        return (ExtensionDefinition) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__EXTENSION_DEFINITION, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__EXTENSION_DEFINITION, true,
                true);
    }
    ...
    public void setExtensionDefinition(ExtensionDefinition newExtensionDefinition) {
        eDynamicSet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__EXTENSION_DEFINITION, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__EXTENSION_DEFINITION, newExtensionDefinition);
    }
    ...
    @Override
    public String getId() {
        return (String) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__ID, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__ID, true, true);
    }
    ...
    public void setId(String newId) {
        eDynamicSet(Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__ID, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_DEFINITION__ID, newId);
    }
