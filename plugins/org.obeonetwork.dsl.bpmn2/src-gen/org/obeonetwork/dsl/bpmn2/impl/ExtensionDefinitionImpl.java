 ...
 * @generated
 */
public class ExtensionDefinitionImpl extends BPMN2ObjectImpl implements ExtensionDefinition {
    /**
    ...
    public String getName() {
        return (String) eDynamicGet(Bpmn2Package.EXTENSION_DEFINITION__NAME, Bpmn2Package.Literals.EXTENSION_DEFINITION__NAME, true, true);
    }
    ...
    public void setName(String newName) {
        eDynamicSet(Bpmn2Package.EXTENSION_DEFINITION__NAME, Bpmn2Package.Literals.EXTENSION_DEFINITION__NAME, newName);
    }
    ...
    public EList<ExtensionAttributeDefinition> getExtensionAttributeDefinitions() {
        return (EList<ExtensionAttributeDefinition>) eDynamicGet(Bpmn2Package.EXTENSION_DEFINITION__EXTENSION_ATTRIBUTE_DEFINITIONS,
                Bpmn2Package.Literals.EXTENSION_DEFINITION__EXTENSION_ATTRIBUTE_DEFINITIONS, true, true);
    }
    ...
    @Override
    public String getId() {
        return (String) eDynamicGet(Bpmn2Package.EXTENSION_DEFINITION__ID, Bpmn2Package.Literals.EXTENSION_DEFINITION__ID, true, true);
    }
    ...
    public void setId(String newId) {
        eDynamicSet(Bpmn2Package.EXTENSION_DEFINITION__ID, Bpmn2Package.Literals.EXTENSION_DEFINITION__ID, newId);
    }
