...
public class GlobalScriptTaskImpl extends GlobalTaskImpl implements GlobalScriptTask {
    ...
    public String getScriptLanguage() {
        return (String) eDynamicGet(Bpmn2Package.GLOBAL_SCRIPT_TASK__SCRIPT_LANGUAGE, Bpmn2Package.Literals.GLOBAL_SCRIPT_TASK__SCRIPT_LANGUAGE, true, true);
    }
    ...
    public void setScriptLanguage(String newScriptLanguage) {
        eDynamicSet(Bpmn2Package.GLOBAL_SCRIPT_TASK__SCRIPT_LANGUAGE, Bpmn2Package.Literals.GLOBAL_SCRIPT_TASK__SCRIPT_LANGUAGE, newScriptLanguage);
    }
    ...
    public String getScript() {
        return (String) eDynamicGet(Bpmn2Package.GLOBAL_SCRIPT_TASK__SCRIPT, Bpmn2Package.Literals.GLOBAL_SCRIPT_TASK__SCRIPT, true, true);
    }
    ...
    public void setScript(String newScript) {
        eDynamicSet(Bpmn2Package.GLOBAL_SCRIPT_TASK__SCRIPT, Bpmn2Package.Literals.GLOBAL_SCRIPT_TASK__SCRIPT, newScript);
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case Bpmn2Package.GLOBAL_SCRIPT_TASK__SCRIPT_LANGUAGE:
            return SCRIPT_LANGUAGE_EDEFAULT == null ? getScriptLanguage() != null : !SCRIPT_LANGUAGE_EDEFAULT.equals(getScriptLanguage());
        case Bpmn2Package.GLOBAL_SCRIPT_TASK__SCRIPT:
