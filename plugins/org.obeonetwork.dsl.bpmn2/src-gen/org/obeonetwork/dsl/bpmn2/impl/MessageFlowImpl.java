...
public class MessageFlowImpl extends BaseElementImpl implements MessageFlow {
    ...
    public String getName() {
        return (String) eDynamicGet(Bpmn2Package.MESSAGE_FLOW__NAME, Bpmn2Package.Literals.MESSAGE_FLOW__NAME, true, true);
    }
    ...
    public InteractionNode getSourceRef() {
        return (InteractionNode) eDynamicGet(Bpmn2Package.MESSAGE_FLOW__SOURCE_REF, Bpmn2Package.Literals.MESSAGE_FLOW__SOURCE_REF, true, true);
    }
    ...
    public InteractionNode basicGetSourceRef() {
        return (InteractionNode) eDynamicGet(Bpmn2Package.MESSAGE_FLOW__SOURCE_REF, Bpmn2Package.Literals.MESSAGE_FLOW__SOURCE_REF, false, true);
    }
    ...
    public void setSourceRef(InteractionNode newSourceRef) {
        eDynamicSet(Bpmn2Package.MESSAGE_FLOW__SOURCE_REF, Bpmn2Package.Literals.MESSAGE_FLOW__SOURCE_REF, newSourceRef);
    }
    ...
    public InteractionNode getTargetRef() {
        return (InteractionNode) eDynamicGet(Bpmn2Package.MESSAGE_FLOW__TARGET_REF, Bpmn2Package.Literals.MESSAGE_FLOW__TARGET_REF, true, true);
    }
    ...
    public InteractionNode basicGetTargetRef() {
        return (InteractionNode) eDynamicGet(Bpmn2Package.MESSAGE_FLOW__TARGET_REF, Bpmn2Package.Literals.MESSAGE_FLOW__TARGET_REF, false, true);
    }
    ...
    public void setTargetRef(InteractionNode newTargetRef) {
        eDynamicSet(Bpmn2Package.MESSAGE_FLOW__TARGET_REF, Bpmn2Package.Literals.MESSAGE_FLOW__TARGET_REF, newTargetRef);
    }
    ...
    public Message getMessageRef() {
        return (Message) eDynamicGet(Bpmn2Package.MESSAGE_FLOW__MESSAGE_REF, Bpmn2Package.Literals.MESSAGE_FLOW__MESSAGE_REF, true, true);
    }
    ...
    public Message basicGetMessageRef() {
        return (Message) eDynamicGet(Bpmn2Package.MESSAGE_FLOW__MESSAGE_REF, Bpmn2Package.Literals.MESSAGE_FLOW__MESSAGE_REF, false, true);
    }
    ...
    public void setMessageRef(Message newMessageRef) {
        eDynamicSet(Bpmn2Package.MESSAGE_FLOW__MESSAGE_REF, Bpmn2Package.Literals.MESSAGE_FLOW__MESSAGE_REF, newMessageRef);
    }
