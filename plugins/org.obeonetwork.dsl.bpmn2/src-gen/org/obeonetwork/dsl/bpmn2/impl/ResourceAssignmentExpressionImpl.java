...
public class ResourceAssignmentExpressionImpl extends BPMN2ObjectImpl implements ResourceAssignmentExpression {
    ...
    public Expression getExpression() {
        return (Expression) eDynamicGet(Bpmn2Package.RESOURCE_ASSIGNMENT_EXPRESSION__EXPRESSION, Bpmn2Package.Literals.RESOURCE_ASSIGNMENT_EXPRESSION__EXPRESSION, true, true);
    }
    ...
    public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
        msgs = eDynamicInverseAdd((InternalEObject) newExpression, Bpmn2Package.RESOURCE_ASSIGNMENT_EXPRESSION__EXPRESSION, msgs);
        return msgs;
    }
    ...
    public void setExpression(Expression newExpression) {
        eDynamicSet(Bpmn2Package.RESOURCE_ASSIGNMENT_EXPRESSION__EXPRESSION, Bpmn2Package.Literals.RESOURCE_ASSIGNMENT_EXPRESSION__EXPRESSION, newExpression);
    }
    ...
    @Override
    public String getId() {
        return (String) eDynamicGet(Bpmn2Package.RESOURCE_ASSIGNMENT_EXPRESSION__ID, Bpmn2Package.Literals.RESOURCE_ASSIGNMENT_EXPRESSION__ID, true, true);
    }
    ...
    public void setId(String newId) {
        eDynamicSet(Bpmn2Package.RESOURCE_ASSIGNMENT_EXPRESSION__ID, Bpmn2Package.Literals.RESOURCE_ASSIGNMENT_EXPRESSION__ID, newId);
    }
