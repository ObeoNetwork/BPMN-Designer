...
public class ResourceParameterImpl extends BaseElementImpl implements ResourceParameter {
    ...
    public String getName() {
        return (String) eDynamicGet(Bpmn2Package.RESOURCE_PARAMETER__NAME, Bpmn2Package.Literals.RESOURCE_PARAMETER__NAME, true, true);
    }
    ...
    public boolean isIsRequired() {
        return (Boolean) eDynamicGet(Bpmn2Package.RESOURCE_PARAMETER__IS_REQUIRED, Bpmn2Package.Literals.RESOURCE_PARAMETER__IS_REQUIRED, true, true);
    }
    ...
    public void setIsRequired(boolean newIsRequired) {
        eDynamicSet(Bpmn2Package.RESOURCE_PARAMETER__IS_REQUIRED, Bpmn2Package.Literals.RESOURCE_PARAMETER__IS_REQUIRED, newIsRequired);
    }
    ...
    public ItemDefinition getType() {
        return (ItemDefinition) eDynamicGet(Bpmn2Package.RESOURCE_PARAMETER__TYPE, Bpmn2Package.Literals.RESOURCE_PARAMETER__TYPE, true, true);
    }
    ...
    public ItemDefinition basicGetType() {
        return (ItemDefinition) eDynamicGet(Bpmn2Package.RESOURCE_PARAMETER__TYPE, Bpmn2Package.Literals.RESOURCE_PARAMETER__TYPE, false, true);
    }
