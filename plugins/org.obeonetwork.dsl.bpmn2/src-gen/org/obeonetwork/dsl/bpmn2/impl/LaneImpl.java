...
public class LaneImpl extends BaseElementImpl implements Lane {
    ...
    public LaneSet getChildLaneSet() {
        return (LaneSet) eDynamicGet(Bpmn2Package.LANE__CHILD_LANE_SET, Bpmn2Package.Literals.LANE__CHILD_LANE_SET, true, true);
    }
    ...
    public NotificationChain basicSetChildLaneSet(LaneSet newChildLaneSet, NotificationChain msgs) {
        msgs = eDynamicInverseAdd((InternalEObject) newChildLaneSet, Bpmn2Package.LANE__CHILD_LANE_SET, msgs);
        return msgs;
    }
    ...
    public BaseElement getPartitionElementRef() {
        return (BaseElement) eDynamicGet(Bpmn2Package.LANE__PARTITION_ELEMENT_REF, Bpmn2Package.Literals.LANE__PARTITION_ELEMENT_REF, true, true);
    }
    ...
    public BaseElement basicGetPartitionElementRef() {
        return (BaseElement) eDynamicGet(Bpmn2Package.LANE__PARTITION_ELEMENT_REF, Bpmn2Package.Literals.LANE__PARTITION_ELEMENT_REF, false, true);
    }
    ...
    public void setPartitionElementRef(BaseElement newPartitionElementRef) {
        eDynamicSet(Bpmn2Package.LANE__PARTITION_ELEMENT_REF, Bpmn2Package.Literals.LANE__PARTITION_ELEMENT_REF, newPartitionElementRef);
    }
    ...
    public EList<FlowNode> getFlowNodeRefs() {
        return (EList<FlowNode>) eDynamicGet(Bpmn2Package.LANE__FLOW_NODE_REFS, Bpmn2Package.Literals.LANE__FLOW_NODE_REFS, true, true);
    }
    ...
    public BaseElement getPartitionElement() {
        return (BaseElement) eDynamicGet(Bpmn2Package.LANE__PARTITION_ELEMENT, Bpmn2Package.Literals.LANE__PARTITION_ELEMENT, true, true);
    }
    ...
    public NotificationChain basicSetPartitionElement(BaseElement newPartitionElement, NotificationChain msgs) {
        msgs = eDynamicInverseAdd((InternalEObject) newPartitionElement, Bpmn2Package.LANE__PARTITION_ELEMENT, msgs);
        return msgs;
    }
    ...
    public void setPartitionElement(BaseElement newPartitionElement) {
        eDynamicSet(Bpmn2Package.LANE__PARTITION_ELEMENT, Bpmn2Package.Literals.LANE__PARTITION_ELEMENT, newPartitionElement);
    }
