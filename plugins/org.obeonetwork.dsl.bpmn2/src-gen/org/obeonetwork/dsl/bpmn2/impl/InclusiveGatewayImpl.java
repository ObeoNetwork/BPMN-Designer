...
public class InclusiveGatewayImpl extends GatewayImpl implements InclusiveGateway {
    ...
    public SequenceFlow getDefault() {
        return (SequenceFlow) eDynamicGet(Bpmn2Package.INCLUSIVE_GATEWAY__DEFAULT, Bpmn2Package.Literals.INCLUSIVE_GATEWAY__DEFAULT, true, true);
    }
    ...
    public SequenceFlow basicGetDefault() {
        return (SequenceFlow) eDynamicGet(Bpmn2Package.INCLUSIVE_GATEWAY__DEFAULT, Bpmn2Package.Literals.INCLUSIVE_GATEWAY__DEFAULT, false, true);
    }
    ...
    public void setDefault(SequenceFlow newDefault) {
        eDynamicSet(Bpmn2Package.INCLUSIVE_GATEWAY__DEFAULT, Bpmn2Package.Literals.INCLUSIVE_GATEWAY__DEFAULT, newDefault);
    }
