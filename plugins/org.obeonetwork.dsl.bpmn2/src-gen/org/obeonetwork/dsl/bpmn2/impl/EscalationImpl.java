...
public class EscalationImpl extends BPMN2ObjectImpl implements Escalation {
    ...
    public ItemDefinition getStructureRef() {
        return (ItemDefinition) eDynamicGet(Bpmn2Package.ESCALATION__STRUCTURE_REF, Bpmn2Package.Literals.ESCALATION__STRUCTURE_REF, true, true);
    }
    ...
    public ItemDefinition basicGetStructureRef() {
        return (ItemDefinition) eDynamicGet(Bpmn2Package.ESCALATION__STRUCTURE_REF, Bpmn2Package.Literals.ESCALATION__STRUCTURE_REF, false, true);
    }
    ...
    public void setStructureRef(ItemDefinition newStructureRef) {
        eDynamicSet(Bpmn2Package.ESCALATION__STRUCTURE_REF, Bpmn2Package.Literals.ESCALATION__STRUCTURE_REF, newStructureRef);
    }
    ...
    public String getEscalationCode() {
        return (String) eDynamicGet(Bpmn2Package.ESCALATION__ESCALATION_CODE, Bpmn2Package.Literals.ESCALATION__ESCALATION_CODE, true, true);
    }
    ...
    public void setEscalationCode(String newEscalationCode) {
        eDynamicSet(Bpmn2Package.ESCALATION__ESCALATION_CODE, Bpmn2Package.Literals.ESCALATION__ESCALATION_CODE, newEscalationCode);
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case Bpmn2Package.ESCALATION__ESCALATION_CODE:
            return ESCALATION_CODE_EDEFAULT == null ? getEscalationCode() != null : !ESCALATION_CODE_EDEFAULT.equals(getEscalationCode());
        case Bpmn2Package.ESCALATION__ID:
