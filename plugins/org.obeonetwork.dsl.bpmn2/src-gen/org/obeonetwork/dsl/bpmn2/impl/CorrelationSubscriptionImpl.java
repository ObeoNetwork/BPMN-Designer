...
public class CorrelationSubscriptionImpl extends BaseElementImpl implements CorrelationSubscription {
    ...
    public CorrelationKey getCorrelationKeyRef() {
        return (CorrelationKey) eDynamicGet(Bpmn2Package.CORRELATION_SUBSCRIPTION__CORRELATION_KEY_REF, Bpmn2Package.Literals.CORRELATION_SUBSCRIPTION__CORRELATION_KEY_REF, true, true);
    }
    ...
    public CorrelationKey basicGetCorrelationKeyRef() {
        return (CorrelationKey) eDynamicGet(Bpmn2Package.CORRELATION_SUBSCRIPTION__CORRELATION_KEY_REF, Bpmn2Package.Literals.CORRELATION_SUBSCRIPTION__CORRELATION_KEY_REF, false, true);
    }
    ...
    public void setCorrelationKeyRef(CorrelationKey newCorrelationKeyRef) {
        eDynamicSet(Bpmn2Package.CORRELATION_SUBSCRIPTION__CORRELATION_KEY_REF, Bpmn2Package.Literals.CORRELATION_SUBSCRIPTION__CORRELATION_KEY_REF, newCorrelationKeyRef);
    }
    ...
    public EList<CorrelationPropertyBinding> getCorrelationPropertyBinding() {
        return (EList<CorrelationPropertyBinding>) eDynamicGet(Bpmn2Package.CORRELATION_SUBSCRIPTION__CORRELATION_PROPERTY_BINDING,
