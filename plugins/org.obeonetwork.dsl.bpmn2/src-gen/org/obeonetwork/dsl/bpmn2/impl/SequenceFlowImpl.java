...
public class SequenceFlowImpl extends FlowElementImpl implements SequenceFlow {
    ...
    public boolean isIsImmediate() {
        return (Boolean) eDynamicGet(Bpmn2Package.SEQUENCE_FLOW__IS_IMMEDIATE, Bpmn2Package.Literals.SEQUENCE_FLOW__IS_IMMEDIATE, true, true);
    }
    ...
    public void setIsImmediate(boolean newIsImmediate) {
        eDynamicSet(Bpmn2Package.SEQUENCE_FLOW__IS_IMMEDIATE, Bpmn2Package.Literals.SEQUENCE_FLOW__IS_IMMEDIATE, newIsImmediate);
    }
    ...
    public Expression getConditionExpression() {
        return (Expression) eDynamicGet(Bpmn2Package.SEQUENCE_FLOW__CONDITION_EXPRESSION, Bpmn2Package.Literals.SEQUENCE_FLOW__CONDITION_EXPRESSION, true, true);
    }
    ...
    public NotificationChain basicSetConditionExpression(Expression newConditionExpression, NotificationChain msgs) {
        msgs = eDynamicInverseAdd((InternalEObject) newConditionExpression, Bpmn2Package.SEQUENCE_FLOW__CONDITION_EXPRESSION, msgs);
        return msgs;
    }
    ...
    public void setConditionExpression(Expression newConditionExpression) {
        eDynamicSet(Bpmn2Package.SEQUENCE_FLOW__CONDITION_EXPRESSION, Bpmn2Package.Literals.SEQUENCE_FLOW__CONDITION_EXPRESSION, newConditionExpression);
    }
    ...
    public FlowNode getTargetRef() {
        return (FlowNode) eDynamicGet(Bpmn2Package.SEQUENCE_FLOW__TARGET_REF, Bpmn2Package.Literals.SEQUENCE_FLOW__TARGET_REF, true, true);
    }
    ...
    public FlowNode basicGetTargetRef() {
        return (FlowNode) eDynamicGet(Bpmn2Package.SEQUENCE_FLOW__TARGET_REF, Bpmn2Package.Literals.SEQUENCE_FLOW__TARGET_REF, false, true);
    }
    ...
    public void setTargetRef(FlowNode newTargetRef) {
        eDynamicSet(Bpmn2Package.SEQUENCE_FLOW__TARGET_REF, Bpmn2Package.Literals.SEQUENCE_FLOW__TARGET_REF, newTargetRef);
    }
    ...
    public FlowNode getSourceRef() {
        return (FlowNode) eDynamicGet(Bpmn2Package.SEQUENCE_FLOW__SOURCE_REF, Bpmn2Package.Literals.SEQUENCE_FLOW__SOURCE_REF, true, true);
    }
    ...
    public FlowNode basicGetSourceRef() {
        return (FlowNode) eDynamicGet(Bpmn2Package.SEQUENCE_FLOW__SOURCE_REF, Bpmn2Package.Literals.SEQUENCE_FLOW__SOURCE_REF, false, true);
    }
    ...
    public void setSourceRef(FlowNode newSourceRef) {
        eDynamicSet(Bpmn2Package.SEQUENCE_FLOW__SOURCE_REF, Bpmn2Package.Literals.SEQUENCE_FLOW__SOURCE_REF, newSourceRef);
    }
