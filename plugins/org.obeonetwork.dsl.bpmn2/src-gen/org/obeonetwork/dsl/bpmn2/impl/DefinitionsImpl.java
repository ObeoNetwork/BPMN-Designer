...
public class DefinitionsImpl extends BaseElementImpl implements Definitions {
    ...
    public String getName() {
        return (String) eDynamicGet(Bpmn2Package.DEFINITIONS__NAME, Bpmn2Package.Literals.DEFINITIONS__NAME, true, true);
    }
    ...
    public String getTargetNamespace() {
        return (String) eDynamicGet(Bpmn2Package.DEFINITIONS__TARGET_NAMESPACE, Bpmn2Package.Literals.DEFINITIONS__TARGET_NAMESPACE, true, true);
    }
    ...
    public void setTargetNamespace(String newTargetNamespace) {
        eDynamicSet(Bpmn2Package.DEFINITIONS__TARGET_NAMESPACE, Bpmn2Package.Literals.DEFINITIONS__TARGET_NAMESPACE, newTargetNamespace);
    }
    ...
    public String getExpressionLanguage() {
        return (String) eDynamicGet(Bpmn2Package.DEFINITIONS__EXPRESSION_LANGUAGE, Bpmn2Package.Literals.DEFINITIONS__EXPRESSION_LANGUAGE, true, true);
    }
    ...
    public void setExpressionLanguage(String newExpressionLanguage) {
        eDynamicSet(Bpmn2Package.DEFINITIONS__EXPRESSION_LANGUAGE, Bpmn2Package.Literals.DEFINITIONS__EXPRESSION_LANGUAGE, newExpressionLanguage);
    }
    ...
    public String getTypeLanguage() {
        return (String) eDynamicGet(Bpmn2Package.DEFINITIONS__TYPE_LANGUAGE, Bpmn2Package.Literals.DEFINITIONS__TYPE_LANGUAGE, true, true);
    }
    ...
    public void setTypeLanguage(String newTypeLanguage) {
        eDynamicSet(Bpmn2Package.DEFINITIONS__TYPE_LANGUAGE, Bpmn2Package.Literals.DEFINITIONS__TYPE_LANGUAGE, newTypeLanguage);
    }
    ...
    public EList<Import> getImports() {
        return (EList<Import>) eDynamicGet(Bpmn2Package.DEFINITIONS__IMPORTS, Bpmn2Package.Literals.DEFINITIONS__IMPORTS, true, true);
    }
    ...
    public EList<Extension> getExtensions() {
        return (EList<Extension>) eDynamicGet(Bpmn2Package.DEFINITIONS__EXTENSIONS, Bpmn2Package.Literals.DEFINITIONS__EXTENSIONS, true, true);
    }
    ...
    public EList<Relationship> getRelationships() {
        return (EList<Relationship>) eDynamicGet(Bpmn2Package.DEFINITIONS__RELATIONSHIPS, Bpmn2Package.Literals.DEFINITIONS__RELATIONSHIPS, true, true);
    }
    ...
    public EList<RootElement> getRootElements() {
        return (EList<RootElement>) eDynamicGet(Bpmn2Package.DEFINITIONS__ROOT_ELEMENTS, Bpmn2Package.Literals.DEFINITIONS__ROOT_ELEMENTS, true, true);
    }
    ...
    public EList<BPMNDiagram> getDiagrams() {
        return (EList<BPMNDiagram>) eDynamicGet(Bpmn2Package.DEFINITIONS__DIAGRAMS, Bpmn2Package.Literals.DEFINITIONS__DIAGRAMS, true, true);
    }
    ...
    public String getExporter() {
        return (String) eDynamicGet(Bpmn2Package.DEFINITIONS__EXPORTER, Bpmn2Package.Literals.DEFINITIONS__EXPORTER, true, true);
    }
    ...
    public String getExporterVersion() {
        return (String) eDynamicGet(Bpmn2Package.DEFINITIONS__EXPORTER_VERSION, Bpmn2Package.Literals.DEFINITIONS__EXPORTER_VERSION, true, true);
    }
    ...
    public void setExporterVersion(String newExporterVersion) {
        eDynamicSet(Bpmn2Package.DEFINITIONS__EXPORTER_VERSION, Bpmn2Package.Literals.DEFINITIONS__EXPORTER_VERSION, newExporterVersion);
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case Bpmn2Package.DEFINITIONS__TYPE_LANGUAGE:
            return TYPE_LANGUAGE_EDEFAULT == null ? getTypeLanguage() != null : !TYPE_LANGUAGE_EDEFAULT.equals(getTypeLanguage());
        case Bpmn2Package.DEFINITIONS__IMPORTS:
        ...
        case Bpmn2Package.DEFINITIONS__EXPORTER:
            return EXPORTER_EDEFAULT == null ? getExporter() != null : !EXPORTER_EDEFAULT.equals(getExporter());
        case Bpmn2Package.DEFINITIONS__EXPORTER_VERSION:
            return EXPORTER_VERSION_EDEFAULT == null ? getExporterVersion() != null : !EXPORTER_VERSION_EDEFAULT.equals(getExporterVersion());
        }
