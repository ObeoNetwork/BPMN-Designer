...
public class ResourceParameterBindingImpl extends CDOObjectImpl implements
	...
	public String getId() {
		return (String) eDynamicGet(
				Bpmn2Package.RESOURCE_PARAMETER_BINDING__ID,
	...
	public void setId(String newId) {
		eDynamicSet(Bpmn2Package.RESOURCE_PARAMETER_BINDING__ID,
				Bpmn2Package.Literals.RESOURCE_PARAMETER_BINDING__ID, newId);
	}
