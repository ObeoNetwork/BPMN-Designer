...
public class ResourceParameterBindingImpl extends BPMN2ObjectImpl implements ResourceParameterBinding {
	...
	public Expression getExpression() {
		return (Expression) eDynamicGet(Bpmn2Package.RESOURCE_PARAMETER_BINDING__EXPRESSION,
				Bpmn2Package.Literals.RESOURCE_PARAMETER_BINDING__EXPRESSION, true, true);
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject) newExpression, Bpmn2Package.RESOURCE_PARAMETER_BINDING__EXPRESSION,
				msgs);
		return msgs;
	}
	...
	public void setExpression(Expression newExpression) {
		eDynamicSet(Bpmn2Package.RESOURCE_PARAMETER_BINDING__EXPRESSION,
				Bpmn2Package.Literals.RESOURCE_PARAMETER_BINDING__EXPRESSION, newExpression);
	}
	...
	public ResourceParameter getParameterRef() {
		return (ResourceParameter) eDynamicGet(Bpmn2Package.RESOURCE_PARAMETER_BINDING__PARAMETER_REF,
				Bpmn2Package.Literals.RESOURCE_PARAMETER_BINDING__PARAMETER_REF, true, true);
	}
	...
	public ResourceParameter basicGetParameterRef() {
		return (ResourceParameter) eDynamicGet(Bpmn2Package.RESOURCE_PARAMETER_BINDING__PARAMETER_REF,
				Bpmn2Package.Literals.RESOURCE_PARAMETER_BINDING__PARAMETER_REF, false, true);
	}
	...
	public void setParameterRef(ResourceParameter newParameterRef) {
		eDynamicSet(Bpmn2Package.RESOURCE_PARAMETER_BINDING__PARAMETER_REF,
				Bpmn2Package.Literals.RESOURCE_PARAMETER_BINDING__PARAMETER_REF, newParameterRef);
	}
	...
	@Override
	public String getId() {
		return (String) eDynamicGet(Bpmn2Package.RESOURCE_PARAMETER_BINDING__ID,
				Bpmn2Package.Literals.RESOURCE_PARAMETER_BINDING__ID, true, true);
	}
	...
	public void setId(String newId) {
		eDynamicSet(Bpmn2Package.RESOURCE_PARAMETER_BINDING__ID, Bpmn2Package.Literals.RESOURCE_PARAMETER_BINDING__ID,
				newId);
	}
