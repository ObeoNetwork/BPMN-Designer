...
public class DataStoreImpl extends ItemAwareElementImpl implements DataStore {
    ...
    public int getCapacity() {
        return (Integer) eDynamicGet(Bpmn2Package.DATA_STORE__CAPACITY, Bpmn2Package.Literals.DATA_STORE__CAPACITY, true, true);
    }
    ...
    public boolean isIsUnlimited() {
        return (Boolean) eDynamicGet(Bpmn2Package.DATA_STORE__IS_UNLIMITED, Bpmn2Package.Literals.DATA_STORE__IS_UNLIMITED, true, true);
    }
    ...
    public void setIsUnlimited(boolean newIsUnlimited) {
        eDynamicSet(Bpmn2Package.DATA_STORE__IS_UNLIMITED, Bpmn2Package.Literals.DATA_STORE__IS_UNLIMITED, newIsUnlimited);
    }
