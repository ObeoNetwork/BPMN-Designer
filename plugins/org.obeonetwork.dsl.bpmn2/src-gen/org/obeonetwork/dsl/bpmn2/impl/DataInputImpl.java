...
public class DataInputImpl extends ItemAwareElementImpl implements DataInput {
    ...
    public boolean isIsCollection() {
        return (Boolean) eDynamicGet(Bpmn2Package.DATA_INPUT__IS_COLLECTION, Bpmn2Package.Literals.DATA_INPUT__IS_COLLECTION, true, true);
    }
    ...
    public void setIsCollection(boolean newIsCollection) {
        eDynamicSet(Bpmn2Package.DATA_INPUT__IS_COLLECTION, Bpmn2Package.Literals.DATA_INPUT__IS_COLLECTION, newIsCollection);
    }
    ...
    public EList<InputSet> getInputSetWithOptional() {
        return (EList<InputSet>) eDynamicGet(Bpmn2Package.DATA_INPUT__INPUT_SET_WITH_OPTIONAL, Bpmn2Package.Literals.DATA_INPUT__INPUT_SET_WITH_OPTIONAL, true, true);
    }
    ...
    public EList<InputSet> getInputSetWithWhileExecuting() {
        return (EList<InputSet>) eDynamicGet(Bpmn2Package.DATA_INPUT__INPUT_SET_WITH_WHILE_EXECUTING, Bpmn2Package.Literals.DATA_INPUT__INPUT_SET_WITH_WHILE_EXECUTING, true, true);
    }
    ...
    public EList<InputSet> getInputSetRefs() {
        return (EList<InputSet>) eDynamicGet(Bpmn2Package.DATA_INPUT__INPUT_SET_REFS, Bpmn2Package.Literals.DATA_INPUT__INPUT_SET_REFS, true, true);
    }
