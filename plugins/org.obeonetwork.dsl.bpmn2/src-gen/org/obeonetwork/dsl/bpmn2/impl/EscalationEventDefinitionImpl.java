...
public class EscalationEventDefinitionImpl extends EventDefinitionImpl implements EscalationEventDefinition {
    ...
    public Escalation getEscalationRef() {
        return (Escalation) eDynamicGet(Bpmn2Package.ESCALATION_EVENT_DEFINITION__ESCALATION_REF, Bpmn2Package.Literals.ESCALATION_EVENT_DEFINITION__ESCALATION_REF, true, true);
    }
    ...
    public Escalation basicGetEscalationRef() {
        return (Escalation) eDynamicGet(Bpmn2Package.ESCALATION_EVENT_DEFINITION__ESCALATION_REF, Bpmn2Package.Literals.ESCALATION_EVENT_DEFINITION__ESCALATION_REF, false, true);
    }
    ...
    public void setEscalationRef(Escalation newEscalationRef) {
        eDynamicSet(Bpmn2Package.ESCALATION_EVENT_DEFINITION__ESCALATION_REF, Bpmn2Package.Literals.ESCALATION_EVENT_DEFINITION__ESCALATION_REF, newEscalationRef);
    }
