...
public class ErrorImpl extends RootElementImpl implements org.obeonetwork.dsl.bpmn2.Error {
    ...
    public ItemDefinition getStructureRef() {
        return (ItemDefinition) eDynamicGet(Bpmn2Package.ERROR__STRUCTURE_REF, Bpmn2Package.Literals.ERROR__STRUCTURE_REF, true, true);
    }
    ...
    public ItemDefinition basicGetStructureRef() {
        return (ItemDefinition) eDynamicGet(Bpmn2Package.ERROR__STRUCTURE_REF, Bpmn2Package.Literals.ERROR__STRUCTURE_REF, false, true);
    }
    ...
    public String getErrorCode() {
        return (String) eDynamicGet(Bpmn2Package.ERROR__ERROR_CODE, Bpmn2Package.Literals.ERROR__ERROR_CODE, true, true);
    }
