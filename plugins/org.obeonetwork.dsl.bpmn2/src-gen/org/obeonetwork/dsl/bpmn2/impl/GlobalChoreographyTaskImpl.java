...
public class GlobalChoreographyTaskImpl extends ChoreographyImpl implements GlobalChoreographyTask {
    ...
    public Participant getInitiatingParticipantRef() {
        return (Participant) eDynamicGet(Bpmn2Package.GLOBAL_CHOREOGRAPHY_TASK__INITIATING_PARTICIPANT_REF, Bpmn2Package.Literals.GLOBAL_CHOREOGRAPHY_TASK__INITIATING_PARTICIPANT_REF, true, true);
    }
    ...
    public Participant basicGetInitiatingParticipantRef() {
        return (Participant) eDynamicGet(Bpmn2Package.GLOBAL_CHOREOGRAPHY_TASK__INITIATING_PARTICIPANT_REF, Bpmn2Package.Literals.GLOBAL_CHOREOGRAPHY_TASK__INITIATING_PARTICIPANT_REF, false, true);
    }
    ...
    public void setInitiatingParticipantRef(Participant newInitiatingParticipantRef) {
        eDynamicSet(Bpmn2Package.GLOBAL_CHOREOGRAPHY_TASK__INITIATING_PARTICIPANT_REF, Bpmn2Package.Literals.GLOBAL_CHOREOGRAPHY_TASK__INITIATING_PARTICIPANT_REF, newInitiatingParticipantRef);
    }
