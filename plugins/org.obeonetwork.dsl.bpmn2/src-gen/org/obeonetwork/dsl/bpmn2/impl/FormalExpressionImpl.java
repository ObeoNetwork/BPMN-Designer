...
public class FormalExpressionImpl extends ExpressionImpl implements FormalExpression {
    ...
    public String getLanguage() {
        return (String) eDynamicGet(Bpmn2Package.FORMAL_EXPRESSION__LANGUAGE, Bpmn2Package.Literals.FORMAL_EXPRESSION__LANGUAGE, true, true);
    }
    ...
    public void setLanguage(String newLanguage) {
        eDynamicSet(Bpmn2Package.FORMAL_EXPRESSION__LANGUAGE, Bpmn2Package.Literals.FORMAL_EXPRESSION__LANGUAGE, newLanguage);
    }
    ...
    public EObject getBody() {
        return (EObject) eDynamicGet(Bpmn2Package.FORMAL_EXPRESSION__BODY, Bpmn2Package.Literals.FORMAL_EXPRESSION__BODY, true, true);
    }
    ...
    public EObject basicGetBody() {
        return (EObject) eDynamicGet(Bpmn2Package.FORMAL_EXPRESSION__BODY, Bpmn2Package.Literals.FORMAL_EXPRESSION__BODY, false, true);
    }
    ...
    public ItemDefinition getEvaluatesToTypeRef() {
        return (ItemDefinition) eDynamicGet(Bpmn2Package.FORMAL_EXPRESSION__EVALUATES_TO_TYPE_REF, Bpmn2Package.Literals.FORMAL_EXPRESSION__EVALUATES_TO_TYPE_REF, true, true);
    }
    ...
    public ItemDefinition basicGetEvaluatesToTypeRef() {
        return (ItemDefinition) eDynamicGet(Bpmn2Package.FORMAL_EXPRESSION__EVALUATES_TO_TYPE_REF, Bpmn2Package.Literals.FORMAL_EXPRESSION__EVALUATES_TO_TYPE_REF, false, true);
    }
    ...
    public void setEvaluatesToTypeRef(ItemDefinition newEvaluatesToTypeRef) {
        eDynamicSet(Bpmn2Package.FORMAL_EXPRESSION__EVALUATES_TO_TYPE_REF, Bpmn2Package.Literals.FORMAL_EXPRESSION__EVALUATES_TO_TYPE_REF, newEvaluatesToTypeRef);
    }
