...
public class ConversationAssociationImpl extends BaseElementImpl implements ConversationAssociation {
    ...
    public ConversationNode getInnerConversationNodeRef() {
        return (ConversationNode) eDynamicGet(Bpmn2Package.CONVERSATION_ASSOCIATION__INNER_CONVERSATION_NODE_REF, Bpmn2Package.Literals.CONVERSATION_ASSOCIATION__INNER_CONVERSATION_NODE_REF, true,
                true);
    }
    ...
    public ConversationNode basicGetInnerConversationNodeRef() {
        return (ConversationNode) eDynamicGet(Bpmn2Package.CONVERSATION_ASSOCIATION__INNER_CONVERSATION_NODE_REF, Bpmn2Package.Literals.CONVERSATION_ASSOCIATION__INNER_CONVERSATION_NODE_REF, false,
                true);
    }
    ...
    public void setInnerConversationNodeRef(ConversationNode newInnerConversationNodeRef) {
        eDynamicSet(Bpmn2Package.CONVERSATION_ASSOCIATION__INNER_CONVERSATION_NODE_REF, Bpmn2Package.Literals.CONVERSATION_ASSOCIATION__INNER_CONVERSATION_NODE_REF, newInnerConversationNodeRef);
    }
    ...
    public ConversationNode getOuterConversationNodeRef() {
        return (ConversationNode) eDynamicGet(Bpmn2Package.CONVERSATION_ASSOCIATION__OUTER_CONVERSATION_NODE_REF, Bpmn2Package.Literals.CONVERSATION_ASSOCIATION__OUTER_CONVERSATION_NODE_REF, true,
                true);
    }
    ...
    public ConversationNode basicGetOuterConversationNodeRef() {
        return (ConversationNode) eDynamicGet(Bpmn2Package.CONVERSATION_ASSOCIATION__OUTER_CONVERSATION_NODE_REF, Bpmn2Package.Literals.CONVERSATION_ASSOCIATION__OUTER_CONVERSATION_NODE_REF, false,
                true);
    }
    ...
    public void setOuterConversationNodeRef(ConversationNode newOuterConversationNodeRef) {
        eDynamicSet(Bpmn2Package.CONVERSATION_ASSOCIATION__OUTER_CONVERSATION_NODE_REF, Bpmn2Package.Literals.CONVERSATION_ASSOCIATION__OUTER_CONVERSATION_NODE_REF, newOuterConversationNodeRef);
    }
