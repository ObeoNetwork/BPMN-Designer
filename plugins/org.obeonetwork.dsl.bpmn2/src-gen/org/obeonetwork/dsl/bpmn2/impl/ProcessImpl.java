...
public class ProcessImpl extends CallableElementImpl implements org.obeonetwork.dsl.bpmn2.Process {
    ...
    public EList<FlowElement> getFlowElements() {
        return (EList<FlowElement>) eDynamicGet(Bpmn2Package.PROCESS__FLOW_ELEMENTS, Bpmn2Package.Literals.FLOW_ELEMENTS_CONTAINER__FLOW_ELEMENTS, true, true);
    }
    ...
    public EList<LaneSet> getLaneSets() {
        return (EList<LaneSet>) eDynamicGet(Bpmn2Package.PROCESS__LANE_SETS, Bpmn2Package.Literals.FLOW_ELEMENTS_CONTAINER__LANE_SETS, true, true);
    }
    ...
    public ProcessType getProcessType() {
        return (ProcessType) eDynamicGet(Bpmn2Package.PROCESS__PROCESS_TYPE, Bpmn2Package.Literals.PROCESS__PROCESS_TYPE, true, true);
    }
    ...
    public boolean isIsClosed() {
        return (Boolean) eDynamicGet(Bpmn2Package.PROCESS__IS_CLOSED, Bpmn2Package.Literals.PROCESS__IS_CLOSED, true, true);
    }
    ...
    public Auditing getAuditing() {
        return (Auditing) eDynamicGet(Bpmn2Package.PROCESS__AUDITING, Bpmn2Package.Literals.PROCESS__AUDITING, true, true);
    }
    ...
    public Monitoring getMonitoring() {
        return (Monitoring) eDynamicGet(Bpmn2Package.PROCESS__MONITORING, Bpmn2Package.Literals.PROCESS__MONITORING, true, true);
    }
    ...
    public EList<Property> getProperties() {
        return (EList<Property>) eDynamicGet(Bpmn2Package.PROCESS__PROPERTIES, Bpmn2Package.Literals.PROCESS__PROPERTIES, true, true);
    }
    ...
    public EList<org.obeonetwork.dsl.bpmn2.Process> getSupports() {
        return (EList<org.obeonetwork.dsl.bpmn2.Process>) eDynamicGet(Bpmn2Package.PROCESS__SUPPORTS, Bpmn2Package.Literals.PROCESS__SUPPORTS, true, true);
    }
    ...
    public Collaboration getDefinitionalCollaborationRef() {
        return (Collaboration) eDynamicGet(Bpmn2Package.PROCESS__DEFINITIONAL_COLLABORATION_REF, Bpmn2Package.Literals.PROCESS__DEFINITIONAL_COLLABORATION_REF, true, true);
    }
    ...
    public Collaboration basicGetDefinitionalCollaborationRef() {
        return (Collaboration) eDynamicGet(Bpmn2Package.PROCESS__DEFINITIONAL_COLLABORATION_REF, Bpmn2Package.Literals.PROCESS__DEFINITIONAL_COLLABORATION_REF, false, true);
    }
    ...
    public void setDefinitionalCollaborationRef(Collaboration newDefinitionalCollaborationRef) {
        eDynamicSet(Bpmn2Package.PROCESS__DEFINITIONAL_COLLABORATION_REF, Bpmn2Package.Literals.PROCESS__DEFINITIONAL_COLLABORATION_REF, newDefinitionalCollaborationRef);
    }
    ...
    public boolean isIsExecutable() {
        return (Boolean) eDynamicGet(Bpmn2Package.PROCESS__IS_EXECUTABLE, Bpmn2Package.Literals.PROCESS__IS_EXECUTABLE, true, true);
    }
    ...
    public EList<ResourceRole> getResources() {
        return (EList<ResourceRole>) eDynamicGet(Bpmn2Package.PROCESS__RESOURCES, Bpmn2Package.Literals.PROCESS__RESOURCES, true, true);
    }
    ...
    public EList<Artifact> getArtifacts() {
        return (EList<Artifact>) eDynamicGet(Bpmn2Package.PROCESS__ARTIFACTS, Bpmn2Package.Literals.PROCESS__ARTIFACTS, true, true);
    }
    ...
    public EList<CorrelationSubscription> getCorrelationSubscriptions() {
        return (EList<CorrelationSubscription>) eDynamicGet(Bpmn2Package.PROCESS__CORRELATION_SUBSCRIPTIONS, Bpmn2Package.Literals.PROCESS__CORRELATION_SUBSCRIPTIONS, true, true);
    }
    ...
    public EList<org.obeonetwork.dsl.bpmn2.Process> getDecomposedBy() {
        return (EList<org.obeonetwork.dsl.bpmn2.Process>) eDynamicGet(Bpmn2Package.PROCESS__DECOMPOSED_BY, Bpmn2Package.Literals.PROCESS__DECOMPOSED_BY, true, true);
    }
    ...
    public org.obeonetwork.dsl.bpmn2.Process getDecomposes() {
        return (org.obeonetwork.dsl.bpmn2.Process) eDynamicGet(Bpmn2Package.PROCESS__DECOMPOSES, Bpmn2Package.Literals.PROCESS__DECOMPOSES, true, true);
    }
     ...
     * @generated
     */
    public NotificationChain basicSetDecomposes(org.obeonetwork.dsl.bpmn2.Process newDecomposes, NotificationChain msgs) {
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case Bpmn2Package.PROCESS__DECOMPOSES:
            return eInternalContainer().eInverseRemove(this, Bpmn2Package.PROCESS__DECOMPOSED_BY, org.obeonetwork.dsl.bpmn2.Process.class, msgs);
        }
