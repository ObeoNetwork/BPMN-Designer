...
public class DataOutputImpl extends ItemAwareElementImpl implements DataOutput {
    ...
    public String getName() {
        return (String) eDynamicGet(Bpmn2Package.DATA_OUTPUT__NAME, Bpmn2Package.Literals.DATA_OUTPUT__NAME, true, true);
    }
    ...
    public boolean isIsCollection() {
        return (Boolean) eDynamicGet(Bpmn2Package.DATA_OUTPUT__IS_COLLECTION, Bpmn2Package.Literals.DATA_OUTPUT__IS_COLLECTION, true, true);
    }
    ...
    public void setIsCollection(boolean newIsCollection) {
        eDynamicSet(Bpmn2Package.DATA_OUTPUT__IS_COLLECTION, Bpmn2Package.Literals.DATA_OUTPUT__IS_COLLECTION, newIsCollection);
    }
    ...
    public EList<OutputSet> getOutputSetWithOptional() {
        return (EList<OutputSet>) eDynamicGet(Bpmn2Package.DATA_OUTPUT__OUTPUT_SET_WITH_OPTIONAL, Bpmn2Package.Literals.DATA_OUTPUT__OUTPUT_SET_WITH_OPTIONAL, true, true);
    }
    ...
    public EList<OutputSet> getOutputSetWithWhileExecuting() {
        return (EList<OutputSet>) eDynamicGet(Bpmn2Package.DATA_OUTPUT__OUTPUT_SET_WITH_WHILE_EXECUTING, Bpmn2Package.Literals.DATA_OUTPUT__OUTPUT_SET_WITH_WHILE_EXECUTING, true, true);
    }
    ...
    public EList<OutputSet> getOutputSetRefs() {
        return (EList<OutputSet>) eDynamicGet(Bpmn2Package.DATA_OUTPUT__OUTPUT_SET_REFS, Bpmn2Package.Literals.DATA_OUTPUT__OUTPUT_SET_REFS, true, true);
    }
