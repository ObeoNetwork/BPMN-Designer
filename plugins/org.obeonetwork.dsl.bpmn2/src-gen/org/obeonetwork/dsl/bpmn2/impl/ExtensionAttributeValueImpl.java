...
public class ExtensionAttributeValueImpl extends BPMN2ObjectImpl implements ExtensionAttributeValue {
    ...
    public EObject getValueRef() {
        return (EObject) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_VALUE__VALUE_REF, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_VALUE__VALUE_REF, true, true);
    }
    ...
    public EObject basicGetValueRef() {
        return (EObject) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_VALUE__VALUE_REF, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_VALUE__VALUE_REF, false, true);
    }
    ...
    public void setValueRef(EObject newValueRef) {
        eDynamicSet(Bpmn2Package.EXTENSION_ATTRIBUTE_VALUE__VALUE_REF, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_VALUE__VALUE_REF, newValueRef);
    }
    ...
    public EObject getValue() {
        return (EObject) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_VALUE__VALUE, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_VALUE__VALUE, true, true);
    }
    ...
    public void setValue(EObject newValue) {
        eDynamicSet(Bpmn2Package.EXTENSION_ATTRIBUTE_VALUE__VALUE, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_VALUE__VALUE, newValue);
    }
    ...
    public ExtensionAttributeDefinition getExtensionAttributeDefinition() {
        return (ExtensionAttributeDefinition) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_VALUE__EXTENSION_ATTRIBUTE_DEFINITION,
    ...
    public void setExtensionAttributeDefinition(ExtensionAttributeDefinition newExtensionAttributeDefinition) {
        eDynamicSet(Bpmn2Package.EXTENSION_ATTRIBUTE_VALUE__EXTENSION_ATTRIBUTE_DEFINITION, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_VALUE__EXTENSION_ATTRIBUTE_DEFINITION,
    ...
    @Override
    public String getId() {
        return (String) eDynamicGet(Bpmn2Package.EXTENSION_ATTRIBUTE_VALUE__ID, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_VALUE__ID, true, true);
    }
    ...
    public void setId(String newId) {
        eDynamicSet(Bpmn2Package.EXTENSION_ATTRIBUTE_VALUE__ID, Bpmn2Package.Literals.EXTENSION_ATTRIBUTE_VALUE__ID, newId);
    }
