...
public class ImportImpl extends BPMN2ObjectImpl implements Import {
    ...
    public String getImportType() {
        return (String) eDynamicGet(Bpmn2Package.IMPORT__IMPORT_TYPE, Bpmn2Package.Literals.IMPORT__IMPORT_TYPE, true, true);
    }
    ...
    public String getNamespace() {
        return (String) eDynamicGet(Bpmn2Package.IMPORT__NAMESPACE, Bpmn2Package.Literals.IMPORT__NAMESPACE, true, true);
    }
