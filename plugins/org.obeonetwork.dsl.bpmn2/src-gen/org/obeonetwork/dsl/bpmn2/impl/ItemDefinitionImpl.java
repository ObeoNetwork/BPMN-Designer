...
public class ItemDefinitionImpl extends RootElementImpl implements ItemDefinition {
    ...
    public ItemKind getItemKind() {
        return (ItemKind) eDynamicGet(Bpmn2Package.ITEM_DEFINITION__ITEM_KIND, Bpmn2Package.Literals.ITEM_DEFINITION__ITEM_KIND, true, true);
    }
    ...
    public void setItemKind(ItemKind newItemKind) {
        eDynamicSet(Bpmn2Package.ITEM_DEFINITION__ITEM_KIND, Bpmn2Package.Literals.ITEM_DEFINITION__ITEM_KIND, newItemKind);
    }
    ...
    public EObject getStructureRef() {
        return (EObject) eDynamicGet(Bpmn2Package.ITEM_DEFINITION__STRUCTURE_REF, Bpmn2Package.Literals.ITEM_DEFINITION__STRUCTURE_REF, true, true);
    }
    ...
    public EObject basicGetStructureRef() {
        return (EObject) eDynamicGet(Bpmn2Package.ITEM_DEFINITION__STRUCTURE_REF, Bpmn2Package.Literals.ITEM_DEFINITION__STRUCTURE_REF, false, true);
    }
    ...
    public void setStructureRef(EObject newStructureRef) {
        eDynamicSet(Bpmn2Package.ITEM_DEFINITION__STRUCTURE_REF, Bpmn2Package.Literals.ITEM_DEFINITION__STRUCTURE_REF, newStructureRef);
    }
    ...
    public boolean isIsCollection() {
        return (Boolean) eDynamicGet(Bpmn2Package.ITEM_DEFINITION__IS_COLLECTION, Bpmn2Package.Literals.ITEM_DEFINITION__IS_COLLECTION, true, true);
    }
    ...
    public void setIsCollection(boolean newIsCollection) {
        eDynamicSet(Bpmn2Package.ITEM_DEFINITION__IS_COLLECTION, Bpmn2Package.Literals.ITEM_DEFINITION__IS_COLLECTION, newIsCollection);
    }
    ...
    public Import getImport() {
        return (Import) eDynamicGet(Bpmn2Package.ITEM_DEFINITION__IMPORT, Bpmn2Package.Literals.ITEM_DEFINITION__IMPORT, true, true);
    }
    ...
    public Import basicGetImport() {
        return (Import) eDynamicGet(Bpmn2Package.ITEM_DEFINITION__IMPORT, Bpmn2Package.Literals.ITEM_DEFINITION__IMPORT, false, true);
    }
