...
public class UserTaskImpl extends TaskImpl implements UserTask {
    ...
    public EList<Rendering> getRenderings() {
        return (EList<Rendering>) eDynamicGet(Bpmn2Package.USER_TASK__RENDERINGS, Bpmn2Package.Literals.USER_TASK__RENDERINGS, true, true);
    }
    ...
    public String getImplementation() {
        return (String) eDynamicGet(Bpmn2Package.USER_TASK__IMPLEMENTATION, Bpmn2Package.Literals.USER_TASK__IMPLEMENTATION, true, true);
    }
    ...
    public void setImplementation(String newImplementation) {
        eDynamicSet(Bpmn2Package.USER_TASK__IMPLEMENTATION, Bpmn2Package.Literals.USER_TASK__IMPLEMENTATION, newImplementation);
    }
