...
public class CollaborationImpl extends RootElementImpl implements Collaboration {
    ...
    public String getName() {
        return (String) eDynamicGet(Bpmn2Package.COLLABORATION__NAME, Bpmn2Package.Literals.COLLABORATION__NAME, true, true);
    }
    ...
    public boolean isIsClosed() {
        return (Boolean) eDynamicGet(Bpmn2Package.COLLABORATION__IS_CLOSED, Bpmn2Package.Literals.COLLABORATION__IS_CLOSED, true, true);
    }
    ...
    public EList<Choreography> getChoreographyRef() {
        return (EList<Choreography>) eDynamicGet(Bpmn2Package.COLLABORATION__CHOREOGRAPHY_REF, Bpmn2Package.Literals.COLLABORATION__CHOREOGRAPHY_REF, true, true);
    }
    ...
    public EList<Artifact> getArtifacts() {
        return (EList<Artifact>) eDynamicGet(Bpmn2Package.COLLABORATION__ARTIFACTS, Bpmn2Package.Literals.COLLABORATION__ARTIFACTS, true, true);
    }
    ...
    public EList<ParticipantAssociation> getParticipantAssociations() {
        return (EList<ParticipantAssociation>) eDynamicGet(Bpmn2Package.COLLABORATION__PARTICIPANT_ASSOCIATIONS, Bpmn2Package.Literals.COLLABORATION__PARTICIPANT_ASSOCIATIONS, true, true);
    }
    ...
    public EList<MessageFlowAssociation> getMessageFlowAssociations() {
        return (EList<MessageFlowAssociation>) eDynamicGet(Bpmn2Package.COLLABORATION__MESSAGE_FLOW_ASSOCIATIONS, Bpmn2Package.Literals.COLLABORATION__MESSAGE_FLOW_ASSOCIATIONS, true, true);
    }
    ...
    public ConversationAssociation getConversationAssociations() {
        return (ConversationAssociation) eDynamicGet(Bpmn2Package.COLLABORATION__CONVERSATION_ASSOCIATIONS, Bpmn2Package.Literals.COLLABORATION__CONVERSATION_ASSOCIATIONS, true, true);
    }
    ...
    public NotificationChain basicSetConversationAssociations(ConversationAssociation newConversationAssociations, NotificationChain msgs) {
        msgs = eDynamicInverseAdd((InternalEObject) newConversationAssociations, Bpmn2Package.COLLABORATION__CONVERSATION_ASSOCIATIONS, msgs);
        return msgs;
    }
    ...
    public void setConversationAssociations(ConversationAssociation newConversationAssociations) {
        eDynamicSet(Bpmn2Package.COLLABORATION__CONVERSATION_ASSOCIATIONS, Bpmn2Package.Literals.COLLABORATION__CONVERSATION_ASSOCIATIONS, newConversationAssociations);
    }
    ...
    public EList<Participant> getParticipants() {
        return (EList<Participant>) eDynamicGet(Bpmn2Package.COLLABORATION__PARTICIPANTS, Bpmn2Package.Literals.COLLABORATION__PARTICIPANTS, true, true);
    }
    ...
    public EList<MessageFlow> getMessageFlows() {
        return (EList<MessageFlow>) eDynamicGet(Bpmn2Package.COLLABORATION__MESSAGE_FLOWS, Bpmn2Package.Literals.COLLABORATION__MESSAGE_FLOWS, true, true);
    }
    ...
    public EList<CorrelationKey> getCorrelationKeys() {
        return (EList<CorrelationKey>) eDynamicGet(Bpmn2Package.COLLABORATION__CORRELATION_KEYS, Bpmn2Package.Literals.COLLABORATION__CORRELATION_KEYS, true, true);
    }
    ...
    public EList<ConversationNode> getConversations() {
        return (EList<ConversationNode>) eDynamicGet(Bpmn2Package.COLLABORATION__CONVERSATIONS, Bpmn2Package.Literals.COLLABORATION__CONVERSATIONS, true, true);
    }
    ...
    public EList<ConversationLink> getConversationLinks() {
        return (EList<ConversationLink>) eDynamicGet(Bpmn2Package.COLLABORATION__CONVERSATION_LINKS, Bpmn2Package.Literals.COLLABORATION__CONVERSATION_LINKS, true, true);
    }
