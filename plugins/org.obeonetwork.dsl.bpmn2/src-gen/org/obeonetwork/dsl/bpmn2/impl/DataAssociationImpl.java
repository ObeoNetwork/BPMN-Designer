...
public class DataAssociationImpl extends BaseElementImpl implements DataAssociation {
    ...
    public FormalExpression getTransformation() {
        return (FormalExpression) eDynamicGet(Bpmn2Package.DATA_ASSOCIATION__TRANSFORMATION, Bpmn2Package.Literals.DATA_ASSOCIATION__TRANSFORMATION, true, true);
    }
    ...
    public NotificationChain basicSetTransformation(FormalExpression newTransformation, NotificationChain msgs) {
        msgs = eDynamicInverseAdd((InternalEObject) newTransformation, Bpmn2Package.DATA_ASSOCIATION__TRANSFORMATION, msgs);
        return msgs;
    }
    ...
    public void setTransformation(FormalExpression newTransformation) {
        eDynamicSet(Bpmn2Package.DATA_ASSOCIATION__TRANSFORMATION, Bpmn2Package.Literals.DATA_ASSOCIATION__TRANSFORMATION, newTransformation);
    }
    ...
    public EList<Assignment> getAssignment() {
        return (EList<Assignment>) eDynamicGet(Bpmn2Package.DATA_ASSOCIATION__ASSIGNMENT, Bpmn2Package.Literals.DATA_ASSOCIATION__ASSIGNMENT, true, true);
    }
    ...
    public ItemAwareElement getTargetRef() {
        return (ItemAwareElement) eDynamicGet(Bpmn2Package.DATA_ASSOCIATION__TARGET_REF, Bpmn2Package.Literals.DATA_ASSOCIATION__TARGET_REF, true, true);
    }
    ...
    public ItemAwareElement basicGetTargetRef() {
        return (ItemAwareElement) eDynamicGet(Bpmn2Package.DATA_ASSOCIATION__TARGET_REF, Bpmn2Package.Literals.DATA_ASSOCIATION__TARGET_REF, false, true);
    }
    ...
    public void setTargetRef(ItemAwareElement newTargetRef) {
        eDynamicSet(Bpmn2Package.DATA_ASSOCIATION__TARGET_REF, Bpmn2Package.Literals.DATA_ASSOCIATION__TARGET_REF, newTargetRef);
    }
    ...
    public EList<ItemAwareElement> getSourceRef() {
        return (EList<ItemAwareElement>) eDynamicGet(Bpmn2Package.DATA_ASSOCIATION__SOURCE_REF, Bpmn2Package.Literals.DATA_ASSOCIATION__SOURCE_REF, true, true);
    }
