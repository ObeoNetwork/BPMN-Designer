...
public abstract class ChoreographyActivityImpl extends FlowNodeImpl implements ChoreographyActivity {
    ...
    public EList<Participant> getParticipantRefs() {
        return (EList<Participant>) eDynamicGet(Bpmn2Package.CHOREOGRAPHY_ACTIVITY__PARTICIPANT_REFS, Bpmn2Package.Literals.CHOREOGRAPHY_ACTIVITY__PARTICIPANT_REFS, true, true);
    }
    ...
    public Participant getInitiatingParticipantRef() {
        return (Participant) eDynamicGet(Bpmn2Package.CHOREOGRAPHY_ACTIVITY__INITIATING_PARTICIPANT_REF, Bpmn2Package.Literals.CHOREOGRAPHY_ACTIVITY__INITIATING_PARTICIPANT_REF, true, true);
    }
    ...
    public Participant basicGetInitiatingParticipantRef() {
        return (Participant) eDynamicGet(Bpmn2Package.CHOREOGRAPHY_ACTIVITY__INITIATING_PARTICIPANT_REF, Bpmn2Package.Literals.CHOREOGRAPHY_ACTIVITY__INITIATING_PARTICIPANT_REF, false, true);
    }
    ...
    public void setInitiatingParticipantRef(Participant newInitiatingParticipantRef) {
        eDynamicSet(Bpmn2Package.CHOREOGRAPHY_ACTIVITY__INITIATING_PARTICIPANT_REF, Bpmn2Package.Literals.CHOREOGRAPHY_ACTIVITY__INITIATING_PARTICIPANT_REF, newInitiatingParticipantRef);
    }
    ...
    public EList<CorrelationKey> getCorrelationKeys() {
        return (EList<CorrelationKey>) eDynamicGet(Bpmn2Package.CHOREOGRAPHY_ACTIVITY__CORRELATION_KEYS, Bpmn2Package.Literals.CHOREOGRAPHY_ACTIVITY__CORRELATION_KEYS, true, true);
    }
    ...
    public ChoreographyLoopType getLoopType() {
        return (ChoreographyLoopType) eDynamicGet(Bpmn2Package.CHOREOGRAPHY_ACTIVITY__LOOP_TYPE, Bpmn2Package.Literals.CHOREOGRAPHY_ACTIVITY__LOOP_TYPE, true, true);
    }
    ...
    public void setLoopType(ChoreographyLoopType newLoopType) {
        eDynamicSet(Bpmn2Package.CHOREOGRAPHY_ACTIVITY__LOOP_TYPE, Bpmn2Package.Literals.CHOREOGRAPHY_ACTIVITY__LOOP_TYPE, newLoopType);
    }
