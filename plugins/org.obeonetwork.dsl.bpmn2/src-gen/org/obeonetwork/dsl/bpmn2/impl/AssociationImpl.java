...
public class AssociationImpl extends ArtifactImpl implements Association {
    ...
    public AssociationDirection getAssociationDirection() {
        return (AssociationDirection) eDynamicGet(Bpmn2Package.ASSOCIATION__ASSOCIATION_DIRECTION, Bpmn2Package.Literals.ASSOCIATION__ASSOCIATION_DIRECTION, true, true);
    }
    ...
    public void setAssociationDirection(AssociationDirection newAssociationDirection) {
        eDynamicSet(Bpmn2Package.ASSOCIATION__ASSOCIATION_DIRECTION, Bpmn2Package.Literals.ASSOCIATION__ASSOCIATION_DIRECTION, newAssociationDirection);
    }
    ...
    public BaseElement getSourceRef() {
        return (BaseElement) eDynamicGet(Bpmn2Package.ASSOCIATION__SOURCE_REF, Bpmn2Package.Literals.ASSOCIATION__SOURCE_REF, true, true);
    }
    ...
    public BaseElement basicGetSourceRef() {
        return (BaseElement) eDynamicGet(Bpmn2Package.ASSOCIATION__SOURCE_REF, Bpmn2Package.Literals.ASSOCIATION__SOURCE_REF, false, true);
    }
    ...
    public BaseElement getTargetRef() {
        return (BaseElement) eDynamicGet(Bpmn2Package.ASSOCIATION__TARGET_REF, Bpmn2Package.Literals.ASSOCIATION__TARGET_REF, true, true);
    }
    ...
    public BaseElement basicGetTargetRef() {
        return (BaseElement) eDynamicGet(Bpmn2Package.ASSOCIATION__TARGET_REF, Bpmn2Package.Literals.ASSOCIATION__TARGET_REF, false, true);
    }
