...
public abstract class CatchEventImpl extends EventImpl implements CatchEvent {
    ...
    public boolean isParallelMultiple() {
        return (Boolean) eDynamicGet(Bpmn2Package.CATCH_EVENT__PARALLEL_MULTIPLE, Bpmn2Package.Literals.CATCH_EVENT__PARALLEL_MULTIPLE, true, true);
    }
    ...
    public void setParallelMultiple(boolean newParallelMultiple) {
        eDynamicSet(Bpmn2Package.CATCH_EVENT__PARALLEL_MULTIPLE, Bpmn2Package.Literals.CATCH_EVENT__PARALLEL_MULTIPLE, newParallelMultiple);
    }
    ...
    public OutputSet getOutputSet() {
        return (OutputSet) eDynamicGet(Bpmn2Package.CATCH_EVENT__OUTPUT_SET, Bpmn2Package.Literals.CATCH_EVENT__OUTPUT_SET, true, true);
    }
    ...
    public EList<EventDefinition> getEventDefinitionRefs() {
        return (EList<EventDefinition>) eDynamicGet(Bpmn2Package.CATCH_EVENT__EVENT_DEFINITION_REFS, Bpmn2Package.Literals.CATCH_EVENT__EVENT_DEFINITION_REFS, true, true);
    }
    ...
    public EList<DataOutputAssociation> getDataOutputAssociation() {
        return (EList<DataOutputAssociation>) eDynamicGet(Bpmn2Package.CATCH_EVENT__DATA_OUTPUT_ASSOCIATION, Bpmn2Package.Literals.CATCH_EVENT__DATA_OUTPUT_ASSOCIATION, true, true);
    }
    ...
    public EList<DataOutput> getDataOutputs() {
        return (EList<DataOutput>) eDynamicGet(Bpmn2Package.CATCH_EVENT__DATA_OUTPUTS, Bpmn2Package.Literals.CATCH_EVENT__DATA_OUTPUTS, true, true);
    }
    ...
    public EList<EventDefinition> getEventDefinitions() {
        return (EList<EventDefinition>) eDynamicGet(Bpmn2Package.CATCH_EVENT__EVENT_DEFINITIONS, Bpmn2Package.Literals.CATCH_EVENT__EVENT_DEFINITIONS, true, true);
    }
