...
public abstract class DiagramImpl extends BPMN2ObjectImpl implements Diagram {
    ...
    public String getDocumentation() {
        return (String) eDynamicGet(DiPackage.DIAGRAM__DOCUMENTATION, DiPackage.Literals.DIAGRAM__DOCUMENTATION, true, true);
    }
    ...
    public EList<Style> getOwnedStyle() {
        return (EList<Style>) eDynamicGet(DiPackage.DIAGRAM__OWNED_STYLE, DiPackage.Literals.DIAGRAM__OWNED_STYLE, true, true);
    }
    ...
    public DiagramElement getRootElement() {
        return (DiagramElement) eDynamicGet(DiPackage.DIAGRAM__ROOT_ELEMENT, DiPackage.Literals.DIAGRAM__ROOT_ELEMENT, true, true);
    }
