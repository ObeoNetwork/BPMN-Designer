...
public class FontImpl extends BPMN2ObjectImpl implements Font {
    ...
    public boolean isIsStrikeThrough() {
        return (Boolean) eDynamicGet(DcPackage.FONT__IS_STRIKE_THROUGH, DcPackage.Literals.FONT__IS_STRIKE_THROUGH, true, true);
    }
    ...
    public boolean non_negative_size(DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (false) {
            if (diagnostics != null) {
                diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DcValidator.DIAGNOSTIC_SOURCE, DcValidator.FONT__NON_NEGATIVE_SIZE,
