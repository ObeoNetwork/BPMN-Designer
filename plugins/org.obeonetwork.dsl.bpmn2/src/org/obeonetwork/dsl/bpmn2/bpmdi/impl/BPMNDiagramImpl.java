...
public class BPMNDiagramImpl extends DiagramImpl implements BPMNDiagram {
	...
	public BPMNPlane getPlane() {
		return (BPMNPlane) eGet(BpmnDiPackage.Literals.BPMN_DIAGRAM__PLANE,
				true);
	}
	...
	public void setPlane(BPMNPlane newPlane) {
		eSet(BpmnDiPackage.Literals.BPMN_DIAGRAM__PLANE, newPlane);
	}
	...
	public EList<BPMNLabelStyle> getLabelStyle() {
		return (EList<BPMNLabelStyle>) eGet(
				BpmnDiPackage.Literals.BPMN_DIAGRAM__LABEL_STYLE, true);
	}
