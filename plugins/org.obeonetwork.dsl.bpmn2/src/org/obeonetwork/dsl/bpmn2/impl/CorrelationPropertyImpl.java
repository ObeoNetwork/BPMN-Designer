...
public class CorrelationPropertyImpl extends RootElementImpl implements
	...
	public EList<CorrelationPropertyRetrievalExpression> getCorrelationPropertyRetrievalExpression() {
		return (EList<CorrelationPropertyRetrievalExpression>) eGet(
	...
	public String getName() {
		return (String) eGet(Bpmn2Package.Literals.CORRELATION_PROPERTY__NAME,
				true);
	}
	...
	public void setName(String newName) {
		eSet(Bpmn2Package.Literals.CORRELATION_PROPERTY__NAME, newName);
	}
	...
	public ItemDefinition getType() {
		return (ItemDefinition) eGet(
				Bpmn2Package.Literals.CORRELATION_PROPERTY__TYPE, true);
	}
	...
	public void setType(ItemDefinition newType) {
		eSet(Bpmn2Package.Literals.CORRELATION_PROPERTY__TYPE, newType);
	}
