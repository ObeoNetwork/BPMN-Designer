 ...
 * 
 */
public interface CorrelationKeyPropertiesEditionPart {
	...
	/**
	 * Init the correlationPropertyRef
	 * @param settings settings for the correlationPropertyRef ReferencesTable 
	 */
	public void initCorrelationPropertyRef(ReferencesTableSettings settings);

	/**
	 * Update the correlationPropertyRef
	 * @param newValue the correlationPropertyRef to update
	 * 
	 */
	public void updateCorrelationPropertyRef();

	/**
	 * Adds the given filter to the correlationPropertyRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the correlationPropertyRef table
	 * 
	 */
