...
public interface ResourcePropertiesEditionPart {
	...
	/**
	 * Update the resourceParameters
	 * @param newValue the resourceParameters to update
	 * 
	 */
	public void updateResourceParameters();

	/**
	 * Adds the given filter to the resourceParameters edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the resourceParameters table
	 * 
	 */
