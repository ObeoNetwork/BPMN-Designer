 ...
 * 
 */
public interface CorrelationPropertyPropertiesEditionPart {
	...
	/**
	 * Init the correlationPropertyRetrievalExpression
	 * @param current the current value
	 * @param containgFeature the feature where to navigate if necessary
	 * @param feature the feature to manage
	 */
	...
	/**
	 * Update the correlationPropertyRetrievalExpression
	 * @param newValue the correlationPropertyRetrievalExpression to update
	 * 
	 */
	public void updateCorrelationPropertyRetrievalExpression();

	/**
	 * Adds the given filter to the correlationPropertyRetrievalExpression edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the correlationPropertyRetrievalExpression table
	 * 
	 */
