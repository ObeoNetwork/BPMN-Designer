 ...
 * 
 */
public interface GlobalUserTaskPropertiesEditionPart {
	 ...
	 * @param newValue the renderings to update
	 * 
	 */
	public void updateRenderings();

	/**
	 * Adds the given filter to the renderings edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the renderings table
	 * 
	 */
