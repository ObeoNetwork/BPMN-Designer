 ...
 * 
 */
public interface AdHocSubProcessPropertiesEditionPart {
	...
	/**
	 * @return the cancelRemainingInstances
	 * 
	 */
	public Boolean getCancelRemainingInstances();

	/**
	 * Defines a new cancelRemainingInstances
	 * @param newValue the new cancelRemainingInstances to set
	 * 
	 */
