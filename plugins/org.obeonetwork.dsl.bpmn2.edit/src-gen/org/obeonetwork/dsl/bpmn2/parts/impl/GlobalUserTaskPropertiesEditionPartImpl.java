 ...
 * 
 */
public class GlobalUserTaskPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, GlobalUserTaskPropertiesEditionPart {
	 ...
	 * 
	 */
	public GlobalUserTaskPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(Bpmn2Messages.GlobalUserTaskPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.id, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionDefinitions, Bpmn2Messages.GlobalUserTaskPropertiesEditionPart_ExtensionDefinitionsLabel);		 
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionDefinitions, Bpmn2ViewsRepository.SWT_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesAdvancedTableComposition(Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionValues, Bpmn2Messages.GlobalUserTaskPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionValues, Bpmn2ViewsRepository.SWT_KIND));
		this.extensionValues.createControls(parent);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationAdvancedTableComposition(Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.GlobalUserTask.Properties.documentation, Bpmn2Messages.GlobalUserTaskPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.documentation, Bpmn2ViewsRepository.SWT_KIND));
		this.documentation.createControls(parent);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.name, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSupportedInterfaceRefsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(Bpmn2ViewsRepository.GlobalUserTask.Properties.supportedInterfaceRefs, Bpmn2Messages.GlobalUserTaskPropertiesEditionPart_SupportedInterfaceRefsLabel);		 
		...
		this.supportedInterfaceRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.supportedInterfaceRefs, Bpmn2ViewsRepository.SWT_KIND));
		this.supportedInterfaceRefs.createControls(parent);
		this.supportedInterfaceRefs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.supportedInterfaceRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSupportedInterfaceRefs() {
		...
		"supportedInterfaceRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.supportedInterfaceRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveSupportedInterfaceRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.supportedInterfaceRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		supportedInterfaceRefs.refresh();
	}
	...
	protected void removeFromSupportedInterfaceRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.supportedInterfaceRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		supportedInterfaceRefs.refresh();
	}
	...
	protected Composite createIoBindingAdvancedTableComposition(Composite parent) {
		this.ioBinding = new ReferencesTable(getDescription(Bpmn2ViewsRepository.GlobalUserTask.Properties.ioBinding, Bpmn2Messages.GlobalUserTaskPropertiesEditionPart_IoBindingLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.ioBinding, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ioBinding.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.ioBinding, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ioBinding.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.ioBinding, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ioBinding.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.ioBinding, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ioBinding.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.ioBinding.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.ioBinding, Bpmn2ViewsRepository.SWT_KIND));
		this.ioBinding.createControls(parent);
		this.ioBinding.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.ioBinding, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createResourcesAdvancedTableComposition(Composite parent) {
		this.resources = new ReferencesTable(getDescription(Bpmn2ViewsRepository.GlobalUserTask.Properties.resources, Bpmn2Messages.GlobalUserTaskPropertiesEditionPart_ResourcesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				resources.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				resources.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				resources.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				resources.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.resources.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.resources, Bpmn2ViewsRepository.SWT_KIND));
		this.resources.createControls(parent);
		this.resources.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.resources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createImplementationText(Composite parent) {
		...
		implementation.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.implementation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, implementation.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.implementation, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRenderingsAdvancedTableComposition(Composite parent) {
		this.renderings = new ReferencesTable(getDescription(Bpmn2ViewsRepository.GlobalUserTask.Properties.renderings, Bpmn2Messages.GlobalUserTaskPropertiesEditionPart_RenderingsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.renderings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				renderings.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.renderings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				renderings.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.renderings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				renderings.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.renderings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				renderings.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.renderings.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.GlobalUserTask.Properties.renderings, Bpmn2ViewsRepository.SWT_KIND));
		this.renderings.createControls(parent);
		this.renderings.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GlobalUserTaskPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.GlobalUserTask.Properties.renderings, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
