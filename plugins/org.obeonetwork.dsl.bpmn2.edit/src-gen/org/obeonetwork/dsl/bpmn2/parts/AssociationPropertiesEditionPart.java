...
public interface AssociationPropertiesEditionPart {
	...
	/**
	 * Defines a new associationDirection
	 * @param newValue the new associationDirection to set
	 * 
	 */
	...
	/**
	 * Defines a new sourceRef
	 * @param newValue the new sourceRef to set
	 * 
	 */
