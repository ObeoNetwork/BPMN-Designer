 ...
 * 
 */
public interface CorrelationSubscriptionPropertiesEditionPart {
	...
	/**
	 * @return the correlationKeyRef
	 * 
	 */
	public EObject getCorrelationKeyRef();

	/**
	 * Init the correlationKeyRef
	 * @param settings the combo setting
	 */
	public void initCorrelationKeyRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new correlationKeyRef
	 * @param newValue the new correlationKeyRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the correlationKeyRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * Init the correlationPropertyBinding
	 * @param current the current value
	 * @param containgFeature the feature where to navigate if necessary
	 * @param feature the feature to manage
	 */
	...
	/**
	 * Update the correlationPropertyBinding
	 * @param newValue the correlationPropertyBinding to update
	 * 
	 */
	public void updateCorrelationPropertyBinding();

	/**
	 * Adds the given filter to the correlationPropertyBinding edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the correlationPropertyBinding table
	 * 
	 */
