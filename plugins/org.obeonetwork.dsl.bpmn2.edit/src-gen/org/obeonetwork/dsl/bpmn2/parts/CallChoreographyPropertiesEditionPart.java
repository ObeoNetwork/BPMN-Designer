 ...
 * 
 */
public interface CallChoreographyPropertiesEditionPart {
	...
	/**
	 * @return the calledChoreographyRef
	 * 
	 */
	public EObject getCalledChoreographyRef();

	/**
	 * Init the calledChoreographyRef
	 * @param settings the combo setting
	 */
	public void initCalledChoreographyRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new calledChoreographyRef
	 * @param newValue the new calledChoreographyRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the calledChoreographyRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
