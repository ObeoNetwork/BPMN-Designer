 ...
 * 
 */
public class IntermediateCatchEventPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, IntermediateCatchEventPropertiesEditionPart {
	 ...
	 */
	public IntermediateCatchEventPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public IntermediateCatchEventPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							IntermediateCatchEventPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.id, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.extensionDefinitions = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_ExtensionDefinitionsLabel), new ReferencesTableListener	() {
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues, Bpmn2ViewsRepository.FORM_KIND));
		this.extensionValues.createControls(parent, widgetFactory);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation, Bpmn2ViewsRepository.FORM_KIND));
		this.documentation.createControls(parent, widgetFactory);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							IntermediateCatchEventPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.name, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createCategoryValueRefReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.categoryValueRef = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_CategoryValueRefLabel), new ReferencesTableListener	() {
		...
		this.categoryValueRef.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef, Bpmn2ViewsRepository.FORM_KIND));
		this.categoryValueRef.createControls(parent, widgetFactory);
		this.categoryValueRef.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCategoryValueRef() {
		...
		"categoryValueRef", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveCategoryValueRef(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		categoryValueRef.refresh();
	}
	...
	protected void removeFromCategoryValueRef(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		categoryValueRef.refresh();
	}
	...
	protected Composite createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing, Bpmn2ViewsRepository.FORM_KIND));
		this.outgoing.createControls(parent, widgetFactory);
		this.outgoing.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOutgoing() {
		...
		"outgoing", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				outgoing.refresh();
			}
	...
	protected void moveOutgoing(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outgoing.refresh();
	}
	...
	protected void removeFromOutgoing(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outgoing.refresh();
	}
	...
	protected Composite createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming, Bpmn2ViewsRepository.FORM_KIND));
		this.incoming.createControls(parent, widgetFactory);
		this.incoming.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIncoming() {
		...
		"incoming", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				incoming.refresh();
			}
	...
	protected void moveIncoming(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		incoming.refresh();
	}
	...
	protected void removeFromIncoming(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		incoming.refresh();
	}
	...
	protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.properties = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				properties.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				properties.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				properties.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				properties.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.properties.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_, Bpmn2ViewsRepository.FORM_KIND));
		this.properties.createControls(parent, widgetFactory);
		this.properties.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createParallelMultipleCheckbox(FormToolkit widgetFactory, Composite parent) {
		parallelMultiple = widgetFactory.createButton(parent, getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.parallelMultiple, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_ParallelMultipleLabel), SWT.CHECK);
		parallelMultiple.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.parallelMultiple, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(parallelMultiple.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.parallelMultiple, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createEventDefinitionRefsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.eventDefinitionRefs = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_EventDefinitionRefsLabel), new ReferencesTableListener	() {
		...
		this.eventDefinitionRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.eventDefinitionRefs.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addEventDefinitionRefs() {
		...
		"eventDefinitionRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveEventDefinitionRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		eventDefinitionRefs.refresh();
	}
	...
	protected void removeFromEventDefinitionRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		eventDefinitionRefs.refresh();
	}
	...
	protected Composite createDataOutputAssociationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.dataOutputAssociation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_DataOutputAssociationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				dataOutputAssociation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				dataOutputAssociation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				dataOutputAssociation.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				dataOutputAssociation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.dataOutputAssociation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.dataOutputAssociation.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createEventDefinitionsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.eventDefinitions = new ReferencesTable(getDescription(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions, Bpmn2Messages.IntermediateCatchEventPropertiesEditionPart_EventDefinitionsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				eventDefinitions.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				eventDefinitions.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				eventDefinitions.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				eventDefinitions.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.eventDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions, Bpmn2ViewsRepository.FORM_KIND));
		this.eventDefinitions.createControls(parent, widgetFactory);
		this.eventDefinitions.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntermediateCatchEventPropertiesEditionPartForm.this, Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
