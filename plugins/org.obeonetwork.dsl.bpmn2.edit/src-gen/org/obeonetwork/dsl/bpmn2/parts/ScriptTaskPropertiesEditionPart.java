 ...
 * 
 */
public interface ScriptTaskPropertiesEditionPart {
	...
	/**
	 * Defines a new scriptFormat
	 * @param newValue the new scriptFormat to set
	 * 
	 */
	 ...
	 * @param newValue the new script to set
	 * 
	 */
