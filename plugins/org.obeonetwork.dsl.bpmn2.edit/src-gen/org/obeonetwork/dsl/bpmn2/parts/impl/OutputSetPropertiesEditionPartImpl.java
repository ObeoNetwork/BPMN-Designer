 ...
 * 
 */
public class OutputSetPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, OutputSetPropertiesEditionPart {
	 ...
	 * 
	 */
	public OutputSetPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(Bpmn2Messages.OutputSetPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.OutputSet.Properties.id, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(Bpmn2ViewsRepository.OutputSet.Properties.extensionDefinitions, Bpmn2Messages.OutputSetPropertiesEditionPart_ExtensionDefinitionsLabel);		 
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.OutputSet.Properties.extensionDefinitions, Bpmn2ViewsRepository.SWT_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesAdvancedTableComposition(Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.OutputSet.Properties.extensionValues, Bpmn2Messages.OutputSetPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.OutputSet.Properties.extensionValues, Bpmn2ViewsRepository.SWT_KIND));
		this.extensionValues.createControls(parent);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationAdvancedTableComposition(Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.OutputSet.Properties.documentation, Bpmn2Messages.OutputSetPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.OutputSet.Properties.documentation, Bpmn2ViewsRepository.SWT_KIND));
		this.documentation.createControls(parent);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createDataOutputRefsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(Bpmn2ViewsRepository.OutputSet.Properties.dataOutputRefs, Bpmn2Messages.OutputSetPropertiesEditionPart_DataOutputRefsLabel);		 
		this.dataOutputRefs = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.dataOutputRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.OutputSet.Properties.dataOutputRefs, Bpmn2ViewsRepository.SWT_KIND));
		this.dataOutputRefs.createControls(parent);
		this.dataOutputRefs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.dataOutputRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDataOutputRefs() {
		...
		"dataOutputRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.dataOutputRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveDataOutputRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.dataOutputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		dataOutputRefs.refresh();
	}
	...
	protected void removeFromDataOutputRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.dataOutputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		dataOutputRefs.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createOptionalOutputRefsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(Bpmn2ViewsRepository.OutputSet.Properties.optionalOutputRefs, Bpmn2Messages.OutputSetPropertiesEditionPart_OptionalOutputRefsLabel);		 
		this.optionalOutputRefs = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.optionalOutputRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.OutputSet.Properties.optionalOutputRefs, Bpmn2ViewsRepository.SWT_KIND));
		this.optionalOutputRefs.createControls(parent);
		this.optionalOutputRefs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.optionalOutputRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOptionalOutputRefs() {
		...
		"optionalOutputRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.optionalOutputRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOptionalOutputRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.optionalOutputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		optionalOutputRefs.refresh();
	}
	...
	protected void removeFromOptionalOutputRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.optionalOutputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		optionalOutputRefs.refresh();
	}
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.OutputSet.Properties.name, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createInputSetRefsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(Bpmn2ViewsRepository.OutputSet.Properties.inputSetRefs, Bpmn2Messages.OutputSetPropertiesEditionPart_InputSetRefsLabel);		 
		this.inputSetRefs = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.inputSetRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.OutputSet.Properties.inputSetRefs, Bpmn2ViewsRepository.SWT_KIND));
		this.inputSetRefs.createControls(parent);
		this.inputSetRefs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.inputSetRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addInputSetRefs() {
		...
		"inputSetRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.inputSetRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveInputSetRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.inputSetRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		inputSetRefs.refresh();
	}
	...
	protected void removeFromInputSetRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSetPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.OutputSet.Properties.inputSetRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		inputSetRefs.refresh();
	}
