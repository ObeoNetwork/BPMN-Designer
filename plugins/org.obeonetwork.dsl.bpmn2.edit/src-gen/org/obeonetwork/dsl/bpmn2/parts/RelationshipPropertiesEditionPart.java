 ...
 * 
 */
public interface RelationshipPropertiesEditionPart {
	...
	/**
	 * Init the sources
	 * @param settings settings for the sources ReferencesTable 
	 */
	public void initSources(ReferencesTableSettings settings);

	/**
	 * Update the sources
	 * @param newValue the sources to update
	 * 
	 */
	public void updateSources();

	/**
	 * Adds the given filter to the sources edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the sources table
	 * 
	 */
	...
	/**
	 * Init the targets
	 * @param settings settings for the targets ReferencesTable 
	 */
