 ...
 * 
 */
public interface FormalExpressionPropertiesEditionPart {
	...
	/**
	 * @return the evaluatesToTypeRef
	 * 
	 */
	public EObject getEvaluatesToTypeRef();

	/**
	 * Init the evaluatesToTypeRef
	 * @param settings the combo setting
	 */
	public void initEvaluatesToTypeRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new evaluatesToTypeRef
	 * @param newValue the new evaluatesToTypeRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the evaluatesToTypeRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
