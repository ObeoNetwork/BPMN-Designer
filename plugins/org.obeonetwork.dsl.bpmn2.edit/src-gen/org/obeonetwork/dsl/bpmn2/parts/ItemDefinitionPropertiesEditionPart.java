 ...
 * 
 */
public interface ItemDefinitionPropertiesEditionPart {
	...
	/**
	 * Defines a new itemKind
	 * @param newValue the new itemKind to set
	 * 
	 */
	...
	/**
	 * Defines a new import
	 * @param newValue the new import to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the import edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
