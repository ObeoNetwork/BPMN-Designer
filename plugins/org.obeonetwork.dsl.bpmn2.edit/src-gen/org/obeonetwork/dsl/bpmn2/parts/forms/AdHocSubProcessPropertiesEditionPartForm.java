 ...
 * 
 */
public class AdHocSubProcessPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, AdHocSubProcessPropertiesEditionPart {
	 ...
	 */
	public AdHocSubProcessPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public AdHocSubProcessPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(adHocSubProcessStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == Bpmn2ViewsRepository.AdHocSubProcess.Properties.cancelRemainingInstances) {
					return createCancelRemainingInstancesCheckbox(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AdHocSubProcessPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.AdHocSubProcess.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, Bpmn2ViewsRepository.AdHocSubProcess.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.id, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.extensionDefinitions = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionDefinitions, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_ExtensionDefinitionsLabel), new ReferencesTableListener	() {
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionDefinitions, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionValues, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionValues, Bpmn2ViewsRepository.FORM_KIND));
		this.extensionValues.createControls(parent, widgetFactory);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.documentation, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.documentation, Bpmn2ViewsRepository.FORM_KIND));
		this.documentation.createControls(parent, widgetFactory);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AdHocSubProcessPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.AdHocSubProcess.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, Bpmn2ViewsRepository.AdHocSubProcess.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.name, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createCategoryValueRefReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.categoryValueRef = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.categoryValueRef, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_CategoryValueRefLabel), new ReferencesTableListener	() {
		...
		this.categoryValueRef.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.categoryValueRef, Bpmn2ViewsRepository.FORM_KIND));
		this.categoryValueRef.createControls(parent, widgetFactory);
		this.categoryValueRef.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.categoryValueRef, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCategoryValueRef() {
		...
		"categoryValueRef", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.categoryValueRef,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveCategoryValueRef(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.categoryValueRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		categoryValueRef.refresh();
	}
	...
	protected void removeFromCategoryValueRef(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.categoryValueRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		categoryValueRef.refresh();
	}
	...
	protected Composite createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.outgoing, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_OutgoingLabel), new ReferencesTableListener	() {
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.outgoing, Bpmn2ViewsRepository.FORM_KIND));
		this.outgoing.createControls(parent, widgetFactory);
		this.outgoing.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.outgoing, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOutgoing() {
		...
		"outgoing", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.outgoing,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				outgoing.refresh();
			}
	...
	protected void moveOutgoing(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.outgoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outgoing.refresh();
	}
	...
	protected void removeFromOutgoing(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.outgoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outgoing.refresh();
	}
	...
	protected Composite createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.incoming, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_IncomingLabel), new ReferencesTableListener	() {
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.incoming, Bpmn2ViewsRepository.FORM_KIND));
		this.incoming.createControls(parent, widgetFactory);
		this.incoming.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.incoming, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIncoming() {
		...
		"incoming", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.incoming,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				incoming.refresh();
			}
	...
	protected void moveIncoming(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.incoming, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		incoming.refresh();
	}
	...
	protected void removeFromIncoming(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.incoming, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		incoming.refresh();
	}
	...
	protected Composite createIsForCompensationCheckbox(FormToolkit widgetFactory, Composite parent) {
		isForCompensation = widgetFactory.createButton(parent, getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.isForCompensation, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_IsForCompensationLabel), SWT.CHECK);
		isForCompensation.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.isForCompensation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isForCompensation.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.isForCompensation, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createResourcesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.resources = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.resources, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_ResourcesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				resources.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				resources.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				resources.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				resources.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.resources.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.resources, Bpmn2ViewsRepository.FORM_KIND));
		this.resources.createControls(parent, widgetFactory);
		this.resources.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.resources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDefault_FlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		default_ = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.AdHocSubProcess.Properties.default_, Bpmn2ViewsRepository.FORM_KIND));
		...
		default_.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.default_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDefault_()));
			}

		});
		default_.setID(Bpmn2ViewsRepository.AdHocSubProcess.Properties.default_);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.default_, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.properties = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.properties_, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				properties.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				properties.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				properties.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				properties.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.properties.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.properties_, Bpmn2ViewsRepository.FORM_KIND));
		this.properties.createControls(parent, widgetFactory);
		this.properties.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.properties_, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createBoundaryEventRefsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.boundaryEventRefs = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.boundaryEventRefs, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_BoundaryEventRefsLabel), new ReferencesTableListener	() {
		...
		this.boundaryEventRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.boundaryEventRefs, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.boundaryEventRefs.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.boundaryEventRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addBoundaryEventRefs() {
		...
		"boundaryEventRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.boundaryEventRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveBoundaryEventRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.boundaryEventRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		boundaryEventRefs.refresh();
	}
	...
	protected void removeFromBoundaryEventRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.boundaryEventRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		boundaryEventRefs.refresh();
	}
	...
	protected Composite createDataInputAssociationsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.dataInputAssociations = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataInputAssociations, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_DataInputAssociationsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataInputAssociations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				dataInputAssociations.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataInputAssociations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				dataInputAssociations.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataInputAssociations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				dataInputAssociations.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataInputAssociations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				dataInputAssociations.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.dataInputAssociations.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataInputAssociations, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.dataInputAssociations.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataInputAssociations, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDataOutputAssociationsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.dataOutputAssociations = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataOutputAssociations, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_DataOutputAssociationsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataOutputAssociations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				dataOutputAssociations.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataOutputAssociations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				dataOutputAssociations.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataOutputAssociations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				dataOutputAssociations.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataOutputAssociations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				dataOutputAssociations.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.dataOutputAssociations.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataOutputAssociations, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.dataOutputAssociations.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.dataOutputAssociations, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createStartQuantityText(FormToolkit widgetFactory, Composite parent) {
		...
		startQuantity.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AdHocSubProcessPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.AdHocSubProcess.Properties.startQuantity,
		...
		startQuantity.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.startQuantity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, startQuantity.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.startQuantity, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createCompletionQuantityText(FormToolkit widgetFactory, Composite parent) {
		...
		completionQuantity.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AdHocSubProcessPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.AdHocSubProcess.Properties.completionQuantity,
		...
		completionQuantity.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.completionQuantity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, completionQuantity.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.completionQuantity, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createLaneSetsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.laneSets = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.laneSets, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_LaneSetsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.laneSets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				laneSets.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.laneSets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				laneSets.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.laneSets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				laneSets.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.laneSets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				laneSets.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.laneSets.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.laneSets, Bpmn2ViewsRepository.FORM_KIND));
		this.laneSets.createControls(parent, widgetFactory);
		this.laneSets.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.laneSets, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createTriggeredByEventCheckbox(FormToolkit widgetFactory, Composite parent) {
		triggeredByEvent = widgetFactory.createButton(parent, getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.triggeredByEvent, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_TriggeredByEventLabel), SWT.CHECK);
		triggeredByEvent.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.triggeredByEvent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(triggeredByEvent.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.triggeredByEvent, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createArtifactsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.artifacts = new ReferencesTable(getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.artifacts, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_ArtifactsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.artifacts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				artifacts.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.artifacts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				artifacts.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.artifacts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				artifacts.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.artifacts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				artifacts.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.artifacts.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.artifacts, Bpmn2ViewsRepository.FORM_KIND));
		this.artifacts.createControls(parent, widgetFactory);
		this.artifacts.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.artifacts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createOrderingEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		ordering.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.ordering, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOrdering()));
			}

		});
		ordering.setID(Bpmn2ViewsRepository.AdHocSubProcess.Properties.ordering);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.ordering, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCancelRemainingInstancesCheckbox(FormToolkit widgetFactory, Composite parent) {
		cancelRemainingInstances = widgetFactory.createButton(parent, getDescription(Bpmn2ViewsRepository.AdHocSubProcess.Properties.cancelRemainingInstances, Bpmn2Messages.AdHocSubProcessPropertiesEditionPart_CancelRemainingInstancesLabel), SWT.CHECK);
		cancelRemainingInstances.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AdHocSubProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.AdHocSubProcess.Properties.cancelRemainingInstances, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(cancelRemainingInstances.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.AdHocSubProcess.Properties.cancelRemainingInstances, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
