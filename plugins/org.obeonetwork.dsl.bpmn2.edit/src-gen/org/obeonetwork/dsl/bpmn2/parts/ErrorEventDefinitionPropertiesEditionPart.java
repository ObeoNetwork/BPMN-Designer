 ...
 * 
 */
public interface ErrorEventDefinitionPropertiesEditionPart {
	...
	/**
	 * Defines a new errorRef
	 * @param newValue the new errorRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the errorRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
