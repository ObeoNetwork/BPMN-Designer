 ...
 * 
 */
public interface DataStoreReferencePropertiesEditionPart {
	...
	/**
	 * Init the dataStoreRef
	 * @param settings the combo setting
	 */
	public void initDataStoreRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new dataStoreRef
	 * @param newValue the new dataStoreRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the dataStoreRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
