 ...
 * 
 */
public interface EventBasedGatewayPropertiesEditionPart {
	...
	/**
	 * @return the gatewayDirection
	 * 
	 */
	public Enumerator getGatewayDirection();

	/**
	 * Init the gatewayDirection
	...
	/**
	 * Defines a new gatewayDirection
	 * @param newValue the new gatewayDirection to set
	 * 
	 */
	...
	/**
	 * Defines a new instantiate
	 * @param newValue the new instantiate to set
	 * 
	 */
	...
	/**
	 * @return the eventGatewayType
	 * 
	 */
	public Enumerator getEventGatewayType();

	/**
	 * Init the eventGatewayType
	 * @param input the viewer input
	 * @param current the current value
	 */
	...
	/**
	 * Defines a new eventGatewayType
	 * @param newValue the new eventGatewayType to set
	 * 
	 */
