 ...
 * 
 */
public class MessageFlowAssociationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, MessageFlowAssociationPropertiesEditionPart {
	 ...
	 * 
	 */
	public MessageFlowAssociationPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(messageFlowAssociationStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == Bpmn2ViewsRepository.MessageFlowAssociation.Properties.innerMessageFlowRef) {
					return createInnerMessageFlowRefFlatComboViewer(parent);
				}
				if (key == Bpmn2ViewsRepository.MessageFlowAssociation.Properties.outerMessageFlowRef) {
					return createOuterMessageFlowRefFlatComboViewer(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(Bpmn2Messages.MessageFlowAssociationPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.id, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionDefinitions, Bpmn2Messages.MessageFlowAssociationPropertiesEditionPart_ExtensionDefinitionsLabel);		 
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionDefinitions, Bpmn2ViewsRepository.SWT_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesAdvancedTableComposition(Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionValues, Bpmn2Messages.MessageFlowAssociationPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionValues, Bpmn2ViewsRepository.SWT_KIND));
		this.extensionValues.createControls(parent);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationAdvancedTableComposition(Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.documentation, Bpmn2Messages.MessageFlowAssociationPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.documentation, Bpmn2ViewsRepository.SWT_KIND));
		this.documentation.createControls(parent);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createInnerMessageFlowRefFlatComboViewer(Composite parent) {
		...
		innerMessageFlowRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.innerMessageFlowRef, Bpmn2ViewsRepository.SWT_KIND));
		...
		innerMessageFlowRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.innerMessageFlowRef, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getInnerMessageFlowRef()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.innerMessageFlowRef, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createOuterMessageFlowRefFlatComboViewer(Composite parent) {
		...
		outerMessageFlowRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.outerMessageFlowRef, Bpmn2ViewsRepository.SWT_KIND));
		...
		outerMessageFlowRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageFlowAssociationPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MessageFlowAssociation.Properties.outerMessageFlowRef, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getOuterMessageFlowRef()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MessageFlowAssociation.Properties.outerMessageFlowRef, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
