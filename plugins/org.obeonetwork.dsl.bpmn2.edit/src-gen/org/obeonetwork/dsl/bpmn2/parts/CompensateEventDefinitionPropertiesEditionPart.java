 ...
 * 
 */
public interface CompensateEventDefinitionPropertiesEditionPart {
	...
	/**
	 * Defines a new waitForCompletion
	 * @param newValue the new waitForCompletion to set
	 * 
	 */
	...
	/**
	 * Init the activityRef
	 * @param settings the combo setting
	 */
	public void initActivityRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new activityRef
	 * @param newValue the new activityRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the activityRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
