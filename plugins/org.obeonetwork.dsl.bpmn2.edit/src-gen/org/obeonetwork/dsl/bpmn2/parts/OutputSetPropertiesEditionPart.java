 ...
 * 
 */
public interface OutputSetPropertiesEditionPart {
	...
	/**
	 * Init the dataOutputRefs
	 * @param settings settings for the dataOutputRefs ReferencesTable 
	 */
	public void initDataOutputRefs(ReferencesTableSettings settings);

	/**
	 * Update the dataOutputRefs
	 * @param newValue the dataOutputRefs to update
	 * 
	 */
	public void updateDataOutputRefs();

	/**
	 * Adds the given filter to the dataOutputRefs edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the dataOutputRefs table
	 * 
	 */
	...
	/**
	 * Init the optionalOutputRefs
	 * @param settings settings for the optionalOutputRefs ReferencesTable 
	 */
	public void initOptionalOutputRefs(ReferencesTableSettings settings);

	/**
	 * Update the optionalOutputRefs
	 * @param newValue the optionalOutputRefs to update
	 * 
	 */
	public void updateOptionalOutputRefs();

	/**
	 * Adds the given filter to the optionalOutputRefs edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the optionalOutputRefs table
	 * 
	 */
	...
	/**
	 * Init the inputSetRefs
	 * @param settings settings for the inputSetRefs ReferencesTable 
	 */
	public void initInputSetRefs(ReferencesTableSettings settings);

	/**
	 * Update the inputSetRefs
	 * @param newValue the inputSetRefs to update
	 * 
	 */
	public void updateInputSetRefs();

	/**
	 * Adds the given filter to the inputSetRefs edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the inputSetRefs table
	 * 
	 */
