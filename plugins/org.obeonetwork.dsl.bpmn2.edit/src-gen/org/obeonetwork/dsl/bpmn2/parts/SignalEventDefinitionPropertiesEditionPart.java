 ...
 * 
 */
public interface SignalEventDefinitionPropertiesEditionPart {
	...
	/**
	 * Defines a new signalRef
	 * @param newValue the new signalRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the signalRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
