 ...
 * 
 */
public interface DataObjectReferencePropertiesEditionPart {
	...
	/**
	 * Init the itemSubjectRef
	 * @param settings the combo setting
	 */
	public void initItemSubjectRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new itemSubjectRef
	 * @param newValue the new itemSubjectRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the itemSubjectRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return the dataObjectRef
	 * 
	 */
	public EObject getDataObjectRef();

	/**
	 * Init the dataObjectRef
	 * @param settings the combo setting
	 */
	public void initDataObjectRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new dataObjectRef
	 * @param newValue the new dataObjectRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the dataObjectRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
