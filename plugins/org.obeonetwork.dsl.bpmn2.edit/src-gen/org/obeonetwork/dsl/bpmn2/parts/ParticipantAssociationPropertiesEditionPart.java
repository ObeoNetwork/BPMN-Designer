 ...
 * 
 */
public interface ParticipantAssociationPropertiesEditionPart {
	...
	/**
	 * @return the innerParticipantRef
	 * 
	 */
	public EObject getInnerParticipantRef();

	/**
	 * Init the innerParticipantRef
	 * @param settings the combo setting
	 */
	public void initInnerParticipantRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new innerParticipantRef
	 * @param newValue the new innerParticipantRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the innerParticipantRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return the outerParticipantRef
	 * 
	 */
	public EObject getOuterParticipantRef();

	/**
	 * Init the outerParticipantRef
	 * @param settings the combo setting
	 */
	public void initOuterParticipantRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new outerParticipantRef
	 * @param newValue the new outerParticipantRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the outerParticipantRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
