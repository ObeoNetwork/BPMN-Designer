 ...
 * 
 */
public interface CallActivityPropertiesEditionPart {
	...
	/**
	 * @return the calledElementRef
	 * 
	 */
	public EObject getCalledElementRef();

	/**
	 * Init the calledElementRef
	 * @param settings the combo setting
	 */
	public void initCalledElementRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new calledElementRef
	 * @param newValue the new calledElementRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the calledElementRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
