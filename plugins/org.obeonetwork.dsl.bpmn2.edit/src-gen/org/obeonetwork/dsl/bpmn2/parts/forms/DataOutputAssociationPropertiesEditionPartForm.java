 ...
 * 
 */
public class DataOutputAssociationPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DataOutputAssociationPropertiesEditionPart {
	 ...
	 */
	public DataOutputAssociationPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public DataOutputAssociationPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Bpmn2Messages.DataOutputAssociationPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DataOutputAssociationPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.DataOutputAssociation.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, Bpmn2ViewsRepository.DataOutputAssociation.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.DataOutputAssociation.Properties.id, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.extensionDefinitions = new ReferencesTable(getDescription(Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionDefinitions, Bpmn2Messages.DataOutputAssociationPropertiesEditionPart_ExtensionDefinitionsLabel), new ReferencesTableListener	() {
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionDefinitions, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionValues, Bpmn2Messages.DataOutputAssociationPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionValues, Bpmn2ViewsRepository.FORM_KIND));
		this.extensionValues.createControls(parent, widgetFactory);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.DataOutputAssociation.Properties.documentation, Bpmn2Messages.DataOutputAssociationPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.DataOutputAssociation.Properties.documentation, Bpmn2ViewsRepository.FORM_KIND));
		this.documentation.createControls(parent, widgetFactory);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createAssignmentTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.assignment = new ReferencesTable(getDescription(Bpmn2ViewsRepository.DataOutputAssociation.Properties.assignment, Bpmn2Messages.DataOutputAssociationPropertiesEditionPart_AssignmentLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.assignment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				assignment.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.assignment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				assignment.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.assignment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				assignment.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.assignment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				assignment.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.assignment.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.DataOutputAssociation.Properties.assignment, Bpmn2ViewsRepository.FORM_KIND));
		this.assignment.createControls(parent, widgetFactory);
		this.assignment.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.assignment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createTargetRefFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		targetRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.DataOutputAssociation.Properties.targetRef, Bpmn2ViewsRepository.FORM_KIND));
		...
		targetRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.targetRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTargetRef()));
			}

		});
		targetRef.setID(Bpmn2ViewsRepository.DataOutputAssociation.Properties.targetRef);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.DataOutputAssociation.Properties.targetRef, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSourceRefReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.sourceRef = new ReferencesTable(getDescription(Bpmn2ViewsRepository.DataOutputAssociation.Properties.sourceRef, Bpmn2Messages.DataOutputAssociationPropertiesEditionPart_SourceRefLabel), new ReferencesTableListener	() {
		...
		this.sourceRef.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.DataOutputAssociation.Properties.sourceRef, Bpmn2ViewsRepository.FORM_KIND));
		this.sourceRef.createControls(parent, widgetFactory);
		this.sourceRef.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.sourceRef, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSourceRef() {
		...
		"sourceRef", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.sourceRef,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				sourceRef.refresh();
			}
	...
	protected void moveSourceRef(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.sourceRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		sourceRef.refresh();
	}
	...
	protected void removeFromSourceRef(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataOutputAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.DataOutputAssociation.Properties.sourceRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		sourceRef.refresh();
	}
