 ...
 * 
 */
public interface MessageFlowAssociationPropertiesEditionPart {
	...
	/**
	 * @return the innerMessageFlowRef
	 * 
	 */
	public EObject getInnerMessageFlowRef();

	/**
	 * Init the innerMessageFlowRef
	 * @param settings the combo setting
	 */
	public void initInnerMessageFlowRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new innerMessageFlowRef
	 * @param newValue the new innerMessageFlowRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the innerMessageFlowRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return the outerMessageFlowRef
	 * 
	 */
	public EObject getOuterMessageFlowRef();

	/**
	 * Init the outerMessageFlowRef
	 * @param settings the combo setting
	 */
	public void initOuterMessageFlowRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new outerMessageFlowRef
	 * @param newValue the new outerMessageFlowRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the outerMessageFlowRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
