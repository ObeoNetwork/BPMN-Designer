 ...
 * 
 */
public interface LanePropertiesEditionPart {
	...
	/**
	 * @return the partitionElementRef
	 * 
	 */
	public EObject getPartitionElementRef();

	/**
	 * Init the partitionElementRef
	 * @param settings the combo setting
	 */
	public void initPartitionElementRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new partitionElementRef
	 * @param newValue the new partitionElementRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the partitionElementRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * Init the flowNodeRefs
	 * @param settings settings for the flowNodeRefs ReferencesTable 
	 */
	public void initFlowNodeRefs(ReferencesTableSettings settings);

	/**
	 * Update the flowNodeRefs
	 * @param newValue the flowNodeRefs to update
	 * 
	 */
	public void updateFlowNodeRefs();

	/**
	 * Adds the given filter to the flowNodeRefs edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the flowNodeRefs table
	 * 
	 */
