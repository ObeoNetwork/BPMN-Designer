 ...
 * 
 */
public class ConversationAssociationPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ConversationAssociationPropertiesEditionPart {
	 ...
	 */
	public ConversationAssociationPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ConversationAssociationPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(conversationAssociationStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == Bpmn2ViewsRepository.ConversationAssociation.Properties.innerConversationNodeRef) {
					return createInnerConversationNodeRefFlatComboViewer(parent, widgetFactory);
				}
				if (key == Bpmn2ViewsRepository.ConversationAssociation.Properties.outerConversationNodeRef) {
					return createOuterConversationNodeRefFlatComboViewer(parent, widgetFactory);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Bpmn2Messages.ConversationAssociationPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ConversationAssociationPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.ConversationAssociation.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, Bpmn2ViewsRepository.ConversationAssociation.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.ConversationAssociation.Properties.id, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.extensionDefinitions = new ReferencesTable(getDescription(Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionDefinitions, Bpmn2Messages.ConversationAssociationPropertiesEditionPart_ExtensionDefinitionsLabel), new ReferencesTableListener	() {
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionDefinitions, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionValues, Bpmn2Messages.ConversationAssociationPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionValues, Bpmn2ViewsRepository.FORM_KIND));
		this.extensionValues.createControls(parent, widgetFactory);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.ConversationAssociation.Properties.documentation, Bpmn2Messages.ConversationAssociationPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.ConversationAssociation.Properties.documentation, Bpmn2ViewsRepository.FORM_KIND));
		this.documentation.createControls(parent, widgetFactory);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createInnerConversationNodeRefFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		innerConversationNodeRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.ConversationAssociation.Properties.innerConversationNodeRef, Bpmn2ViewsRepository.FORM_KIND));
		widgetFactory.adapt(innerConversationNodeRef);
		...
		innerConversationNodeRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.innerConversationNodeRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getInnerConversationNodeRef()));
			}

		});
		innerConversationNodeRef.setID(Bpmn2ViewsRepository.ConversationAssociation.Properties.innerConversationNodeRef);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.ConversationAssociation.Properties.innerConversationNodeRef, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createOuterConversationNodeRefFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		outerConversationNodeRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.ConversationAssociation.Properties.outerConversationNodeRef, Bpmn2ViewsRepository.FORM_KIND));
		widgetFactory.adapt(outerConversationNodeRef);
		...
		outerConversationNodeRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConversationAssociationPropertiesEditionPartForm.this, Bpmn2ViewsRepository.ConversationAssociation.Properties.outerConversationNodeRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOuterConversationNodeRef()));
			}

		});
		outerConversationNodeRef.setID(Bpmn2ViewsRepository.ConversationAssociation.Properties.outerConversationNodeRef);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.ConversationAssociation.Properties.outerConversationNodeRef, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
