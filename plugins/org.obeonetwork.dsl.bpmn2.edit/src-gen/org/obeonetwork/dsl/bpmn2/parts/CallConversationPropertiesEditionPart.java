 ...
 * 
 */
public interface CallConversationPropertiesEditionPart {
	...
	/**
	 * @return the calledCollaborationRef
	 * 
	 */
	public EObject getCalledCollaborationRef();

	/**
	 * Init the calledCollaborationRef
	 * @param settings the combo setting
	 */
	public void initCalledCollaborationRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new calledCollaborationRef
	 * @param newValue the new calledCollaborationRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the calledCollaborationRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
