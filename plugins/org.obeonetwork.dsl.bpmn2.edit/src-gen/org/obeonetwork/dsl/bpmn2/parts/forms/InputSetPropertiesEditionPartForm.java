 ...
 * 
 */
public class InputSetPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, InputSetPropertiesEditionPart {
	 ...
	 */
	public InputSetPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public InputSetPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(inputSetStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == Bpmn2ViewsRepository.InputSet.Properties.dataInputRefs) {
					return createDataInputRefsReferencesTable(widgetFactory, parent);
				}
				if (key == Bpmn2ViewsRepository.InputSet.Properties.optionalInputRefs) {
					return createOptionalInputRefsReferencesTable(widgetFactory, parent);
				}
				if (key == Bpmn2ViewsRepository.InputSet.Properties.whileExecutingInputRefs) {
					return createWhileExecutingInputRefsReferencesTable(widgetFactory, parent);
				}
				if (key == Bpmn2ViewsRepository.InputSet.Properties.outputSetRefs) {
					return createOutputSetRefsReferencesTable(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Bpmn2Messages.InputSetPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							InputSetPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.InputSet.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, Bpmn2ViewsRepository.InputSet.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.InputSet.Properties.id, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.extensionDefinitions = new ReferencesTable(getDescription(Bpmn2ViewsRepository.InputSet.Properties.extensionDefinitions, Bpmn2Messages.InputSetPropertiesEditionPart_ExtensionDefinitionsLabel), new ReferencesTableListener	() {
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.InputSet.Properties.extensionDefinitions, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.InputSet.Properties.extensionValues, Bpmn2Messages.InputSetPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.InputSet.Properties.extensionValues, Bpmn2ViewsRepository.FORM_KIND));
		this.extensionValues.createControls(parent, widgetFactory);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.InputSet.Properties.documentation, Bpmn2Messages.InputSetPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.InputSet.Properties.documentation, Bpmn2ViewsRepository.FORM_KIND));
		this.documentation.createControls(parent, widgetFactory);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							InputSetPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.InputSet.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, Bpmn2ViewsRepository.InputSet.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.InputSet.Properties.name, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createDataInputRefsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.dataInputRefs = new ReferencesTable(getDescription(Bpmn2ViewsRepository.InputSet.Properties.dataInputRefs, Bpmn2Messages.InputSetPropertiesEditionPart_DataInputRefsLabel), new ReferencesTableListener	() {
		...
		this.dataInputRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.InputSet.Properties.dataInputRefs, Bpmn2ViewsRepository.FORM_KIND));
		this.dataInputRefs.createControls(parent, widgetFactory);
		this.dataInputRefs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.dataInputRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDataInputRefs() {
		...
		"dataInputRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.dataInputRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveDataInputRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.dataInputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		dataInputRefs.refresh();
	}
	...
	protected void removeFromDataInputRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.dataInputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		dataInputRefs.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createOptionalInputRefsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.optionalInputRefs = new ReferencesTable(getDescription(Bpmn2ViewsRepository.InputSet.Properties.optionalInputRefs, Bpmn2Messages.InputSetPropertiesEditionPart_OptionalInputRefsLabel), new ReferencesTableListener	() {
		...
		this.optionalInputRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.InputSet.Properties.optionalInputRefs, Bpmn2ViewsRepository.FORM_KIND));
		this.optionalInputRefs.createControls(parent, widgetFactory);
		this.optionalInputRefs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.optionalInputRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOptionalInputRefs() {
		...
		"optionalInputRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.optionalInputRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOptionalInputRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.optionalInputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		optionalInputRefs.refresh();
	}
	...
	protected void removeFromOptionalInputRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.optionalInputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		optionalInputRefs.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createWhileExecutingInputRefsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.whileExecutingInputRefs = new ReferencesTable(getDescription(Bpmn2ViewsRepository.InputSet.Properties.whileExecutingInputRefs, Bpmn2Messages.InputSetPropertiesEditionPart_WhileExecutingInputRefsLabel), new ReferencesTableListener	() {
		...
		this.whileExecutingInputRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.InputSet.Properties.whileExecutingInputRefs, Bpmn2ViewsRepository.FORM_KIND));
		this.whileExecutingInputRefs.createControls(parent, widgetFactory);
		this.whileExecutingInputRefs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.whileExecutingInputRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addWhileExecutingInputRefs() {
		...
		"whileExecutingInputRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.whileExecutingInputRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveWhileExecutingInputRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.whileExecutingInputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		whileExecutingInputRefs.refresh();
	}
	...
	protected void removeFromWhileExecutingInputRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.whileExecutingInputRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		whileExecutingInputRefs.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createOutputSetRefsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outputSetRefs = new ReferencesTable(getDescription(Bpmn2ViewsRepository.InputSet.Properties.outputSetRefs, Bpmn2Messages.InputSetPropertiesEditionPart_OutputSetRefsLabel), new ReferencesTableListener	() {
		...
		this.outputSetRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.InputSet.Properties.outputSetRefs, Bpmn2ViewsRepository.FORM_KIND));
		this.outputSetRefs.createControls(parent, widgetFactory);
		this.outputSetRefs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.outputSetRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOutputSetRefs() {
		...
		"outputSetRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.outputSetRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOutputSetRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.outputSetRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outputSetRefs.refresh();
	}
	...
	protected void removeFromOutputSetRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputSetPropertiesEditionPartForm.this, Bpmn2ViewsRepository.InputSet.Properties.outputSetRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outputSetRefs.refresh();
	}
