...
public interface OperationPropertiesEditionPart {
	...
	/**
	 * @return the inMessageRef
	 * 
	 */
	public EObject getInMessageRef();

	/**
	 * Init the inMessageRef
	 * @param settings the combo setting
	 */
	public void initInMessageRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new inMessageRef
	 * @param newValue the new inMessageRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the inMessageRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return the outMessageRef
	 * 
	 */
	public EObject getOutMessageRef();

	/**
	 * Init the outMessageRef
	 * @param settings the combo setting
	 */
	public void initOutMessageRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new outMessageRef
	 * @param newValue the new outMessageRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the outMessageRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * Init the errorRefs
	 * @param settings settings for the errorRefs ReferencesTable 
	 */
	public void initErrorRefs(ReferencesTableSettings settings);

	/**
	 * Update the errorRefs
	 * @param newValue the errorRefs to update
	 * 
	 */
	public void updateErrorRefs();

	/**
	 * Adds the given filter to the errorRefs edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the errorRefs table
	 * 
	 */
	...
	/**
	 * @return the implementationRef
	 * 
	 */
	public EObject getImplementationRef();

	/**
	 * Init the implementationRef
	 * @param settings the combo setting
	 */
	public void initImplementationRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new implementationRef
	 * @param newValue the new implementationRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the implementationRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
