 ...
 * 
 */
public class ProcessPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ProcessPropertiesEditionPart {
	 ...
	 */
	public ProcessPropertiesEditionPartForm() { super(); }
		...
		composer = new PartComposer(processStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == Bpmn2ViewsRepository.Process.Properties.processType) {
					return createProcessTypeEMFComboViewer(widgetFactory, parent);
				}
				...
				if (key == Bpmn2ViewsRepository.Process.Properties.definitionalCollaborationRef) {
					return createDefinitionalCollaborationRefFlatComboViewer(parent, widgetFactory);
				}
				if (key == Bpmn2ViewsRepository.Process.Properties.isExecutable) {
					return createIsExecutableCheckbox(widgetFactory, parent);
				}
				...
				if (key == Bpmn2ViewsRepository.Process.Properties.correlationSubscriptions) {
					return createCorrelationSubscriptionsTableComposition(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(Bpmn2Messages.ProcessPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.Process.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, Bpmn2ViewsRepository.Process.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.id, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.extensionDefinitions = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.extensionDefinitions, Bpmn2Messages.ProcessPropertiesEditionPart_ExtensionDefinitionsLabel), new ReferencesTableListener	() {
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.extensionDefinitions, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.extensionValues, Bpmn2Messages.ProcessPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.extensionValues, Bpmn2ViewsRepository.FORM_KIND));
		this.extensionValues.createControls(parent, widgetFactory);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.documentation, Bpmn2Messages.ProcessPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.documentation, Bpmn2ViewsRepository.FORM_KIND));
		this.documentation.createControls(parent, widgetFactory);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							Bpmn2ViewsRepository.Process.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, Bpmn2ViewsRepository.Process.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.name, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSupportedInterfaceRefsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.supportedInterfaceRefs = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.supportedInterfaceRefs, Bpmn2Messages.ProcessPropertiesEditionPart_SupportedInterfaceRefsLabel), new ReferencesTableListener	() {
		...
		this.supportedInterfaceRefs.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.supportedInterfaceRefs, Bpmn2ViewsRepository.FORM_KIND));
		...
		this.supportedInterfaceRefs.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.supportedInterfaceRefs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSupportedInterfaceRefs() {
		...
		"supportedInterfaceRefs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.supportedInterfaceRefs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveSupportedInterfaceRefs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.supportedInterfaceRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		supportedInterfaceRefs.refresh();
	}
	...
	protected void removeFromSupportedInterfaceRefs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.supportedInterfaceRefs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		supportedInterfaceRefs.refresh();
	}
	...
	protected Composite createIoBindingTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ioBinding = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.ioBinding, Bpmn2Messages.ProcessPropertiesEditionPart_IoBindingLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.ioBinding, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ioBinding.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.ioBinding, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ioBinding.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.ioBinding, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ioBinding.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.ioBinding, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ioBinding.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.ioBinding.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.ioBinding, Bpmn2ViewsRepository.FORM_KIND));
		this.ioBinding.createControls(parent, widgetFactory);
		this.ioBinding.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.ioBinding, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createLaneSetsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.laneSets = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.laneSets, Bpmn2Messages.ProcessPropertiesEditionPart_LaneSetsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.laneSets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				laneSets.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.laneSets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				laneSets.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.laneSets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				laneSets.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.laneSets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				laneSets.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.laneSets.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.laneSets, Bpmn2ViewsRepository.FORM_KIND));
		this.laneSets.createControls(parent, widgetFactory);
		this.laneSets.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.laneSets, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createProcessTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		processType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.processType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getProcessType()));
			}

		});
		processType.setID(Bpmn2ViewsRepository.Process.Properties.processType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.processType, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIsClosedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isClosed = widgetFactory.createButton(parent, getDescription(Bpmn2ViewsRepository.Process.Properties.isClosed, Bpmn2Messages.ProcessPropertiesEditionPart_IsClosedLabel), SWT.CHECK);
		isClosed.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.isClosed, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isClosed.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.isClosed, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.properties = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.properties_, Bpmn2Messages.ProcessPropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				properties.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				properties.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				properties.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.properties_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				properties.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.properties.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.properties_, Bpmn2ViewsRepository.FORM_KIND));
		this.properties.createControls(parent, widgetFactory);
		this.properties.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.properties_, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createSupportsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.supports = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.supports, Bpmn2Messages.ProcessPropertiesEditionPart_SupportsLabel), new ReferencesTableListener	() {
		...
		this.supports.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.supports, Bpmn2ViewsRepository.FORM_KIND));
		this.supports.createControls(parent, widgetFactory);
		this.supports.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.supports, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSupports() {
		...
		"supports", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.supports,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				supports.refresh();
			}
	...
	protected void moveSupports(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.supports, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		supports.refresh();
	}
	...
	protected void removeFromSupports(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.supports, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		supports.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createDefinitionalCollaborationRefFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		definitionalCollaborationRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.Process.Properties.definitionalCollaborationRef, Bpmn2ViewsRepository.FORM_KIND));
		widgetFactory.adapt(definitionalCollaborationRef);
		...
		definitionalCollaborationRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.definitionalCollaborationRef, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDefinitionalCollaborationRef()));
			}

		});
		definitionalCollaborationRef.setID(Bpmn2ViewsRepository.Process.Properties.definitionalCollaborationRef);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.definitionalCollaborationRef, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIsExecutableCheckbox(FormToolkit widgetFactory, Composite parent) {
		isExecutable = widgetFactory.createButton(parent, getDescription(Bpmn2ViewsRepository.Process.Properties.isExecutable, Bpmn2Messages.ProcessPropertiesEditionPart_IsExecutableLabel), SWT.CHECK);
		isExecutable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.isExecutable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isExecutable.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.isExecutable, Bpmn2ViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createResourcesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.resources = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.resources, Bpmn2Messages.ProcessPropertiesEditionPart_ResourcesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				resources.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				resources.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				resources.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.resources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				resources.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.resources.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.resources, Bpmn2ViewsRepository.FORM_KIND));
		this.resources.createControls(parent, widgetFactory);
		this.resources.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.resources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createArtifactsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.artifacts = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.artifacts, Bpmn2Messages.ProcessPropertiesEditionPart_ArtifactsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.artifacts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				artifacts.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.artifacts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				artifacts.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.artifacts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				artifacts.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.artifacts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				artifacts.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.artifacts.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.artifacts, Bpmn2ViewsRepository.FORM_KIND));
		this.artifacts.createControls(parent, widgetFactory);
		this.artifacts.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.artifacts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createCorrelationSubscriptionsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.correlationSubscriptions = new ReferencesTable(getDescription(Bpmn2ViewsRepository.Process.Properties.correlationSubscriptions, Bpmn2Messages.ProcessPropertiesEditionPart_CorrelationSubscriptionsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.correlationSubscriptions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				correlationSubscriptions.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.correlationSubscriptions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				correlationSubscriptions.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.correlationSubscriptions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				correlationSubscriptions.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.correlationSubscriptions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				correlationSubscriptions.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.correlationSubscriptions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.Process.Properties.correlationSubscriptions, Bpmn2ViewsRepository.FORM_KIND));
		this.correlationSubscriptions.createControls(parent, widgetFactory);
		this.correlationSubscriptions.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, Bpmn2ViewsRepository.Process.Properties.correlationSubscriptions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
