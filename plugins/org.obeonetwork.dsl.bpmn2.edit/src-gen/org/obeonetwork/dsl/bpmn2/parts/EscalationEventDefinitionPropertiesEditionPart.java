 ...
 * 
 */
public interface EscalationEventDefinitionPropertiesEditionPart {
	...
	/**
	 * Init the escalationRef
	 * @param settings the combo setting
	 */
	public void initEscalationRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new escalationRef
	 * @param newValue the new escalationRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the escalationRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
