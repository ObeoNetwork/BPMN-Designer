 ...
 * 
 */
public interface BoundaryEventPropertiesEditionPart {
	...
	/**
	 * Defines a new parallelMultiple
	 * @param newValue the new parallelMultiple to set
	 * 
	 */
	...
	/**
	 * Init the eventDefinitionRefs
	 * @param settings settings for the eventDefinitionRefs ReferencesTable 
	 */
	public void initEventDefinitionRefs(ReferencesTableSettings settings);

	/**
	 * Update the eventDefinitionRefs
	 * @param newValue the eventDefinitionRefs to update
	 * 
	 */
	public void updateEventDefinitionRefs();

	/**
	 * Adds the given filter to the eventDefinitionRefs edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the eventDefinitionRefs table
	 * 
	 */
	...
	/**
	 * Init the dataOutputAssociation
	 * @param current the current value
	 * @param containgFeature the feature where to navigate if necessary
	 * @param feature the feature to manage
	 */
	...
	/**
	 * Update the dataOutputAssociation
	 * @param newValue the dataOutputAssociation to update
	 * 
	 */
	public void updateDataOutputAssociation();

	/**
	 * Adds the given filter to the dataOutputAssociation edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the dataOutputAssociation table
	 * 
	 */
	...
	/**
	 * Update the eventDefinitions
	 * @param newValue the eventDefinitions to update
	 * 
	 */
	public void updateEventDefinitions();

	/**
	 * Adds the given filter to the eventDefinitions edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the eventDefinitions table
	 * 
	 */
	...
	/**
	 * Defines a new cancelActivity
	 * @param newValue the new cancelActivity to set
	 * 
	 */
	...
	/**
	 * Init the attachedToRef
	 * @param settings the combo setting
	 */
	public void initAttachedToRef(EObjectFlatComboSettings settings);

	/**
	 * Defines a new attachedToRef
	 * @param newValue the new attachedToRef to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the attachedToRef edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
