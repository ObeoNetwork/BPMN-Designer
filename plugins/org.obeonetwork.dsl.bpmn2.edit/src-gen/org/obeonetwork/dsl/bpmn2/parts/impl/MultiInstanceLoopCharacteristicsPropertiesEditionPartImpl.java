 ...
 * 
 */
public class MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, MultiInstanceLoopCharacteristicsPropertiesEditionPart {
	 ...
	 * 
	 */
	public MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(Bpmn2Messages.MultiInstanceLoopCharacteristicsPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.id, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExtensionDefinitionsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionDefinitions, Bpmn2Messages.MultiInstanceLoopCharacteristicsPropertiesEditionPart_ExtensionDefinitionsLabel);		 
		...
		this.extensionDefinitions.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionDefinitions, Bpmn2ViewsRepository.SWT_KIND));
		...
		this.extensionDefinitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionDefinitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"extensionDefinitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionDefinitions,
	...
	protected void moveExtensionDefinitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		extensionDefinitions.refresh();
	}
	...
	protected void removeFromExtensionDefinitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionDefinitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		extensionDefinitions.refresh();
	}
	...
	protected Composite createExtensionValuesAdvancedTableComposition(Composite parent) {
		this.extensionValues = new ReferencesTable(getDescription(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionValues, Bpmn2Messages.MultiInstanceLoopCharacteristicsPropertiesEditionPart_ExtensionValuesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				extensionValues.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				extensionValues.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				extensionValues.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionValues, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				extensionValues.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.extensionValues.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionValues, Bpmn2ViewsRepository.SWT_KIND));
		this.extensionValues.createControls(parent);
		this.extensionValues.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.extensionValues, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDocumentationAdvancedTableComposition(Composite parent) {
		this.documentation = new ReferencesTable(getDescription(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.documentation, Bpmn2Messages.MultiInstanceLoopCharacteristicsPropertiesEditionPart_DocumentationLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				documentation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				documentation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				documentation.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.documentation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				documentation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.documentation.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.documentation, Bpmn2ViewsRepository.SWT_KIND));
		this.documentation.createControls(parent);
		this.documentation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.documentation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createIsSequentialCheckbox(Composite parent) {
		isSequential = new Button(parent, SWT.CHECK);
		isSequential.setText(getDescription(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.isSequential, Bpmn2Messages.MultiInstanceLoopCharacteristicsPropertiesEditionPart_IsSequentialLabel));
		isSequential.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.isSequential, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isSequential.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.isSequential, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createBehaviorEMFComboViewer(Composite parent) {
		...
		behavior.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.behavior, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getBehavior()));
			}

		});
		behavior.setID(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.behavior);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.behavior, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createLoopDataInputRefFlatComboViewer(Composite parent) {
		...
		loopDataInputRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.loopDataInputRef, Bpmn2ViewsRepository.SWT_KIND));
		...
		loopDataInputRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.loopDataInputRef, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getLoopDataInputRef()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.loopDataInputRef, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createLoopDataOutputRefFlatComboViewer(Composite parent) {
		...
		loopDataOutputRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.loopDataOutputRef, Bpmn2ViewsRepository.SWT_KIND));
		...
		loopDataOutputRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.loopDataOutputRef, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getLoopDataOutputRef()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.loopDataOutputRef, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createComplexBehaviorDefinitionAdvancedTableComposition(Composite parent) {
		this.complexBehaviorDefinition = new ReferencesTable(getDescription(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.complexBehaviorDefinition, Bpmn2Messages.MultiInstanceLoopCharacteristicsPropertiesEditionPart_ComplexBehaviorDefinitionLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.complexBehaviorDefinition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				complexBehaviorDefinition.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.complexBehaviorDefinition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				complexBehaviorDefinition.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.complexBehaviorDefinition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				complexBehaviorDefinition.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.complexBehaviorDefinition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				complexBehaviorDefinition.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.complexBehaviorDefinition.setHelpText(propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.complexBehaviorDefinition, Bpmn2ViewsRepository.SWT_KIND));
		this.complexBehaviorDefinition.createControls(parent);
		this.complexBehaviorDefinition.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.complexBehaviorDefinition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createOneBehaviorEventRefFlatComboViewer(Composite parent) {
		...
		oneBehaviorEventRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.oneBehaviorEventRef, Bpmn2ViewsRepository.SWT_KIND));
		...
		oneBehaviorEventRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.oneBehaviorEventRef, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getOneBehaviorEventRef()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.oneBehaviorEventRef, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createNoneBehaviorEventRefFlatComboViewer(Composite parent) {
		...
		noneBehaviorEventRef = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.noneBehaviorEventRef, Bpmn2ViewsRepository.SWT_KIND));
		...
		noneBehaviorEventRef.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MultiInstanceLoopCharacteristicsPropertiesEditionPartImpl.this, Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.noneBehaviorEventRef, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getNoneBehaviorEventRef()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(Bpmn2ViewsRepository.MultiInstanceLoopCharacteristics.Properties.noneBehaviorEventRef, Bpmn2ViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
