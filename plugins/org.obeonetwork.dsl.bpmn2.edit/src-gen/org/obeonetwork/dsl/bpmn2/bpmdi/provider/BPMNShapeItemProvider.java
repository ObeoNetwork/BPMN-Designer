 ...
 * </copyright>
 */
package org.obeonetwork.dsl.bpmn2.bpmdi.provider;
...
import org.obeonetwork.dsl.dd.di.provider.LabeledShapeItemProvider;

/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.bpmdi.BPMNShape} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BPMNShapeItemProvider extends LabeledShapeItemProvider
    ...
    protected void addBpmnElementPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNShape_bpmnElement_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNShape_bpmnElement_feature", "_UI_BPMNShape_type"),
    ...
    protected void addIsHorizontalPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNShape_isHorizontal_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNShape_isHorizontal_feature", "_UI_BPMNShape_type"),
                BpmnDiPackage.Literals.BPMN_SHAPE__IS_HORIZONTAL, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addIsExpandedPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNShape_isExpanded_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNShape_isExpanded_feature", "_UI_BPMNShape_type"),
                BpmnDiPackage.Literals.BPMN_SHAPE__IS_EXPANDED, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addIsMarkerVisiblePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNShape_isMarkerVisible_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNShape_isMarkerVisible_feature", "_UI_BPMNShape_type"),
                BpmnDiPackage.Literals.BPMN_SHAPE__IS_MARKER_VISIBLE, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addIsMessageVisiblePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNShape_isMessageVisible_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNShape_isMessageVisible_feature", "_UI_BPMNShape_type"),
                BpmnDiPackage.Literals.BPMN_SHAPE__IS_MESSAGE_VISIBLE, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addParticipantBandKindPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNShape_participantBandKind_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNShape_participantBandKind_feature", "_UI_BPMNShape_type"),
                BpmnDiPackage.Literals.BPMN_SHAPE__PARTICIPANT_BAND_KIND, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addChoreographyActivityShapePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNShape_choreographyActivityShape_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNShape_choreographyActivityShape_feature", "_UI_BPMNShape_type"),
