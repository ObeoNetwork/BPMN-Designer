...
import org.obeonetwork.dsl.dd.di.provider.LabeledEdgeItemProvider;

/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.bpmdi.BPMNEdge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BPMNEdgeItemProvider extends LabeledEdgeItemProvider
    ...
    protected void addBpmnElementPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNEdge_bpmnElement_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNEdge_bpmnElement_feature", "_UI_BPMNEdge_type"),
    ...
    protected void addSourceElementPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNEdge_sourceElement_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNEdge_sourceElement_feature", "_UI_BPMNEdge_type"),
    ...
    protected void addTargetElementPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNEdge_targetElement_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNEdge_targetElement_feature", "_UI_BPMNEdge_type"),
    ...
    protected void addMessageVisibleKindPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BPMNEdge_messageVisibleKind_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BPMNEdge_messageVisibleKind_feature", "_UI_BPMNEdge_type"),
                BpmnDiPackage.Literals.BPMN_EDGE__MESSAGE_VISIBLE_KIND, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
