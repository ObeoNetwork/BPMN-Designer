...
public class ErrorItemProvider extends RootElementItemProvider
    ...
    protected void addStructureRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Error_structureRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Error_structureRef_feature", "_UI_Error_type"),
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Error_name_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Error_name_feature", "_UI_Error_type"), Bpmn2Package.Literals.ERROR__NAME, true, false, false,
    ...
    protected void addErrorCodePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Error_errorCode_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Error_errorCode_feature", "_UI_Error_type"), Bpmn2Package.Literals.ERROR__ERROR_CODE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Error_type") : label;
    }
