...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.FormalExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormalExpressionItemProvider extends ExpressionItemProvider
    ...
    protected void addLanguagePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_FormalExpression_language_feature"), getString("_UI_PropertyDescriptor_description", "_UI_FormalExpression_language_feature", "_UI_FormalExpression_type"),
                Bpmn2Package.Literals.FORMAL_EXPRESSION__LANGUAGE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addBodyPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_FormalExpression_body_feature"), getString("_UI_PropertyDescriptor_description", "_UI_FormalExpression_body_feature", "_UI_FormalExpression_type"),
    ...
    protected void addEvaluatesToTypeRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_FormalExpression_evaluatesToTypeRef_feature"),
