 ...
 * @generated
 */
public class TransactionItemProvider extends SubProcessItemProvider
    ...
    protected void addProtocolPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Transaction_protocol_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Transaction_protocol_feature", "_UI_Transaction_type"),
                Bpmn2Package.Literals.TRANSACTION__PROTOCOL, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addMethodPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Transaction_method_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Transaction_method_feature", "_UI_Transaction_type"),
                Bpmn2Package.Literals.TRANSACTION__METHOD, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
