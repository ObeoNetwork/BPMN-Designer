...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider extends RootElementItemProvider
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Message_name_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Message_name_feature", "_UI_Message_type"), Bpmn2Package.Literals.MESSAGE__NAME, true, false, false,
    ...
    protected void addItemRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Message_itemRef_feature"),
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Message_type") : label;
    }
