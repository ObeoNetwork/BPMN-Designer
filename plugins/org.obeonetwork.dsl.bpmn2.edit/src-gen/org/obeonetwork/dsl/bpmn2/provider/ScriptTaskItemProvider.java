...
public class ScriptTaskItemProvider extends TaskItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addScriptFormatPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ScriptTask_scriptFormat_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ScriptTask_scriptFormat_feature", "_UI_ScriptTask_type"),
                Bpmn2Package.Literals.SCRIPT_TASK__SCRIPT_FORMAT, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addScriptPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ScriptTask_script_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_ScriptTask_script_feature", "_UI_ScriptTask_type"), Bpmn2Package.Literals.SCRIPT_TASK__SCRIPT, true, false, false,
