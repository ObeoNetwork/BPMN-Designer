...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.ParticipantMultiplicity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParticipantMultiplicityItemProvider extends ItemProviderAdapter
    ...
    protected void addMinimumPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ParticipantMultiplicity_minimum_feature"),
                        ...
                        Bpmn2Package.Literals.PARTICIPANT_MULTIPLICITY__MINIMUM, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addMaximumPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ParticipantMultiplicity_maximum_feature"),
                        ...
                        Bpmn2Package.Literals.PARTICIPANT_MULTIPLICITY__MAXIMUM, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ParticipantMultiplicity_id_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ParticipantMultiplicity_id_feature", "_UI_ParticipantMultiplicity_type"),
                Bpmn2Package.Literals.PARTICIPANT_MULTIPLICITY__ID, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ParticipantMultiplicity_type") : getString("_UI_ParticipantMultiplicity_type") + " " + label;
    }
