...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.BoundaryEvent} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class BoundaryEventItemProvider extends CatchEventItemProvider
    ...
    protected void addCancelActivityPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BoundaryEvent_cancelActivity_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BoundaryEvent_cancelActivity_feature", "_UI_BoundaryEvent_type"),
                Bpmn2Package.Literals.BOUNDARY_EVENT__CANCEL_ACTIVITY, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addAttachedToRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_BoundaryEvent_attachedToRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_BoundaryEvent_attachedToRef_feature", "_UI_BoundaryEvent_type"),
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_BoundaryEvent_type") : label;
    }
