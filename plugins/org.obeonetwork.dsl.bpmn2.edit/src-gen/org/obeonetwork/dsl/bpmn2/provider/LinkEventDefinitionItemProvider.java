...
public class LinkEventDefinitionItemProvider extends EventDefinitionItemProvider
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_LinkEventDefinition_name_feature"), getString("_UI_PropertyDescriptor_description", "_UI_LinkEventDefinition_name_feature", "_UI_LinkEventDefinition_type"),
                Bpmn2Package.Literals.LINK_EVENT_DEFINITION__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addTargetPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_LinkEventDefinition_target_feature"), getString("_UI_PropertyDescriptor_description", "_UI_LinkEventDefinition_target_feature", "_UI_LinkEventDefinition_type"),
    ...
    protected void addSourcePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_LinkEventDefinition_source_feature"), getString("_UI_PropertyDescriptor_description", "_UI_LinkEventDefinition_source_feature", "_UI_LinkEventDefinition_type"),
