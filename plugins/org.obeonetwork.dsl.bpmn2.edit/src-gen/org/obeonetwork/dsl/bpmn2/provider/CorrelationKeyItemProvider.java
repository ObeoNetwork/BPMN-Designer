...
public class CorrelationKeyItemProvider extends BaseElementItemProvider
    ...
    protected void addCorrelationPropertyRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_CorrelationKey_correlationPropertyRef_feature"),
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_CorrelationKey_name_feature"), getString("_UI_PropertyDescriptor_description", "_UI_CorrelationKey_name_feature", "_UI_CorrelationKey_type"),
                Bpmn2Package.Literals.CORRELATION_KEY__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns CorrelationKey.png. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_CorrelationKey_type") : label;
    }
