...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.Gateway} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GatewayItemProvider extends FlowNodeItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addGatewayDirectionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Gateway_gatewayDirection_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Gateway_gatewayDirection_feature", "_UI_Gateway_type"),
                Bpmn2Package.Literals.GATEWAY__GATEWAY_DIRECTION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Gateway_type") : label;
    }
