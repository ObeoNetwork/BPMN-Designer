...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.PartnerEntity} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class PartnerEntityItemProvider extends RootElementItemProvider
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_PartnerEntity_name_feature"), getString("_UI_PropertyDescriptor_description", "_UI_PartnerEntity_name_feature", "_UI_PartnerEntity_type"),
                Bpmn2Package.Literals.PARTNER_ENTITY__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addParticipantRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_PartnerEntity_participantRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_PartnerEntity_participantRef_feature", "_UI_PartnerEntity_type"),
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_PartnerEntity_type") : label;
    }
