...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.ResourceRole} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class ResourceRoleItemProvider extends BaseElementItemProvider
    ...
    protected void addResourceRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ResourceRole_resourceRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ResourceRole_resourceRef_feature", "_UI_ResourceRole_type"),
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ResourceRole_name_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_ResourceRole_name_feature", "_UI_ResourceRole_type"), Bpmn2Package.Literals.RESOURCE_ROLE__NAME, true, false, false,
