...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.Participant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParticipantItemProvider extends BaseElementItemProvider
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Participant_name_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Participant_name_feature", "_UI_Participant_type"), Bpmn2Package.Literals.PARTICIPANT__NAME, true, false, false,
    ...
    protected void addInterfaceRefsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Participant_interfaceRefs_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Participant_interfaceRefs_feature", "_UI_Participant_type"),
    ...
    protected void addEndPointRefsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Participant_endPointRefs_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Participant_endPointRefs_feature", "_UI_Participant_type"),
    ...
    protected void addProcessRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Participant_processRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Participant_processRef_feature", "_UI_Participant_type"),
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Participant_type") : label;
    }
