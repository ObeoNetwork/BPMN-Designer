...
public class InclusiveGatewayItemProvider extends GatewayItemProvider
    ...
    protected void addDefaultPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_InclusiveGateway_default_feature"), getString("_UI_PropertyDescriptor_description", "_UI_InclusiveGateway_default_feature", "_UI_InclusiveGateway_type"),
