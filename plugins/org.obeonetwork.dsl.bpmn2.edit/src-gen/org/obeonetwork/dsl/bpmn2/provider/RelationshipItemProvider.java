...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipItemProvider extends BaseElementItemProvider
    ...
    protected void addTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Relationship_type_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Relationship_type_feature", "_UI_Relationship_type"), Bpmn2Package.Literals.RELATIONSHIP__TYPE, true, false, false,
    ...
    protected void addDirectionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Relationship_direction_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Relationship_direction_feature", "_UI_Relationship_type"),
                Bpmn2Package.Literals.RELATIONSHIP__DIRECTION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addSourcesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Relationship_sources_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Relationship_sources_feature", "_UI_Relationship_type"),
    ...
    protected void addTargetsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Relationship_targets_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Relationship_targets_feature", "_UI_Relationship_type"),
