...
public class SendTaskItemProvider extends TaskItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addImplementationPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_SendTask_implementation_feature"), getString("_UI_PropertyDescriptor_description", "_UI_SendTask_implementation_feature", "_UI_SendTask_type"),
                Bpmn2Package.Literals.SEND_TASK__IMPLEMENTATION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addOperationRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_SendTask_operationRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_SendTask_operationRef_feature", "_UI_SendTask_type"),
    ...
    protected void addMessageRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_SendTask_messageRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_SendTask_messageRef_feature", "_UI_SendTask_type"),
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SendTask_type") : label;
    }
