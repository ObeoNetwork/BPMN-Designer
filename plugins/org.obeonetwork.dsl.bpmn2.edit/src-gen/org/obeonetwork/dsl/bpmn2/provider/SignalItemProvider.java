...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.Signal} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class SignalItemProvider extends RootElementItemProvider
    ...
    protected void addStructureRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Signal_structureRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Signal_structureRef_feature", "_UI_Signal_type"),
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Signal_name_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Signal_name_feature", "_UI_Signal_type"), Bpmn2Package.Literals.SIGNAL__NAME, true, false, false,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Signal_type") : label;
    }
