...
public class InputOutputBindingItemProvider extends ItemProviderAdapter
    ...
    protected void addInputDataRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_InputOutputBinding_inputDataRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_InputOutputBinding_inputDataRef_feature", "_UI_InputOutputBinding_type"),
    ...
    protected void addOutputDataRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_InputOutputBinding_outputDataRef_feature"),
    ...
    protected void addOperationRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_InputOutputBinding_operationRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_InputOutputBinding_operationRef_feature", "_UI_InputOutputBinding_type"),
    ...
    protected void addIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_InputOutputBinding_id_feature"), getString("_UI_PropertyDescriptor_description", "_UI_InputOutputBinding_id_feature", "_UI_InputOutputBinding_type"),
                Bpmn2Package.Literals.INPUT_OUTPUT_BINDING__ID, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_InputOutputBinding_type") : getString("_UI_InputOutputBinding_type") + " " + label;
    }
