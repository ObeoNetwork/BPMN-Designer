 ...
 * {@link org.obeonetwork.dsl.bpmn2.ConversationLink} object. <!--
...
public class ConversationLinkItemProvider extends BaseElementItemProvider
    ...
    protected void addSourceRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ConversationLink_sourceRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ConversationLink_sourceRef_feature", "_UI_ConversationLink_type"),
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ConversationLink_name_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ConversationLink_name_feature", "_UI_ConversationLink_type"),
                Bpmn2Package.Literals.CONVERSATION_LINK__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addTargetRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ConversationLink_targetRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ConversationLink_targetRef_feature", "_UI_ConversationLink_type"),
                Bpmn2Package.Literals.CONVERSATION_LINK__TARGET_REF, true, false, true, null, null, null));
    }

    /**
     * This returns ConversationLink.png. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ConversationLink_type") : label;
    }
