...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.SequenceFlow} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class SequenceFlowItemProvider extends FlowElementItemProvider
    ...
    protected void addIsImmediatePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                Bpmn2Package.Literals.SEQUENCE_FLOW__IS_IMMEDIATE, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addTargetRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_SequenceFlow_targetRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_targetRef_feature", "_UI_SequenceFlow_type"),
    ...
    protected void addSourceRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_SequenceFlow_sourceRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_sourceRef_feature", "_UI_SequenceFlow_type"),
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SequenceFlow_type") : label;
    }
