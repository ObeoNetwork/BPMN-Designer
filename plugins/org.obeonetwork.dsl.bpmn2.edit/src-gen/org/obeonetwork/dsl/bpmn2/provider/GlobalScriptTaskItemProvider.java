...
public class GlobalScriptTaskItemProvider extends GlobalTaskItemProvider
    ...
    protected void addScriptLanguagePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_GlobalScriptTask_scriptLanguage_feature"), getString("_UI_PropertyDescriptor_description", "_UI_GlobalScriptTask_scriptLanguage_feature", "_UI_GlobalScriptTask_type"),
                Bpmn2Package.Literals.GLOBAL_SCRIPT_TASK__SCRIPT_LANGUAGE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addScriptPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_GlobalScriptTask_script_feature"), getString("_UI_PropertyDescriptor_description", "_UI_GlobalScriptTask_script_feature", "_UI_GlobalScriptTask_type"),
                Bpmn2Package.Literals.GLOBAL_SCRIPT_TASK__SCRIPT, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
