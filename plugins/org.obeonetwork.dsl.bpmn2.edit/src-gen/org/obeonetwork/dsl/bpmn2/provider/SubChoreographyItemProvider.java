...
public class SubChoreographyItemProvider extends ChoreographyActivityItemProvider
    ...
    /**
     * This returns SubChoreography.png. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SubChoreography_type") : label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(Bpmn2Package.Literals.SUB_CHOREOGRAPHY__ARTIFACTS, Bpmn2Factory.eINSTANCE.createTextAnnotation()));

        newChildDescriptors.add(createChildParameter(Bpmn2Package.Literals.SUB_CHOREOGRAPHY__ARTIFACTS, Bpmn2Factory.eINSTANCE.createGroup()));

        newChildDescriptors.add(createChildParameter(Bpmn2Package.Literals.SUB_CHOREOGRAPHY__ARTIFACTS, Bpmn2Factory.eINSTANCE.createAssociation()));
    }
