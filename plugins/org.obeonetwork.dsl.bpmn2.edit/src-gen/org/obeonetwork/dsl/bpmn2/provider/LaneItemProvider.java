...
public class LaneItemProvider extends BaseElementItemProvider implements
	...
	protected void addFlowNodeRefsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Lane_flowNodeRefs_feature", "_UI_Lane_type"),
				Bpmn2Package.Literals.LANE__FLOW_NODE_REFS, true, false, true,
				null, null, null));
	}
	...
	public Object getImage(Object object) {
		try {
			return overlayImage(object,
					getResourceLocator().getImage("full/obj16/Lane.png"));
		} catch (java.util.MissingResourceException e) {
			return overlayImage(object,
					getResourceLocator().getImage("full/obj16/Lane.gif"));
		}
	}
