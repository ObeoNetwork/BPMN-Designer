...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.bpmn2.ItemDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemDefinitionItemProvider extends RootElementItemProvider
    ...
    protected void addItemKindPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ItemDefinition_itemKind_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ItemDefinition_itemKind_feature", "_UI_ItemDefinition_type"),
                Bpmn2Package.Literals.ITEM_DEFINITION__ITEM_KIND, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addStructureRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ItemDefinition_structureRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ItemDefinition_structureRef_feature", "_UI_ItemDefinition_type"),
    ...
    protected void addIsCollectionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ItemDefinition_isCollection_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ItemDefinition_isCollection_feature", "_UI_ItemDefinition_type"),
                Bpmn2Package.Literals.ITEM_DEFINITION__IS_COLLECTION, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addImportPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ItemDefinition_import_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ItemDefinition_import_feature", "_UI_ItemDefinition_type"),
