...
public class StandardLoopCharacteristicsItemProvider extends
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Bpmn2Package.Literals.STANDARD_LOOP_CHARACTERISTICS__LOOP_MAXIMUM);
		}
		...
		try {
			return overlayImage(
					...
					getResourceLocator().getImage(
							"full/obj16/StandardLoopCharacteristics.png"));
		} catch (java.util.MissingResourceException e) {
			return overlayImage(
					object,
					getResourceLocator().getImage(
							"full/obj16/StandardLoopCharacteristics.gif"));
		}
	}
