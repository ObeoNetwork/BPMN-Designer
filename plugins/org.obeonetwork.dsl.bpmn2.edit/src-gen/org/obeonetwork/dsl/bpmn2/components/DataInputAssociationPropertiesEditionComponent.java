 ...
 * 
 */
public class DataInputAssociationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public DataInputAssociationPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject dataInputAssociation, String editing_mode) {
		super(editingContext, dataInputAssociation, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = Bpmn2ViewsRepository.class;
		partKey = Bpmn2ViewsRepository.DataInputAssociation.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final DataInputAssociation dataInputAssociation = (DataInputAssociation)elt;
			final DataInputAssociationPropertiesEditionPart basePart = (DataInputAssociationPropertiesEditionPart)editingPart;
			// init values
			if (dataInputAssociation.getId() != null && isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, dataInputAssociation.getId()));
			
			if (isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.extensionDefinitions)) {
				extensionDefinitionsSettings = new ReferencesTableSettings(dataInputAssociation, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions());
				basePart.initExtensionDefinitions(extensionDefinitionsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.extensionValues)) {
				extensionValuesSettings = new ReferencesTableSettings(dataInputAssociation, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues());
				basePart.initExtensionValues(extensionValuesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.documentation)) {
				documentationSettings = new ReferencesTableSettings(dataInputAssociation, Bpmn2Package.eINSTANCE.getBaseElement_Documentation());
				basePart.initDocumentation(documentationSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.assignment)) {
				assignmentSettings = new ReferencesTableSettings(dataInputAssociation, Bpmn2Package.eINSTANCE.getDataAssociation_Assignment());
				basePart.initAssignment(assignmentSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.targetRef)) {
				// init part
				targetRefSettings = new EObjectFlatComboSettings(dataInputAssociation, Bpmn2Package.eINSTANCE.getDataAssociation_TargetRef());
				basePart.initTargetRef(targetRefSettings);
				// set the button mode
				basePart.setTargetRefButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.sourceRef)) {
				sourceRefSettings = new ReferencesTableSettings(dataInputAssociation, Bpmn2Package.eINSTANCE.getDataAssociation_SourceRef());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == Bpmn2ViewsRepository.DataInputAssociation.Properties.id) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Id();
		}
		if (editorKey == Bpmn2ViewsRepository.DataInputAssociation.Properties.extensionDefinitions) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions();
		}
		if (editorKey == Bpmn2ViewsRepository.DataInputAssociation.Properties.extensionValues) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues();
		}
		if (editorKey == Bpmn2ViewsRepository.DataInputAssociation.Properties.documentation) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Documentation();
		}
		if (editorKey == Bpmn2ViewsRepository.DataInputAssociation.Properties.assignment) {
			return Bpmn2Package.eINSTANCE.getDataAssociation_Assignment();
		}
		if (editorKey == Bpmn2ViewsRepository.DataInputAssociation.Properties.targetRef) {
			return Bpmn2Package.eINSTANCE.getDataAssociation_TargetRef();
		}
		if (editorKey == Bpmn2ViewsRepository.DataInputAssociation.Properties.sourceRef) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		DataInputAssociation dataInputAssociation = (DataInputAssociation)semanticObject;
		if (Bpmn2ViewsRepository.DataInputAssociation.Properties.id == event.getAffectedEditor()) {
			dataInputAssociation.setId((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.DataInputAssociation.Properties.extensionDefinitions == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.DataInputAssociation.Properties.extensionValues == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.DataInputAssociation.Properties.documentation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.DataInputAssociation.Properties.assignment == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.DataInputAssociation.Properties.targetRef == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.DataInputAssociation.Properties.sourceRef == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			DataInputAssociationPropertiesEditionPart basePart = (DataInputAssociationPropertiesEditionPart)editingPart;
			if (Bpmn2Package.eINSTANCE.getBaseElement_Id().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.id)) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.extensionDefinitions))
				basePart.updateExtensionDefinitions();
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.extensionValues))
				basePart.updateExtensionValues();
			if (Bpmn2Package.eINSTANCE.getBaseElement_Documentation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.documentation))
				basePart.updateDocumentation();
			if (Bpmn2Package.eINSTANCE.getDataAssociation_Assignment().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.assignment))
				basePart.updateAssignment();
			if (Bpmn2Package.eINSTANCE.getDataAssociation_TargetRef().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.targetRef))
				basePart.setTargetRef((EObject)msg.getNewValue());
			if (Bpmn2Package.eINSTANCE.getDataAssociation_SourceRef().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.DataInputAssociation.Properties.sourceRef))
	...
	public boolean isRequired(Object key, int kind) {
		return key == Bpmn2ViewsRepository.DataInputAssociation.Properties.id || key == Bpmn2ViewsRepository.DataInputAssociation.Properties.targetRef;
	}
