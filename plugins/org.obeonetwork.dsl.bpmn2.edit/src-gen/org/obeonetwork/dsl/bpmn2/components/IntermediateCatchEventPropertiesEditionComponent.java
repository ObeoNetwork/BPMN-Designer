 ...
 * 
 */
public class IntermediateCatchEventPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public IntermediateCatchEventPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject intermediateCatchEvent, String editing_mode) {
		super(editingContext, intermediateCatchEvent, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = Bpmn2ViewsRepository.class;
		partKey = Bpmn2ViewsRepository.IntermediateCatchEvent.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final IntermediateCatchEvent intermediateCatchEvent = (IntermediateCatchEvent)elt;
			final IntermediateCatchEventPropertiesEditionPart basePart = (IntermediateCatchEventPropertiesEditionPart)editingPart;
			// init values
			if (intermediateCatchEvent.getId() != null && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, intermediateCatchEvent.getId()));
			
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions)) {
				extensionDefinitionsSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions());
				basePart.initExtensionDefinitions(extensionDefinitionsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues)) {
				extensionValuesSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues());
				basePart.initExtensionValues(extensionValuesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation)) {
				documentationSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getBaseElement_Documentation());
				basePart.initDocumentation(documentationSettings);
			}
			if (intermediateCatchEvent.getName() != null && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, intermediateCatchEvent.getName()));
			
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef)) {
				categoryValueRefSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef());
				basePart.initCategoryValueRef(categoryValueRefSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing)) {
				outgoingSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getFlowNode_Outgoing());
				basePart.initOutgoing(outgoingSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming)) {
				incomingSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getFlowNode_Incoming());
				basePart.initIncoming(incomingSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_)) {
				propertiesSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getEvent_Properties());
				basePart.initProperties(propertiesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.parallelMultiple)) {
				basePart.setParallelMultiple(intermediateCatchEvent.isParallelMultiple());
			}
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs)) {
				eventDefinitionRefsSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getCatchEvent_EventDefinitionRefs());
				basePart.initEventDefinitionRefs(eventDefinitionRefsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation)) {
				dataOutputAssociationSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getCatchEvent_DataOutputAssociation());
				basePart.initDataOutputAssociation(dataOutputAssociationSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions)) {
				eventDefinitionsSettings = new ReferencesTableSettings(intermediateCatchEvent, Bpmn2Package.eINSTANCE.getCatchEvent_EventDefinitions());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.id) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Id();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Documentation();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.name) {
			return Bpmn2Package.eINSTANCE.getFlowElement_Name();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef) {
			return Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing) {
			return Bpmn2Package.eINSTANCE.getFlowNode_Outgoing();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming) {
			return Bpmn2Package.eINSTANCE.getFlowNode_Incoming();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_) {
			return Bpmn2Package.eINSTANCE.getEvent_Properties();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.parallelMultiple) {
			return Bpmn2Package.eINSTANCE.getCatchEvent_ParallelMultiple();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs) {
			return Bpmn2Package.eINSTANCE.getCatchEvent_EventDefinitionRefs();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation) {
			return Bpmn2Package.eINSTANCE.getCatchEvent_DataOutputAssociation();
		}
		if (editorKey == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		IntermediateCatchEvent intermediateCatchEvent = (IntermediateCatchEvent)semanticObject;
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.id == event.getAffectedEditor()) {
			intermediateCatchEvent.setId((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.name == event.getAffectedEditor()) {
			intermediateCatchEvent.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				if (event.getNewValue() instanceof SequenceFlow) {
		...
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_ == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.parallelMultiple == event.getAffectedEditor()) {
			intermediateCatchEvent.setParallelMultiple((Boolean)event.getNewValue());
		}
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			IntermediateCatchEventPropertiesEditionPart basePart = (IntermediateCatchEventPropertiesEditionPart)editingPart;
			if (Bpmn2Package.eINSTANCE.getBaseElement_Id().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.id)) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionDefinitions))
				basePart.updateExtensionDefinitions();
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.extensionValues))
				basePart.updateExtensionValues();
			if (Bpmn2Package.eINSTANCE.getBaseElement_Documentation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.documentation))
				basePart.updateDocumentation();
			if (Bpmn2Package.eINSTANCE.getFlowElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.categoryValueRef))
				basePart.updateCategoryValueRef();
			if (Bpmn2Package.eINSTANCE.getFlowNode_Outgoing().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.outgoing))
				basePart.updateOutgoing();
			if (Bpmn2Package.eINSTANCE.getFlowNode_Incoming().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.incoming))
				basePart.updateIncoming();
			if (Bpmn2Package.eINSTANCE.getEvent_Properties().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.properties_))
				basePart.updateProperties();
			if (Bpmn2Package.eINSTANCE.getCatchEvent_ParallelMultiple().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.parallelMultiple))
				basePart.setParallelMultiple((Boolean)msg.getNewValue());
			
			if (Bpmn2Package.eINSTANCE.getCatchEvent_EventDefinitionRefs().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitionRefs))
				basePart.updateEventDefinitionRefs();
			if (Bpmn2Package.eINSTANCE.getCatchEvent_DataOutputAssociation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.dataOutputAssociation))
				basePart.updateDataOutputAssociation();
			if (Bpmn2Package.eINSTANCE.getCatchEvent_EventDefinitions().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.eventDefinitions))
	...
	public boolean isRequired(Object key, int kind) {
		return key == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.id || key == Bpmn2ViewsRepository.IntermediateCatchEvent.Properties.parallelMultiple;
	}
