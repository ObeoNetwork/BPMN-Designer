 ...
 * 
 */
public class GlobalManualTaskPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public GlobalManualTaskPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject globalManualTask, String editing_mode) {
		super(editingContext, globalManualTask, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = Bpmn2ViewsRepository.class;
		partKey = Bpmn2ViewsRepository.GlobalManualTask.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final GlobalManualTask globalManualTask = (GlobalManualTask)elt;
			final GlobalManualTaskPropertiesEditionPart basePart = (GlobalManualTaskPropertiesEditionPart)editingPart;
			// init values
			if (globalManualTask.getId() != null && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, globalManualTask.getId()));
			
			if (isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.extensionDefinitions)) {
				extensionDefinitionsSettings = new ReferencesTableSettings(globalManualTask, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions());
				basePart.initExtensionDefinitions(extensionDefinitionsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.extensionValues)) {
				extensionValuesSettings = new ReferencesTableSettings(globalManualTask, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues());
				basePart.initExtensionValues(extensionValuesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.documentation)) {
				documentationSettings = new ReferencesTableSettings(globalManualTask, Bpmn2Package.eINSTANCE.getBaseElement_Documentation());
				basePart.initDocumentation(documentationSettings);
			}
			if (globalManualTask.getName() != null && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, globalManualTask.getName()));
			
			if (isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.supportedInterfaceRefs)) {
				supportedInterfaceRefsSettings = new ReferencesTableSettings(globalManualTask, Bpmn2Package.eINSTANCE.getCallableElement_SupportedInterfaceRefs());
				basePart.initSupportedInterfaceRefs(supportedInterfaceRefsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.ioBinding)) {
				ioBindingSettings = new ReferencesTableSettings(globalManualTask, Bpmn2Package.eINSTANCE.getCallableElement_IoBinding());
				basePart.initIoBinding(ioBindingSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.resources)) {
				resourcesSettings = new ReferencesTableSettings(globalManualTask, Bpmn2Package.eINSTANCE.getGlobalTask_Resources());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == Bpmn2ViewsRepository.GlobalManualTask.Properties.id) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Id();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalManualTask.Properties.extensionDefinitions) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalManualTask.Properties.extensionValues) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalManualTask.Properties.documentation) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Documentation();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalManualTask.Properties.name) {
			return Bpmn2Package.eINSTANCE.getCallableElement_Name();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalManualTask.Properties.supportedInterfaceRefs) {
			return Bpmn2Package.eINSTANCE.getCallableElement_SupportedInterfaceRefs();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalManualTask.Properties.ioBinding) {
			return Bpmn2Package.eINSTANCE.getCallableElement_IoBinding();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalManualTask.Properties.resources) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		GlobalManualTask globalManualTask = (GlobalManualTask)semanticObject;
		if (Bpmn2ViewsRepository.GlobalManualTask.Properties.id == event.getAffectedEditor()) {
			globalManualTask.setId((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.GlobalManualTask.Properties.extensionDefinitions == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.GlobalManualTask.Properties.extensionValues == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalManualTask.Properties.documentation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalManualTask.Properties.name == event.getAffectedEditor()) {
			globalManualTask.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.GlobalManualTask.Properties.supportedInterfaceRefs == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalManualTask.Properties.ioBinding == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalManualTask.Properties.resources == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			GlobalManualTaskPropertiesEditionPart basePart = (GlobalManualTaskPropertiesEditionPart)editingPart;
			if (Bpmn2Package.eINSTANCE.getBaseElement_Id().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.id)) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.extensionDefinitions))
				basePart.updateExtensionDefinitions();
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.extensionValues))
				basePart.updateExtensionValues();
			if (Bpmn2Package.eINSTANCE.getBaseElement_Documentation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.documentation))
				basePart.updateDocumentation();
			if (Bpmn2Package.eINSTANCE.getCallableElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (Bpmn2Package.eINSTANCE.getCallableElement_SupportedInterfaceRefs().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.supportedInterfaceRefs))
				basePart.updateSupportedInterfaceRefs();
			if (Bpmn2Package.eINSTANCE.getCallableElement_IoBinding().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.ioBinding))
				basePart.updateIoBinding();
			if (Bpmn2Package.eINSTANCE.getGlobalTask_Resources().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalManualTask.Properties.resources))
	...
	public boolean isRequired(Object key, int kind) {
		return key == Bpmn2ViewsRepository.GlobalManualTask.Properties.id;
	}
