 ...
 * 
 */
public class GlobalConversationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public GlobalConversationPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject globalConversation, String editing_mode) {
		super(editingContext, globalConversation, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = Bpmn2ViewsRepository.class;
		partKey = Bpmn2ViewsRepository.GlobalConversation.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final GlobalConversation globalConversation = (GlobalConversation)elt;
			final GlobalConversationPropertiesEditionPart basePart = (GlobalConversationPropertiesEditionPart)editingPart;
			// init values
			if (globalConversation.getId() != null && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, globalConversation.getId()));
			
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.extensionDefinitions)) {
				extensionDefinitionsSettings = new ReferencesTableSettings(globalConversation, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions());
				basePart.initExtensionDefinitions(extensionDefinitionsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.extensionValues)) {
				extensionValuesSettings = new ReferencesTableSettings(globalConversation, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues());
				basePart.initExtensionValues(extensionValuesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.documentation)) {
				documentationSettings = new ReferencesTableSettings(globalConversation, Bpmn2Package.eINSTANCE.getBaseElement_Documentation());
				basePart.initDocumentation(documentationSettings);
			}
			if (globalConversation.getName() != null && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, globalConversation.getName()));
			
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.isClosed)) {
				basePart.setIsClosed(globalConversation.isIsClosed());
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.choreographyRef)) {
				choreographyRefSettings = new ReferencesTableSettings(globalConversation, Bpmn2Package.eINSTANCE.getCollaboration_ChoreographyRef());
				basePart.initChoreographyRef(choreographyRefSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.artifacts)) {
				artifactsSettings = new ReferencesTableSettings(globalConversation, Bpmn2Package.eINSTANCE.getCollaboration_Artifacts());
				basePart.initArtifacts(artifactsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.participantAssociations)) {
				participantAssociationsSettings = new ReferencesTableSettings(globalConversation, Bpmn2Package.eINSTANCE.getCollaboration_ParticipantAssociations());
				basePart.initParticipantAssociations(participantAssociationsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.messageFlowAssociations)) {
				messageFlowAssociationsSettings = new ReferencesTableSettings(globalConversation, Bpmn2Package.eINSTANCE.getCollaboration_MessageFlowAssociations());
				basePart.initMessageFlowAssociations(messageFlowAssociationsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.messageFlows)) {
				messageFlowsSettings = new ReferencesTableSettings(globalConversation, Bpmn2Package.eINSTANCE.getCollaboration_MessageFlows());
				basePart.initMessageFlows(messageFlowsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.correlationKeys)) {
				correlationKeysSettings = new ReferencesTableSettings(globalConversation, Bpmn2Package.eINSTANCE.getCollaboration_CorrelationKeys());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.id) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Id();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.extensionDefinitions) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.extensionValues) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.documentation) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Documentation();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.name) {
			return Bpmn2Package.eINSTANCE.getCollaboration_Name();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.isClosed) {
			return Bpmn2Package.eINSTANCE.getCollaboration_IsClosed();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.choreographyRef) {
			return Bpmn2Package.eINSTANCE.getCollaboration_ChoreographyRef();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.artifacts) {
			return Bpmn2Package.eINSTANCE.getCollaboration_Artifacts();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.participantAssociations) {
			return Bpmn2Package.eINSTANCE.getCollaboration_ParticipantAssociations();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.messageFlowAssociations) {
			return Bpmn2Package.eINSTANCE.getCollaboration_MessageFlowAssociations();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.messageFlows) {
			return Bpmn2Package.eINSTANCE.getCollaboration_MessageFlows();
		}
		if (editorKey == Bpmn2ViewsRepository.GlobalConversation.Properties.correlationKeys) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		GlobalConversation globalConversation = (GlobalConversation)semanticObject;
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.id == event.getAffectedEditor()) {
			globalConversation.setId((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.extensionDefinitions == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.extensionValues == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.documentation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.name == event.getAffectedEditor()) {
			globalConversation.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.isClosed == event.getAffectedEditor()) {
			globalConversation.setIsClosed((Boolean)event.getNewValue());
		}
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.choreographyRef == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.artifacts == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.participantAssociations == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.messageFlowAssociations == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.messageFlows == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.GlobalConversation.Properties.correlationKeys == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			GlobalConversationPropertiesEditionPart basePart = (GlobalConversationPropertiesEditionPart)editingPart;
			if (Bpmn2Package.eINSTANCE.getBaseElement_Id().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.id)) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.extensionDefinitions))
				basePart.updateExtensionDefinitions();
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.extensionValues))
				basePart.updateExtensionValues();
			if (Bpmn2Package.eINSTANCE.getBaseElement_Documentation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.documentation))
				basePart.updateDocumentation();
			if (Bpmn2Package.eINSTANCE.getCollaboration_Name().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (Bpmn2Package.eINSTANCE.getCollaboration_IsClosed().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.isClosed))
				basePart.setIsClosed((Boolean)msg.getNewValue());
			
			if (Bpmn2Package.eINSTANCE.getCollaboration_ChoreographyRef().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.choreographyRef))
				basePart.updateChoreographyRef();
			if (Bpmn2Package.eINSTANCE.getCollaboration_Artifacts().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.artifacts))
				basePart.updateArtifacts();
			if (Bpmn2Package.eINSTANCE.getCollaboration_ParticipantAssociations().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.participantAssociations))
				basePart.updateParticipantAssociations();
			if (Bpmn2Package.eINSTANCE.getCollaboration_MessageFlowAssociations().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.messageFlowAssociations))
				basePart.updateMessageFlowAssociations();
			if (Bpmn2Package.eINSTANCE.getCollaboration_MessageFlows().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.messageFlows))
				basePart.updateMessageFlows();
			if (Bpmn2Package.eINSTANCE.getCollaboration_CorrelationKeys().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.GlobalConversation.Properties.correlationKeys))
	...
	public boolean isRequired(Object key, int kind) {
		return key == Bpmn2ViewsRepository.GlobalConversation.Properties.id || key == Bpmn2ViewsRepository.GlobalConversation.Properties.isClosed;
	}
