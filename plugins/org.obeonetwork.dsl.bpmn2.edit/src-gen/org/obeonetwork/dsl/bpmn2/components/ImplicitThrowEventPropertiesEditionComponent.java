 ...
 * 
 */
public class ImplicitThrowEventPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ImplicitThrowEventPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject implicitThrowEvent, String editing_mode) {
		super(editingContext, implicitThrowEvent, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = Bpmn2ViewsRepository.class;
		partKey = Bpmn2ViewsRepository.ImplicitThrowEvent.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ImplicitThrowEvent implicitThrowEvent = (ImplicitThrowEvent)elt;
			final ImplicitThrowEventPropertiesEditionPart basePart = (ImplicitThrowEventPropertiesEditionPart)editingPart;
			// init values
			if (implicitThrowEvent.getId() != null && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, implicitThrowEvent.getId()));
			
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.extensionDefinitions)) {
				extensionDefinitionsSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions());
				basePart.initExtensionDefinitions(extensionDefinitionsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.extensionValues)) {
				extensionValuesSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues());
				basePart.initExtensionValues(extensionValuesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.documentation)) {
				documentationSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getBaseElement_Documentation());
				basePart.initDocumentation(documentationSettings);
			}
			if (implicitThrowEvent.getName() != null && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, implicitThrowEvent.getName()));
			
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.categoryValueRef)) {
				categoryValueRefSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef());
				basePart.initCategoryValueRef(categoryValueRefSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.outgoing)) {
				outgoingSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getFlowNode_Outgoing());
				basePart.initOutgoing(outgoingSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.incoming)) {
				incomingSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getFlowNode_Incoming());
				basePart.initIncoming(incomingSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.properties_)) {
				propertiesSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getEvent_Properties());
				basePart.initProperties(propertiesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.eventDefinitionRefs)) {
				eventDefinitionRefsSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitionRefs());
				basePart.initEventDefinitionRefs(eventDefinitionRefsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.dataInputAssociation)) {
				dataInputAssociationSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getThrowEvent_DataInputAssociation());
				basePart.initDataInputAssociation(dataInputAssociationSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.eventDefinitions)) {
				eventDefinitionsSettings = new ReferencesTableSettings(implicitThrowEvent, Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitions());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.id) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Id();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.extensionDefinitions) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.extensionValues) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.documentation) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Documentation();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.name) {
			return Bpmn2Package.eINSTANCE.getFlowElement_Name();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.categoryValueRef) {
			return Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.outgoing) {
			return Bpmn2Package.eINSTANCE.getFlowNode_Outgoing();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.incoming) {
			return Bpmn2Package.eINSTANCE.getFlowNode_Incoming();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.properties_) {
			return Bpmn2Package.eINSTANCE.getEvent_Properties();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.eventDefinitionRefs) {
			return Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitionRefs();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.dataInputAssociation) {
			return Bpmn2Package.eINSTANCE.getThrowEvent_DataInputAssociation();
		}
		if (editorKey == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.eventDefinitions) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		ImplicitThrowEvent implicitThrowEvent = (ImplicitThrowEvent)semanticObject;
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.id == event.getAffectedEditor()) {
			implicitThrowEvent.setId((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.extensionDefinitions == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.extensionValues == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.documentation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.name == event.getAffectedEditor()) {
			implicitThrowEvent.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.categoryValueRef == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.outgoing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.incoming == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				if (event.getNewValue() instanceof SequenceFlow) {
		...
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.properties_ == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.eventDefinitionRefs == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.dataInputAssociation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.eventDefinitions == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			ImplicitThrowEventPropertiesEditionPart basePart = (ImplicitThrowEventPropertiesEditionPart)editingPart;
			if (Bpmn2Package.eINSTANCE.getBaseElement_Id().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.id)) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.extensionDefinitions))
				basePart.updateExtensionDefinitions();
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.extensionValues))
				basePart.updateExtensionValues();
			if (Bpmn2Package.eINSTANCE.getBaseElement_Documentation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.documentation))
				basePart.updateDocumentation();
			if (Bpmn2Package.eINSTANCE.getFlowElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.categoryValueRef))
				basePart.updateCategoryValueRef();
			if (Bpmn2Package.eINSTANCE.getFlowNode_Outgoing().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.outgoing))
				basePart.updateOutgoing();
			if (Bpmn2Package.eINSTANCE.getFlowNode_Incoming().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.incoming))
				basePart.updateIncoming();
			if (Bpmn2Package.eINSTANCE.getEvent_Properties().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.properties_))
				basePart.updateProperties();
			if (Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitionRefs().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.eventDefinitionRefs))
				basePart.updateEventDefinitionRefs();
			if (Bpmn2Package.eINSTANCE.getThrowEvent_DataInputAssociation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.dataInputAssociation))
				basePart.updateDataInputAssociation();
			if (Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitions().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.eventDefinitions))
	...
	public boolean isRequired(Object key, int kind) {
		return key == Bpmn2ViewsRepository.ImplicitThrowEvent.Properties.id;
	}
