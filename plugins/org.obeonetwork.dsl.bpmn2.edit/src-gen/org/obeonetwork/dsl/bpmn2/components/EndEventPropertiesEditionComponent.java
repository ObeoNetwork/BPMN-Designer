 ...
 * 
 */
public class EndEventPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public EndEventPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject endEvent, String editing_mode) {
		super(editingContext, endEvent, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = Bpmn2ViewsRepository.class;
		partKey = Bpmn2ViewsRepository.EndEvent.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final EndEvent endEvent = (EndEvent)elt;
			final EndEventPropertiesEditionPart basePart = (EndEventPropertiesEditionPart)editingPart;
			// init values
			if (endEvent.getId() != null && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, endEvent.getId()));
			
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.extensionDefinitions)) {
				extensionDefinitionsSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions());
				basePart.initExtensionDefinitions(extensionDefinitionsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.extensionValues)) {
				extensionValuesSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues());
				basePart.initExtensionValues(extensionValuesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.documentation)) {
				documentationSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getBaseElement_Documentation());
				basePart.initDocumentation(documentationSettings);
			}
			if (endEvent.getName() != null && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, endEvent.getName()));
			
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.categoryValueRef)) {
				categoryValueRefSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef());
				basePart.initCategoryValueRef(categoryValueRefSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.outgoing)) {
				outgoingSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getFlowNode_Outgoing());
				basePart.initOutgoing(outgoingSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.incoming)) {
				incomingSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getFlowNode_Incoming());
				basePart.initIncoming(incomingSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.properties_)) {
				propertiesSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getEvent_Properties());
				basePart.initProperties(propertiesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.eventDefinitionRefs)) {
				eventDefinitionRefsSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitionRefs());
				basePart.initEventDefinitionRefs(eventDefinitionRefsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.dataInputAssociation)) {
				dataInputAssociationSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getThrowEvent_DataInputAssociation());
				basePart.initDataInputAssociation(dataInputAssociationSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.eventDefinitions)) {
				eventDefinitionsSettings = new ReferencesTableSettings(endEvent, Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitions());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.id) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Id();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.extensionDefinitions) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.extensionValues) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.documentation) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Documentation();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.name) {
			return Bpmn2Package.eINSTANCE.getFlowElement_Name();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.categoryValueRef) {
			return Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.outgoing) {
			return Bpmn2Package.eINSTANCE.getFlowNode_Outgoing();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.incoming) {
			return Bpmn2Package.eINSTANCE.getFlowNode_Incoming();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.properties_) {
			return Bpmn2Package.eINSTANCE.getEvent_Properties();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.eventDefinitionRefs) {
			return Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitionRefs();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.dataInputAssociation) {
			return Bpmn2Package.eINSTANCE.getThrowEvent_DataInputAssociation();
		}
		if (editorKey == Bpmn2ViewsRepository.EndEvent.Properties.eventDefinitions) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		EndEvent endEvent = (EndEvent)semanticObject;
		if (Bpmn2ViewsRepository.EndEvent.Properties.id == event.getAffectedEditor()) {
			endEvent.setId((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.EndEvent.Properties.extensionDefinitions == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.EndEvent.Properties.extensionValues == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.EndEvent.Properties.documentation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.EndEvent.Properties.name == event.getAffectedEditor()) {
			endEvent.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.EndEvent.Properties.categoryValueRef == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.EndEvent.Properties.outgoing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.EndEvent.Properties.incoming == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				if (event.getNewValue() instanceof SequenceFlow) {
		...
		if (Bpmn2ViewsRepository.EndEvent.Properties.properties_ == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.EndEvent.Properties.eventDefinitionRefs == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.EndEvent.Properties.dataInputAssociation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.EndEvent.Properties.eventDefinitions == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			EndEventPropertiesEditionPart basePart = (EndEventPropertiesEditionPart)editingPart;
			if (Bpmn2Package.eINSTANCE.getBaseElement_Id().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.id)) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.extensionDefinitions))
				basePart.updateExtensionDefinitions();
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.extensionValues))
				basePart.updateExtensionValues();
			if (Bpmn2Package.eINSTANCE.getBaseElement_Documentation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.documentation))
				basePart.updateDocumentation();
			if (Bpmn2Package.eINSTANCE.getFlowElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.categoryValueRef))
				basePart.updateCategoryValueRef();
			if (Bpmn2Package.eINSTANCE.getFlowNode_Outgoing().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.outgoing))
				basePart.updateOutgoing();
			if (Bpmn2Package.eINSTANCE.getFlowNode_Incoming().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.incoming))
				basePart.updateIncoming();
			if (Bpmn2Package.eINSTANCE.getEvent_Properties().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.properties_))
				basePart.updateProperties();
			if (Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitionRefs().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.eventDefinitionRefs))
				basePart.updateEventDefinitionRefs();
			if (Bpmn2Package.eINSTANCE.getThrowEvent_DataInputAssociation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.dataInputAssociation))
				basePart.updateDataInputAssociation();
			if (Bpmn2Package.eINSTANCE.getThrowEvent_EventDefinitions().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.EndEvent.Properties.eventDefinitions))
	...
	public boolean isRequired(Object key, int kind) {
		return key == Bpmn2ViewsRepository.EndEvent.Properties.id;
	}
