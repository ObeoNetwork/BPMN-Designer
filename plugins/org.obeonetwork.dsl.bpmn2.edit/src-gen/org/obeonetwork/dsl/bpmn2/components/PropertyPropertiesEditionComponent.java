...
public class PropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public PropertyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject property, String editing_mode) {
		...
		partKey = Bpmn2ViewsRepository.Property.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (property.getId() != null && isAccessible(Bpmn2ViewsRepository.Property.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, property.getId()));
			
			if (isAccessible(Bpmn2ViewsRepository.Property.Properties.extensionDefinitions)) {
				extensionDefinitionsSettings = new ReferencesTableSettings(property, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions());
				basePart.initExtensionDefinitions(extensionDefinitionsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.Property.Properties.extensionValues)) {
				extensionValuesSettings = new ReferencesTableSettings(property, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues());
				basePart.initExtensionValues(extensionValuesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.Property.Properties.documentation)) {
				documentationSettings = new ReferencesTableSettings(property, Bpmn2Package.eINSTANCE.getBaseElement_Documentation());
				basePart.initDocumentation(documentationSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.Property.Properties.itemSubjectRef)) {
				// init part
				itemSubjectRefSettings = new EObjectFlatComboSettings(property, Bpmn2Package.eINSTANCE.getItemAwareElement_ItemSubjectRef());
				basePart.initItemSubjectRef(itemSubjectRefSettings);
				// set the button mode
				basePart.setItemSubjectRefButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (property.getName() != null && isAccessible(Bpmn2ViewsRepository.Property.Properties.name))
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == Bpmn2ViewsRepository.Property.Properties.id) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Id();
		}
		if (editorKey == Bpmn2ViewsRepository.Property.Properties.extensionDefinitions) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions();
		}
		if (editorKey == Bpmn2ViewsRepository.Property.Properties.extensionValues) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues();
		}
		if (editorKey == Bpmn2ViewsRepository.Property.Properties.documentation) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Documentation();
		}
		if (editorKey == Bpmn2ViewsRepository.Property.Properties.itemSubjectRef) {
			return Bpmn2Package.eINSTANCE.getItemAwareElement_ItemSubjectRef();
		}
		if (editorKey == Bpmn2ViewsRepository.Property.Properties.name) {
			return Bpmn2Package.eINSTANCE.getProperty_Name();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (Bpmn2ViewsRepository.Property.Properties.id == event.getAffectedEditor()) {
			property.setId((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.Property.Properties.extensionDefinitions == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.Property.Properties.extensionValues == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.Property.Properties.documentation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.Property.Properties.itemSubjectRef == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.Property.Properties.name == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_Id().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.Property.Properties.id)) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.Property.Properties.extensionDefinitions))
				basePart.updateExtensionDefinitions();
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.Property.Properties.extensionValues))
				basePart.updateExtensionValues();
			if (Bpmn2Package.eINSTANCE.getBaseElement_Documentation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.Property.Properties.documentation))
				basePart.updateDocumentation();
			if (Bpmn2Package.eINSTANCE.getItemAwareElement_ItemSubjectRef().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.Property.Properties.itemSubjectRef))
				basePart.setItemSubjectRef((EObject)msg.getNewValue());
			if (Bpmn2Package.eINSTANCE.getProperty_Name().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.Property.Properties.name)) {
				if (msg.getNewValue() != null) {
	...
	public boolean isRequired(Object key, int kind) {
		return key == Bpmn2ViewsRepository.Property.Properties.id || key == Bpmn2ViewsRepository.Property.Properties.name;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (Bpmn2ViewsRepository.Property.Properties.name == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(Bpmn2Package.eINSTANCE.getProperty_Name().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(Bpmn2Package.eINSTANCE.getProperty_Name().getEAttributeType(), newValue);
				}
