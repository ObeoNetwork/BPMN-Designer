...
public class InterfacePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public InterfacePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject interface_, String editing_mode) {
		...
		partKey = Bpmn2ViewsRepository.Interface_.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (interface_.getId() != null && isAccessible(Bpmn2ViewsRepository.Interface_.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, interface_.getId()));
			
			if (isAccessible(Bpmn2ViewsRepository.Interface_.Properties.extensionDefinitions)) {
				extensionDefinitionsSettings = new ReferencesTableSettings(interface_, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions());
				basePart.initExtensionDefinitions(extensionDefinitionsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.Interface_.Properties.extensionValues)) {
				extensionValuesSettings = new ReferencesTableSettings(interface_, Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues());
				basePart.initExtensionValues(extensionValuesSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.Interface_.Properties.documentation)) {
				documentationSettings = new ReferencesTableSettings(interface_, Bpmn2Package.eINSTANCE.getBaseElement_Documentation());
				basePart.initDocumentation(documentationSettings);
			}
			if (interface_.getName() != null && isAccessible(Bpmn2ViewsRepository.Interface_.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, interface_.getName()));
			
			if (isAccessible(Bpmn2ViewsRepository.Interface_.Properties.operations)) {
				operationsSettings = new ReferencesTableSettings(interface_, Bpmn2Package.eINSTANCE.getInterface_Operations());
				basePart.initOperations(operationsSettings);
			}
			if (isAccessible(Bpmn2ViewsRepository.Interface_.Properties.implementationRef)) {
				// init part
				implementationRefSettings = new EObjectFlatComboSettings(interface_, Bpmn2Package.eINSTANCE.getInterface_ImplementationRef());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == Bpmn2ViewsRepository.Interface_.Properties.id) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Id();
		}
		if (editorKey == Bpmn2ViewsRepository.Interface_.Properties.extensionDefinitions) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions();
		}
		if (editorKey == Bpmn2ViewsRepository.Interface_.Properties.extensionValues) {
			return Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues();
		}
		if (editorKey == Bpmn2ViewsRepository.Interface_.Properties.documentation) {
			return Bpmn2Package.eINSTANCE.getBaseElement_Documentation();
		}
		if (editorKey == Bpmn2ViewsRepository.Interface_.Properties.name) {
			return Bpmn2Package.eINSTANCE.getInterface_Name();
		}
		if (editorKey == Bpmn2ViewsRepository.Interface_.Properties.operations) {
			return Bpmn2Package.eINSTANCE.getInterface_Operations();
		}
		if (editorKey == Bpmn2ViewsRepository.Interface_.Properties.implementationRef) {
			return Bpmn2Package.eINSTANCE.getInterface_ImplementationRef();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (Bpmn2ViewsRepository.Interface_.Properties.id == event.getAffectedEditor()) {
			interface_.setId((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (Bpmn2ViewsRepository.Interface_.Properties.extensionDefinitions == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.Interface_.Properties.extensionValues == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.Interface_.Properties.documentation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.Interface_.Properties.name == event.getAffectedEditor()) {
		...
		if (Bpmn2ViewsRepository.Interface_.Properties.operations == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (Bpmn2ViewsRepository.Interface_.Properties.implementationRef == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_Id().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.Interface_.Properties.id)) {
			...
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionDefinitions().equals(msg.getFeature())  && isAccessible(Bpmn2ViewsRepository.Interface_.Properties.extensionDefinitions))
				basePart.updateExtensionDefinitions();
			if (Bpmn2Package.eINSTANCE.getBaseElement_ExtensionValues().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.Interface_.Properties.extensionValues))
				basePart.updateExtensionValues();
			if (Bpmn2Package.eINSTANCE.getBaseElement_Documentation().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.Interface_.Properties.documentation))
				basePart.updateDocumentation();
			if (Bpmn2Package.eINSTANCE.getInterface_Name().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.Interface_.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (Bpmn2Package.eINSTANCE.getInterface_Operations().equals(msg.getFeature()) && isAccessible(Bpmn2ViewsRepository.Interface_.Properties.operations))
				basePart.updateOperations();
			if (Bpmn2Package.eINSTANCE.getInterface_ImplementationRef().equals(msg.getFeature()) && basePart != null && isAccessible(Bpmn2ViewsRepository.Interface_.Properties.implementationRef))
	...
	public boolean isRequired(Object key, int kind) {
		return key == Bpmn2ViewsRepository.Interface_.Properties.id || key == Bpmn2ViewsRepository.Interface_.Properties.name || key == Bpmn2ViewsRepository.Interface_.Properties.operations;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (Bpmn2ViewsRepository.Interface_.Properties.name == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(Bpmn2Package.eINSTANCE.getInterface_Name().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(Bpmn2Package.eINSTANCE.getInterface_Name().getEAttributeType(), newValue);
				}
