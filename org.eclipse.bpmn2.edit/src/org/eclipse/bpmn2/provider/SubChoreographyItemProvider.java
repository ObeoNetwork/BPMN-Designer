 ...
 * @generated
 */
public class SubChoreographyItemProvider extends
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Bpmn2Package.Literals.SUB_CHOREOGRAPHY__ARTIFACTS);
		}
		...
		try {
			return overlayImage(
					...
					getResourceLocator().getImage(
							"full/obj16/SubChoreography.png"));
		} catch (java.util.MissingResourceException e) {
			return overlayImage(
					object,
					getResourceLocator().getImage(
							"full/obj16/SubChoreography.gif"));
		}
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				Bpmn2Package.Literals.SUB_CHOREOGRAPHY__ARTIFACTS,
