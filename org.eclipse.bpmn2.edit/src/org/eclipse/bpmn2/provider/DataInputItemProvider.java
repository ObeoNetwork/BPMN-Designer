...
public class DataInputItemProvider extends ItemAwareElementItemProvider
	...
	protected void addIsCollectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataInput_isCollection_feature",
						"_UI_DataInput_type"),
				Bpmn2Package.Literals.DATA_INPUT__IS_COLLECTION, true, false,
	...
	protected void addInputSetWithOptionalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataInput_inputSetWithOptional_feature",
						"_UI_DataInput_type"),
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_DataInput_inputSetWithWhileExecuting_feature",
								"_UI_DataInput_type"),
	...
	protected void addInputSetRefsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataInput_inputSetRefs_feature",
						"_UI_DataInput_type"),
				Bpmn2Package.Literals.DATA_INPUT__INPUT_SET_REFS, true, false,
				true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		try {
			return overlayImage(object,
					getResourceLocator().getImage("full/obj16/DataInput.png"));
		} catch (java.util.MissingResourceException e) {
			return overlayImage(object,
					getResourceLocator().getImage("full/obj16/DataInput.gif"));
		}
	}
